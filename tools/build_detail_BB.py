...
def main():
    ...
    if args.tapp_name == "empaTAPP":
        # detailEMPA's parameterValues registry + additionalProperty constraint are
        # now produced by the unified build_tapp.py (matrix routing). Delegate.
        print("NOTE: empaTAPP/detailEMPA is now generated by tools/build_tapp.py (matrix routing). Delegating.")
        import build_tapp
