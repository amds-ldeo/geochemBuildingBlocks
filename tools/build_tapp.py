...
TAPP_CONFIGS = {
    "empaTAPP": {
        ...
        "xlsx": "tapp/Current TAPPs/EPMA_TAPP_v60.csv",
        "prefix": "empa",
        ...
        "description": ("Electron-probe microanalysis (EPMA/EMPA, WDS/EDS) extension of the base TAPP "
                        "definition, generated from tapp/Current TAPPs/EPMA_TAPP_v60.csv via the path-driven pipeline "
    ...
    "labxctTAPP": {
        "xlsx": "tapp/Current TAPPs/Lab-XCT_TAPP_v37.csv",
        "prefix": "labxct",
        ...
        "description": ("Laboratory X-ray computed tomography (polychromatic cone-beam) extension of "
                        ...
                        "ada:analyteTemplate is defined. Generated from tapp/Current TAPPs/Lab-XCT_TAPP_v37.csv by "
                        "tools/build_tapp.py."),
    ...
    "temTAPP": {
        "xlsx": "tapp/Current TAPPs/TEM_TAPP_v48.csv",
        "prefix": "tem",
        ...
        "description": ("Transmission electron microscopy (TEM/STEM, incl. EDS/EELS) extension of the "
                        ...
                        "tapp/Current TAPPs/TEM_TAPP_v48.csv by tools/build_tapp.py."),
    ...
    "semImagingTAPP": {
        "xlsx": "tapp/Current TAPPs/SEM_Imaging_TAPP_v29.csv",
        "prefix": "semImaging",
        ...
        "description": ("Scanning electron microscopy imaging (SE/BSE/CL/EBSD) extension of the base "
                        ...
                        "Generated from tapp/Current TAPPs/SEM_Imaging_TAPP_v29.csv by tools/build_tapp.py."),
    ...
    "semFibsemTAPP": {
        "xlsx": "tapp/Current TAPPs/SEM_FIBSEM_TAPP_v30.csv",
        "prefix": "semFibsem",
        ...
        "description": ("Focused-ion-beam SEM (FIB-SEM tomography, TEM lamella prep) extension of the "
                        "base TAPP definition. Basic protocol-tier fields are required top-level ada: "
                        "properties; Advanced protocol-tier fields are schema:additionalProperty[] "
                        "entries. No ada:analyteTemplate. Generated from tapp/Current TAPPs/SEM_FIBSEM_TAPP_v30.csv "
    ...
    "semCompositionTAPP": {
        "xlsx": "tapp/Current TAPPs/SEM_Composition_TAPP_v58.csv",
        ...
        "description": ("Scanning electron microscopy compositional microanalysis (EDS/WDS) extension of "
                        "the base TAPP definition, generated from tapp/Current TAPPs/SEM_Composition_TAPP_v58.csv via "
    ...
    "semTAPP": {
        "xlsx": "tapp/Current TAPPs/SEM_TAPP_v59.csv",
        "prefix": "sem",
        ...
        "description": ("Scanning electron microscopy superset (imaging + EDS/WDS composition + EBSD + "
                        ...
                        "tapp/Current TAPPs/SEM_TAPP_v59.csv via the path-driven pipeline."),
    ...
    "solutionMcicpmsTAPP": {
        ...
        "xlsx": "tapp/Current TAPPs/Solution_MC-ICP-MS_TAPP_v67.csv",
        ...
        "description": ("Solution multi-collector ICP-MS extension of the base TAPP definition, "
                        "generated from tapp/Current TAPPs/Solution_MC-ICP-MS_TAPP_v67.csv "
    ...
    "solutionQicpmsTAPP": {
        "xlsx": "tapp/Current TAPPs/Solution_Q-ICP-MS_TAPP_v73.csv",
    ...
    "solutionSficpmsTAPP": {
        "xlsx": "tapp/Current TAPPs/Solution_SF-ICP-MS_TAPP_v69.csv",
        ...
        "description": ("Solution sector-field (high-resolution) ICP-MS extension of the base TAPP "
                        "definition, generated from tapp/Current TAPPs/Solution_SF-ICP-MS_TAPP_v69.csv via the "
    ...
    "laQicpmsTAPP": {
        "xlsx": "tapp/Current TAPPs/LA-Q-ICP-MS_TAPP_v71.csv",
        "prefix": "laQicpms",
        ...
        "description": ("Laser-ablation quadrupole ICP-MS extension of the base TAPP definition, "
                        "generated from tapp/Current TAPPs/LA-Q-ICP-MS_TAPP_v71.csv via the "
    ...
    "laSficpmsTAPP": {
        "xlsx": "tapp/Current TAPPs/LA-SF-ICP-MS_TAPP_v68.csv",
        "prefix": "laSficpms",
        "component_types": ["ada:LAICPMSTabular", "ada:LAICPMSMap", "ada:LAICPMSImage",
                            "ada:LAICPMSTransect"],
        "base_items": _IDENTITY_COMMON | {"Analyte"},
    ...
    "laMcicpmsTAPP": {
        "xlsx": "tapp/Current TAPPs/LA-MC-ICPMS_TAPP_v68.csv",
        "prefix": "laMcicpms",
        "component_types": ["ada:LAICPMSTabular", "ada:LAICPMSMap", "ada:LAICPMSImage",
                            "ada:LAICPMSTransect"],
        "base_items": _IDENTITY_COMMON | {"Analyte"},
        ...
        "description": ("Laser-ablation multi-collector ICP-MS extension of the base TAPP definition, "
                        "generated from tapp/Current TAPPs/LA-MC-ICPMS_TAPP_v68.csv via the "
                        "path-driven pipeline."),
    ...
    "laQicpmsUPbTAPP": {
        "xlsx": "tapp/Current TAPPs/LA-Q-ICP-MS_UPb_TAPP_v71.csv",
        "prefix": "laQicpmsUPb",
    ...
    "laSficpmsUPbTAPP": {
        "xlsx": "tapp/Current TAPPs/LA-SF-ICP-MS_UPb_TAPP_v69.csv",
        "prefix": "laSficpmsUPb",
        "component_types": ["ada:LAICPMSGeochronTabular"],
        "base_items": _IDENTITY_COMMON | {"Analyte"},
        "analyte_map": {},
    ...
    "laMcicpmsUPbTAPP": {
        "xlsx": "tapp/Current TAPPs/LA-MC-ICPMS_UPb_TAPP_v68.csv",
        "prefix": "laMcicpmsUPb",
        "component_types": ["ada:LAICPMSGeochronTabular"],
        "base_items": _IDENTITY_COMMON | {"Analyte"},
        "analyte_map": {},
...
# Column F marks an illustrative list by prefixing the WHOLE cell with "e.g.," - 138 cells arrived
# that way in the 2026-09 delivery. Splitting on "|" first and then dropping any part that starts
# with "e.g" ate the first real member of 16 controlled lists, because the prefix qualifies the
# list, not its first term. Strip it from the cell, then keep the per-part filter, which is still
# needed for a bare "e.g." written as a member inside a list.
_EG_PREFIX = re.compile(r"^\s*e\.?\s*g\.?\s*[,:]?\s*", re.I)


def enum_terms(ex):
    """Controlled-list members from a Column F cell, in file order."""
    return [p.strip().strip("'\"") for p in _EG_PREFIX.sub("", ex or "").split("|")
...
def route():
    ...
    for r in rows[1:]:
        ...
        if rec["name"] != "analyticalMode" and ("controlled" in dt.lower() or dt.lower().startswith("boolean")):
            terms = ["Yes", "No"] if dt.lower().startswith("boolean") else enum_terms(ex)
            if terms:
