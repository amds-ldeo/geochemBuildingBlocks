...
TAPP_CONFIGS = {
    ...
    "semImagingTAPP": {
        "xlsx": "docs/SEM_Imaging_TAPP_v4.xlsx",
        "prefix": "semImaging",
        ...
        "description": ("Scanning electron microscopy imaging (SE/BSE/CL/EBSD) extension of the base "
                        ...
                        "Generated from docs/SEM_Imaging_TAPP_v4.xlsx by tools/build_tapp.py."),
    ...
    "semFibsemTAPP": {
        "xlsx": "docs/SEM_FIBSEM_TAPP_v4.xlsx",
        "prefix": "semFibsem",
        ...
        "description": ("Focused-ion-beam SEM (FIB-SEM tomography, TEM lamella prep) extension of the "
                        "base TAPP definition. Basic protocol-tier fields are required top-level ada: "
                        "properties; Advanced protocol-tier fields are schema:additionalProperty[] "
                        "entries. No ada:analyteTemplate. Generated from docs/SEM_FIBSEM_TAPP_v4.xlsx "
    ...
    "semCompositionTAPP": {
        "xlsx": "docs/SEM_Composition_TAPP_v4.xlsx",
        ...
        "description": ("Scanning electron microscopy compositional microanalysis (EDS/WDS) extension of "
                        "the base TAPP definition, generated from docs/SEM_Composition_TAPP_v4.xlsx via "
    ...
    "solutionQicpmsTAPP": {
        "xlsx": "docs/Solution_Q-ICP-MS_TAPP_v5.xlsx",
        ...
        "description": ("Solution quadrupole ICP-MS extension of the base TAPP definition, generated "
                        "from docs/Solution_Q-ICP-MS_TAPP_v5.xlsx via the path-driven pipeline."),
    ...
    "solutionSficpmsTAPP": {
        "xlsx": "docs/Solution_SF-ICP-MS_TAPP_v5.xlsx",
        ...
        "description": ("Solution sector-field (high-resolution) ICP-MS extension of the base TAPP "
                        "definition, generated from docs/Solution_SF-ICP-MS_TAPP_v5.xlsx via the "
