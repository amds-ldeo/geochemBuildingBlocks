...
def main():
    ...
    if args.tapp_name == "empaTAPP":
        # empaTAPP is now generated by the unified, matrix-driven build_tapp.py
        # (impl-tag-kind routing is retired for empa). Delegate so the old entry
        # point keeps working and produces the canonical matrix-conformed output.
        print("NOTE: empaTAPP is now generated by tools/build_tapp.py (matrix routing). Delegating.")
        import build_tapp
        build_tapp.configure("empaTAPP")
        build_tapp.build_empa()
        return
