...
# Analyte-Column Specification Registry (Schema)

`ogch.registry.analyteColumns` *v0.1*
...
description: Registry of reusable schema:PropertyValueSpecification analyte-column
  definitions derived from technique TAPP spreadsheets. Each $def constrains one analyte-table
  reporting column (e.g. detectionLimit, xrayEmissionLine). TAPP building blocks reference
  these definitions via fragment $refs (schema.yaml#/$defs/<name>) so they resolve
  locally through the building-block register. The root only hosts $defs; it has no
  instantiable properties of its own.
type: object
$defs:
  analysisOrder:
    title: Sequence
    ...
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/analysisOrder
      '@type':
        const:
  ...
  backgroundCorrectionMethod:
    ...
    - ada:dataType
    - schema:defaultValue
  backgroundCountingPosition:
    title: Typical Background Position(s)
    description: "Positions of background measurements relative to the peak, in mm
      and/or sin\u03B8, and whether on the high or low energy side."
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/backgroundCountingPosition
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: backgroundCountingPosition
      schema:name:
        const: Typical Background Position(s)
      ada:dataType:
        const: string
      schema:readonlyValue:
        const: true
  ...
  detectionLimitMethod:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/detectionLimitMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  edsDeadTime:
    title: EDS Dead Time
    description: Percent dead time reported by the EDS spectrometer
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/edsDeadTime
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - schema:name
    - ada:dataType
  elementEstimationMethod:
    title: Element Estimation Method
    description: "How elemental concentrations were calculated \u2014 directly from
      measured X-ray intensities or via cation stoichiometry."
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/elementEstimationMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: elementEstimationMethod
      schema:name:
        const: Element Estimation Method
      ada:dataType:
        const: string
      schema:readonlyValue:
        const: true
  ...
  empa_detectionLimit:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/detectionLimit
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  empa_epmaTechniquePerTargetSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  empa_interferenceCorrectionsApplied:
    title: Interference Corrections Applied
    description: Whether a spectral interference correction was applied for each analyte.
      Common interferences include Ti Kb on V Ka, Cr Kb on Mn Ka, and Ba La on Ti
      Ka.
    type: object
    properties:
      '@id':
  ...
  empa_normalizationStandardsBasedCorrection:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/normalizationStandardsBasedCorrection
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  epmaTechnique:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/epmaTechnique
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: epmaTechnique
      schema:name:
        const: EPMA Technique per Element
      ada:dataType:
        const: string
      schema:readonlyValue:
        const: true
  ...
  interferenceCorrection:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/interferenceCorrection
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: interferenceCorrection
      schema:name:
        const: Interference Corrections Applied
      ada:dataType:
        const: boolean
  ...
  laMcicpmsUPb_calibrationStrategyPerTargetSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  laMcicpmsUPb_countingStatisticsError:
    title: Counting Statistics Error
    description: "Uncertainty predicted from counting statistics \u2014 the theoretical
      limit set by the Poisson distribution of the counts accumulated \u2014 for each
      reported quantity per analysis, with the sigma level stated. Derived from the
  ...
  laMcicpmsUPb_detectionLimit:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsUPbTAPP/detectionLimit
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - schema:name
    - ada:dataType
  laMcicpmsUPb_detectionLimitMethod:
    title: Detection Limit Method
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsUPbTAPP/detectionLimitMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - ada:dataType
    - schema:defaultValue
  laMcicpmsUPb_dwellTimePerMass:
    title: Dwell Time per Mass
    description: ''
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsUPbTAPP/dwellTimePerMass
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laMcicpmsUPb_interferingSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  laMcicpmsUPb_internalAnalyticalPrecisionAndAssessmentMethod:
    ...
    - schema:name
    - ada:dataType
  laMcicpmsUPb_isobaricInterferenceCorrectionsApplied:
    ...
    description: 'Whether isobaric interference corrections were applied for any measured
      isotope in this procedure. A procedure-level Boolean: if the procedure includes
      interference corrections, this is always Yes. Detail for each affected mass
      is captured in Interfering Species and Interference Correction Method.'
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsUPbTAPP/isobaricInterferenceCorrectionsApplied
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - ada:dataType
    - schema:defaultValue
  laMcicpmsUPb_limitOfQuantificationMethod:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsUPbTAPP/limitOfQuantificationMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laMcicpmsUPb_massResolutionPerAnalyte:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsUPbTAPP/massResolutionPerAnalyte
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - schema:name
    - ada:dataType
  laMcicpmsUPb_monitoredIsotopes:
    title: Monitored Isotopes
    description: Specific isotope(s) monitored in this procedure, grouped by the analyte
      element they serve where they serve one. Includes interference-monitor and internal-standard
      masses, which serve no analyte and so have no parent element. The analyte list
      is given by the Analyte field and is never inferred from the element symbols
      appearing here.
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsUPbTAPP/monitoredIsotopes
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laMcicpmsUPb_normalizationStandardsBasedCorrection:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsUPbTAPP/normalizationStandardsBasedCorrection
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laMcicpmsUPb_withinSessionAnalyticalPrecisionAndAssessmentMethod:
    ...
    - ada:dataType
    - schema:defaultValue
  laMcicpms_analyticalAccuracyAndAssessmentMethod:
    title: Analytical Accuracy and Assessment Method
    description: 'Offset between measured and accepted reference values for secondary
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsTAPP/analyticalAccuracyAndAssessmentMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - ada:dataType
    - schema:defaultValue
  laMcicpms_betweenSessionAnalyticalPrecisionAndAssessmentMethod:
    title: Between-Session (Long-Term) Analytical Precision and Assessment Method
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsTAPP/betweenSessionAnalyticalPrecisionAndAssessmentMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laMcicpms_calibrationStrategyPerTargetSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  laMcicpms_countingStatisticsError:
    title: Counting Statistics Error
    description: "Uncertainty predicted from counting statistics \u2014 the theoretical
      limit set by the Poisson distribution of the counts accumulated \u2014 for each
      reported quantity per analysis, with the sigma level stated. Derived from the
  ...
  laMcicpms_detectionLimitMethod:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsTAPP/detectionLimitMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laMcicpms_interferenceCorrectionMethod:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsTAPP/interferenceCorrectionMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laMcicpms_interferingSpecies:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsTAPP/interferingSpecies
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - ada:dataType
    - schema:defaultValue
  laMcicpms_internalAnalyticalPrecisionAndAssessmentMethod:
    title: Internal (Within-Measurement) Analytical Precision and Assessment Method
    description: Precision of a single measurement, derived from the scatter of the
      cycles, sweeps or integrations that make it up, together with the method used
      to assess it. State the statistic (2SE, 2SD, 1s RSD), the number of cycles it
    ...
    - schema:name
    - ada:dataType
  laMcicpms_isobaricInterferenceCorrectionsApplied:
    title: Isobaric Interference Corrections Applied
    description: 'Whether isobaric interference corrections were applied for any measured
      isotope in this procedure. A procedure-level Boolean: if the procedure includes
      interference corrections, this is always Yes. Detail for each affected mass
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsTAPP/isobaricInterferenceCorrectionsApplied
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - ada:dataType
    - schema:defaultValue
  laMcicpms_limitOfQuantificationMethod:
    title: Limit of Quantification (LOQ) Method
    description: 'Reference or description of the method used to calculate the limit
      of quantification (LOQ): the lowest concentration reliably measurable with acceptable
      precision and accuracy. Required when concentrations near the LOD are reported.'
  ...
  laMcicpms_sensitivityAsUsefulYield:
    ...
    - schema:name
    - ada:dataType
  laMcicpms_withinSessionAnalyticalPrecisionAndAssessmentMethod:
    title: Within-Session Analytical Precision and Assessment Method
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laMcicpmsTAPP/withinSessionAnalyticalPrecisionAndAssessmentMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laQicpmsUPb_calibrationStrategyPerTargetSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  laQicpmsUPb_countingStatisticsError:
    title: Counting Statistics Error
    description: "Uncertainty predicted from counting statistics \u2014 the theoretical
      limit set by the Poisson distribution of the counts accumulated \u2014 for each
      reported quantity per analysis, with the sigma level stated. Derived from the
  ...
  laQicpmsUPb_detectionLimit:
    ...
    - schema:name
    - ada:dataType
  laQicpmsUPb_detectionLimitMethod:
    title: Detection Limit Method
    description: Reference or description of the method used to calculate session
      detection limits. Mandatory at analysis level. Must be consistent with the method
      applied to generate the Detection Limit values reported above.
  ...
  laQicpmsUPb_interferingSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  laQicpmsUPb_internalAnalyticalPrecisionAndAssessmentMethod:
    title: Internal (Within-Measurement) Analytical Precision and Assessment Method
    description: Precision of a single measurement, derived from the scatter of the
      cycles, sweeps or integrations that make it up, together with the method used
      to assess it. State the statistic (2SE, 2SD, 1s RSD), the number of cycles it
    ...
    - schema:name
    - ada:dataType
  laQicpmsUPb_isobaricInterferenceCorrectionsApplied:
    title: Isobaric Interference Corrections Applied
    description: 'Whether isobaric interference corrections were applied for any measured
      isotope in this procedure. A procedure-level Boolean: if the procedure includes
      interference corrections, this is always Yes. Detail for each affected mass
    ...
    - ada:dataType
    - schema:defaultValue
  laQicpmsUPb_limitOfQuantificationMethod:
    title: Limit of Quantification (LOQ) Method
    description: 'Reference or description of the method used to calculate the limit
      of quantification (LOQ): the lowest concentration reliably measurable with acceptable
      precision and accuracy. Required when concentrations near the LOD are reported.'
    ...
    - schema:name
    - ada:dataType
  laQicpmsUPb_massResolutionPerAnalyte:
    title: Mass Resolution per Analyte
    description: ''
    type: object
    properties:
  ...
  laQicpms_calibrationStrategyPerTargetSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  laQicpms_countingStatisticsError:
    title: Counting Statistics Error
    description: "Uncertainty predicted from counting statistics \u2014 the theoretical
      limit set by the Poisson distribution of the counts accumulated \u2014 for each
      reported quantity per analysis, with the sigma level stated. Derived from the
  ...
  laQicpms_detectionLimit:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laQicpmsTAPP/detectionLimit
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laQicpms_detectionLimitMethod:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laQicpmsTAPP/detectionLimitMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laQicpms_interferingSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  laQicpms_internalAnalyticalPrecisionAndAssessmentMethod:
    title: Internal (Within-Measurement) Analytical Precision and Assessment Method
    description: Precision of a single measurement, derived from the scatter of the
      cycles, sweeps or integrations that make it up, together with the method used
      to assess it. State the statistic (2SE, 2SD, 1s RSD), the number of cycles it
    ...
    - schema:name
    - ada:dataType
  laQicpms_isobaricInterferenceCorrectionsApplied:
    title: Isobaric Interference Corrections Applied
    description: 'Whether isobaric interference corrections were applied for any measured
      isotope in this procedure. A procedure-level Boolean: if the procedure includes
      interference corrections, this is always Yes. Detail for each affected mass
    ...
    - ada:dataType
    - schema:defaultValue
  laQicpms_limitOfQuantificationMethod:
    title: Limit of Quantification (LOQ) Method
    description: 'Reference or description of the method used to calculate the limit
      of quantification (LOQ): the lowest concentration reliably measurable with acceptable
      precision and accuracy. Required when concentrations near the LOD are reported.'
    ...
    - schema:name
    - ada:dataType
  laQicpms_massResolutionPerAnalyte:
    title: Mass Resolution per Analyte
    description: ''
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/laQicpmsTAPP/massResolutionPerAnalyte
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laQicpms_monitoredIsotopes:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laQicpmsTAPP/monitoredIsotopes
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laQicpms_normalizationStandardsBasedCorrection:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laQicpmsTAPP/normalizationStandardsBasedCorrection
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laSficpmsUPb_calibrationStrategyPerTargetSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  laSficpmsUPb_countingStatisticsError:
    title: Counting Statistics Error
    description: "Uncertainty predicted from counting statistics \u2014 the theoretical
      limit set by the Poisson distribution of the counts accumulated \u2014 for each
      reported quantity per analysis, with the sigma level stated. Derived from the
  ...
  laSficpmsUPb_detectionLimit:
    ...
    - schema:name
    - ada:dataType
  laSficpmsUPb_detectionLimitMethod:
    title: Detection Limit Method
    description: Reference or description of the method used to calculate session
      detection limits. Mandatory at analysis level. Must be consistent with the method
      applied to generate the Detection Limit values reported above.
  ...
  laSficpmsUPb_interferingSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  laSficpmsUPb_internalAnalyticalPrecisionAndAssessmentMethod:
    title: Internal (Within-Measurement) Analytical Precision and Assessment Method
    description: Precision of a single measurement, derived from the scatter of the
      cycles, sweeps or integrations that make it up, together with the method used
      to assess it. State the statistic (2SE, 2SD, 1s RSD), the number of cycles it
    ...
    - schema:name
    - ada:dataType
  laSficpmsUPb_isobaricInterferenceCorrectionsApplied:
    title: Isobaric Interference Corrections Applied
    description: 'Whether isobaric interference corrections were applied for any measured
      isotope in this procedure. A procedure-level Boolean: if the procedure includes
      interference corrections, this is always Yes. Detail for each affected mass
    ...
    - ada:dataType
    - schema:defaultValue
  laSficpmsUPb_limitOfQuantificationMethod:
    title: Limit of Quantification (LOQ) Method
    description: 'Reference or description of the method used to calculate the limit
      of quantification (LOQ): the lowest concentration reliably measurable with acceptable
      precision and accuracy. Required when concentrations near the LOD are reported.'
  ...
  laSficpmsUPb_massResolutionPerAnalyte:
    ...
    - schema:name
    - ada:dataType
  laSficpmsUPb_monitoredIsotopes:
    title: Monitored Isotopes
    description: Specific isotope(s) monitored in this procedure, grouped by the analyte
      element they serve where they serve one. Includes interference-monitor and internal-standard
      masses, which serve no analyte and so have no parent element. The analyte list
  ...
  laSficpms_analyticalAccuracyAndAssessmentMethod:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laSficpmsTAPP/analyticalAccuracyAndAssessmentMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laSficpms_betweenSessionAnalyticalPrecisionAndAssessmentMethod:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laSficpmsTAPP/betweenSessionAnalyticalPrecisionAndAssessmentMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laSficpms_calibrationStrategyPerTargetSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  laSficpms_countingStatisticsError:
    title: Counting Statistics Error
    description: "Uncertainty predicted from counting statistics \u2014 the theoretical
      limit set by the Poisson distribution of the counts accumulated \u2014 for each
      reported quantity per analysis, with the sigma level stated. Derived from the
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laSficpmsTAPP/countingStatisticsError
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laSficpms_detectionLimit:
    ...
    - schema:name
    - ada:dataType
  laSficpms_detectionLimitMethod:
    title: Detection Limit Method
    description: Reference or description of the method used to calculate session
      detection limits. Mandatory at analysis level. Must be consistent with the method
      applied to generate the Detection Limit values reported above.
  ...
  laSficpms_dwellTimePerMass:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laSficpmsTAPP/dwellTimePerMass
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laSficpms_interferenceCorrectionMethod:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laSficpmsTAPP/interferenceCorrectionMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laSficpms_interferingSpecies:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laSficpmsTAPP/interferingSpecies
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - ada:dataType
    - schema:defaultValue
  laSficpms_internalAnalyticalPrecisionAndAssessmentMethod:
    title: Internal (Within-Measurement) Analytical Precision and Assessment Method
    description: Precision of a single measurement, derived from the scatter of the
      cycles, sweeps or integrations that make it up, together with the method used
      to assess it. State the statistic (2SE, 2SD, 1s RSD), the number of cycles it
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laSficpmsTAPP/internalAnalyticalPrecisionAndAssessmentMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - schema:name
    - ada:dataType
  laSficpms_isobaricInterferenceCorrectionsApplied:
    title: Isobaric Interference Corrections Applied
    description: 'Whether isobaric interference corrections were applied for any measured
      isotope in this procedure. A procedure-level Boolean: if the procedure includes
      interference corrections, this is always Yes. Detail for each affected mass
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laSficpmsTAPP/isobaricInterferenceCorrectionsApplied
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - ada:dataType
    - schema:defaultValue
  laSficpms_limitOfQuantificationMethod:
    title: Limit of Quantification (LOQ) Method
    description: 'Reference or description of the method used to calculate the limit
      of quantification (LOQ): the lowest concentration reliably measurable with acceptable
      precision and accuracy. Required when concentrations near the LOD are reported.'
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laSficpmsTAPP/limitOfQuantificationMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laSficpms_massResolutionPerAnalyte:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laSficpmsTAPP/massResolutionPerAnalyte
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laSficpms_monitoredIsotopes:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laSficpmsTAPP/monitoredIsotopes
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  laSficpms_withinSessionAnalyticalPrecisionAndAssessmentMethod:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/laSficpmsTAPP/withinSessionAnalyticalPrecisionAndAssessmentMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  monochromatorCrystal:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/monochromatorCrystal
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: monochromatorCrystal
      schema:name:
        const: Diffracting Crystal
      ada:dataType:
        const: string
    ...
    - schema:name
    - ada:dataType
  normalization-standardsCorrection:
    title: Normalization / Standards-Based Correction
    description: Post-acquisition normalization applied using secondary reference
      materials.
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/normalization-standardsCorrection
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: normalization-standardsCorrection
      schema:name:
        const: Normalization / Standards-Based Correction
      ada:dataType:
        const: string
  ...
  peakCountingTime:
    ...
    - ada:dataType
    - schema:defaultValue
  primaryCalibrationStandard:
    title: Primary Calibration Standard Name
    description: Primary reference material used for element standardization (calibration).
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/primaryCalibrationStandard
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: primaryCalibrationStandard
      schema:name:
        const: Primary Calibration Standard Name
      ada:dataType:
        const: string
    ...
    - schema:name
    - ada:dataType
  pulseHeightAnalyzeSetting:
    title: WDS PHA Setting
    description: Pulse height analyzer setting used for the WDS detector.
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/pulseHeightAnalyzeSetting
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: pulseHeightAnalyzeSetting
      schema:name:
        const: WDS PHA Setting
      ada:dataType:
        const: string
    ...
    - schema:name
    - ada:dataType
  secondaryReferenceMaterial:
    title: Secondary Reference Materials
    description: List of quality-control reference materials (secondary standards)
      routinely analyzed alongside unknowns.
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/secondaryReferenceMaterial
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: secondaryReferenceMaterial
      schema:name:
        const: Secondary Reference Materials
      ada:dataType:
        const: string
  ...
  semComposition_analyteEstimationMethod:
    ...
    - schema:name
    - ada:dataType
  semComposition_analyticalAccuracy:
    title: Analytical Accuracy
    description: Offset between measured and accepted reference values for secondary
      standards, expressed as percent relative bias. Include reference material, reference
      value source, and the measured value.
    ...
    - schema:name
    - ada:dataType
  semComposition_analyticalPrecision:
    title: Analytical Precision
    description: Reproducibility of repeated measurements on the same or equivalent
      reference material, expressed as 1-sigma relative standard deviation (%). Include
      reference material name, number of analyses (n), and the measured value.
  ...
  semComposition_blankCorrection:
    ...
    - schema:name
    - ada:dataType
  semComposition_countingStatisticsError:
    title: Counting Statistics Error
    description: "Uncertainty predicted from counting statistics \u2014 the theoretical
      limit set by the Poisson distribution of the counts accumulated \u2014 for each
      reported quantity per analysis, with the sigma level stated. Derived from the
  ...
  semComposition_detectionLimit:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/semCompositionTAPP/detectionLimit
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - schema:name
    - ada:dataType
  semComposition_detectionLimitMethod:
    title: Detection Limit Method
    description: Formula or approach used to calculate detection limits.
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/semCompositionTAPP/detectionLimitMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  semComposition_interferenceCorrectionStandard:
    ...
    - schema:name
    - ada:dataType
  semComposition_interferenceCorrectionsApplied:
    title: Interference Corrections Applied
    description: Whether a spectral interference correction was applied for each analyte.
      Common interferences include Ti Kb on V Ka, Cr Kb on Mn Ka, and Ba La on Ti
      Ka.
  ...
  semComposition_normalizationStandardsBasedCorrection:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/semCompositionTAPP/normalizationStandardsBasedCorrection
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  sem_detectionLimit:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/semTAPP/detectionLimit
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - schema:name
    - ada:dataType
  sem_detectionLimitMethod:
    title: Detection Limit Method
    description: Formula or approach used to calculate detection limits.
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/semTAPP/detectionLimitMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  sem_interferenceCorrectionStandard:
    ...
    - schema:name
    - ada:dataType
  sem_interferenceCorrectionsApplied:
    title: Interference Corrections Applied
    description: Whether a spectral interference correction was applied for each analyte.
      Common interferences include Ti Kb on V Ka, Cr Kb on Mn Ka, and Ba La on Ti
      Ka.
  ...
  sem_normalizationStandardsBasedCorrection:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/semTAPP/normalizationStandardsBasedCorrection
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  solutionMcicpms_analyticalAccuracyAndAssessmentMethod:
    ...
    - ada:dataType
    - schema:defaultValue
  solutionMcicpms_betweenSessionAnalyticalPrecisionAndAssessmentMethod:
    title: Between-Session (Long-Term) Analytical Precision and Assessment Method
    description: "Precision of measurements across multiple analytical sessions over
      weeks to months \u2014 long-term or intermediate precision \u2014 and the method
      used to assess it. Report both the assessment method and the precision values,
  ...
  solutionMcicpms_calibrationStrategyPerTargetSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  solutionMcicpms_countingStatisticsError:
    title: Counting Statistics Error
    description: "Uncertainty predicted from counting statistics \u2014 the theoretical
      limit set by the Poisson distribution of the counts accumulated \u2014 for each
      reported quantity per analysis, with the sigma level stated. Derived from the
    ...
    - schema:name
    - ada:dataType
  solutionMcicpms_detectionLimit:
    title: Detection Limit
    ...
    - schema:name
    - ada:dataType
  solutionMcicpms_detectionLimitMethod:
    title: Detection Limit Method
    description: Method used to calculate detection limits for each reported concentration
      variable, where concentration data are reported.
    type: object
    properties:
      '@id':
    ...
    - ada:dataType
    - schema:defaultValue
  solutionMcicpms_internalAnalyticalPrecisionAndAssessmentMethod:
    title: Internal (Within-Measurement) Analytical Precision and Assessment Method
    description: Precision of a single measurement, derived from the scatter of the
      cycles, sweeps or integrations that make it up, together with the method used
      to assess it. State the statistic (2SE, 2SD, 1s RSD), the number of cycles it
  ...
  solutionMcicpms_perAnalyteCalibrationStrategy:
    ...
    - ada:dataType
    - schema:defaultValue
  solutionMcicpms_withinSessionAnalyticalPrecisionAndAssessmentMethod:
    title: Within-Session Analytical Precision and Assessment Method
    description: Precision of repeated measurements within a single analytical session
      and the method used to assess it. Report both the assessment method and the
      precision values. The assessment method must specify the reference material
  ...
  solutionQicpms_calibrationStrategyPerTargetSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  solutionQicpms_countingStatisticsError:
    title: Counting Statistics Error
    description: "Uncertainty predicted from counting statistics \u2014 the theoretical
      limit set by the Poisson distribution of the counts accumulated \u2014 for each
      reported quantity per analysis, with the sigma level stated. Derived from the
  ...
  solutionQicpms_detectionLimit:
    ...
    - schema:name
    - ada:dataType
  solutionQicpms_detectionLimitMethod:
    title: Detection Limit Method
    description: Method used to calculate detection limits for each reported concentration
      variable.
    type: object
  ...
  solutionQicpms_dwellTimePerMass:
    ...
    description: Integration time spent on each mass peak per sweep (ms). May differ
      per analyte if analyte-specific dwell times are programmed.
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/solutionQicpmsTAPP/dwellTimePerMass
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  solutionQicpms_interferenceCorrectionMethod:
    ...
    properties:
      '@id':
        const: ada:analyteColumn/solutionQicpmsTAPP/interferenceCorrectionMethod
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  solutionQicpms_interferingSpecies:
    ...
    description: List of isobaric or polyatomic species mathematically corrected in
      data reduction. Analyte-specific. For Q-ICP-MS, common interferences include
      ArCl+ on 75As, MoO+ species on Cd isotopes, and BaO+ on Eu. Additional interference
      mitigation via KED or DRC is documented in Group 3 and Group 4.
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/solutionQicpmsTAPP/interferingSpecies
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - ada:dataType
    - schema:defaultValue
  solutionQicpms_internalAnalyticalPrecisionAndAssessmentMethod:
    title: Internal (Within-Measurement) Analytical Precision and Assessment Method
    description: Precision of a single measurement, derived from the scatter of the
      cycles, sweeps or integrations that make it up, together with the method used
      to assess it. State the statistic (2SE, 2SD, 1s RSD), the number of cycles it
    ...
    - schema:name
    - ada:dataType
  solutionQicpms_isobaricInterferenceCorrectionsApplied:
    title: Isobaric Interference Corrections Applied
    description: Whether mathematical corrections for isobaric or polyatomic interferences
      are applied during data reduction (in addition to any KED or DRC mitigation
      in the instrument).
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/solutionQicpmsTAPP/isobaricInterferenceCorrectionsApplied
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  solutionQicpms_limitOfQuantificationMethod:
    ...
    - schema:name
    - ada:dataType
  solutionQicpms_monitoredIsotopes:
    title: Monitored Isotopes
    ...
    properties:
      '@id':
        const: ada:analyteColumn/solutionQicpmsTAPP/monitoredIsotopes
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
  ...
  solutionSficpms_calibrationStrategyPerTargetSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  solutionSficpms_countingStatisticsError:
    title: Counting Statistics Error
    description: "Uncertainty predicted from counting statistics \u2014 the theoretical
      limit set by the Poisson distribution of the counts accumulated \u2014 for each
      reported quantity per analysis, with the sigma level stated. Derived from the
  ...
  solutionSficpms_detectionLimit:
    ...
    - schema:name
    - ada:dataType
  solutionSficpms_detectionLimitMethod:
    title: Detection Limit Method
    description: Method used to calculate detection limits for each reported concentration
      variable.
    type: object
  ...
  solutionSficpms_interferingSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  solutionSficpms_internalAnalyticalPrecisionAndAssessmentMethod:
    title: Internal (Within-Measurement) Analytical Precision and Assessment Method
    description: Precision of a single measurement, derived from the scatter of the
      cycles, sweeps or integrations that make it up, together with the method used
      to assess it. State the statistic (2SE, 2SD, 1s RSD), the number of cycles it
    ...
    - schema:name
    - ada:dataType
  solutionSficpms_isobaricInterferenceCorrectionsApplied:
    title: Isobaric Interference Corrections Applied
    description: Whether mathematical corrections for residual isobaric or polyatomic
      interferences are applied in data reduction (supplementary to any interference
      suppression achieved through mass resolution selection).
    type: object
    properties:
      '@id':
  ...
  solutionSficpms_massResolutionAssignment:
    ...
    - ada:dataType
    - schema:defaultValue
  solutionSficpms_massResolutionPerAnalyte:
    title: Mass Resolution per Analyte
    description: Mass resolution mode assigned to each analyte in this procedure.
      The selected resolution determines which polyatomic interferences are physically
      resolved by the magnet sector. Per-analyte assignments are documented here;
      the overall mode(s) used in the procedure are recorded in Mass Resolution Setting
      (Group 3). Analyte-specific field.
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/solutionSficpmsTAPP/massResolutionPerAnalyte
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
    ...
    - ada:dataType
    - schema:defaultValue
  solutionSficpms_monitoredIsotopes:
    title: Monitored Isotopes
    description: Specific isotope(s) monitored in this procedure, grouped by the analyte
      element they serve where they serve one. Includes interference-monitor and internal-standard
      masses, which serve no analyte and so have no parent element. The analyte list
  ...
  spectrometerNumber:
    title: WDS Spectrometer Channel
    description: WDS spectrometer number used for this element.
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/spectrometerNumber
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: spectrometerNumber
      schema:name:
        const: WDS Spectrometer Channel
      ada:dataType:
        const: integer
    ...
    - schema:name
    - ada:dataType
  timeDependentIntensityCorrection:
    title: Time-Dependent Intensity Correction
    description: Type of time-dependent intensity (TDI) correction applied to compensate
    ...
    - schema:name
    - ada:dataType
  typicalAnalyticalAccuracy:
    title: Typical Analytical Accuracy
    description: Offset between measured and accepted reference values for secondary
      standards, expressed as % relative bias.
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/typicalAnalyticalAccuracy
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: typicalAnalyticalAccuracy
      schema:name:
        const: Typical Analytical Accuracy
      ada:dataType:
        const: string
      schema:readonlyValue:
        const: true
    ...
    - schema:name
    - ada:dataType
  typicalAnalyticalPrecision:
    title: Typical Analytical Precision
    description: "Reproducibility of repeated measurements on the same or equivalent
      standard, expressed as 1\u03C3 relative standard deviation (%)."
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/typicalAnalyticalPrecision
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: typicalAnalyticalPrecision
      schema:name:
        const: Typical Analytical Precision
      ada:dataType:
        const: string
      schema:readonlyValue:
        const: true
    ...
    - schema:name
    - ada:dataType
  typicalCountingStatisticsError:
    title: Typical Counting Statistics Error
    description: "1\u03C3 uncertainty propagated from counting statistics on peak
      and background intensities."
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/typicalCountingStatisticsError
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: typicalCountingStatisticsError
      schema:name:
        const: Typical Counting Statistics Error
      ada:dataType:
        const: string
      schema:readonlyValue:
        const: true
    ...
    - schema:name
    - ada:dataType
  typicalDetectionLimit:
    title: Typical Detection Limit
    description: "Method detection limit at 99% confidence (3\u03C3) for each measured
      element."
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/typicalDetectionLimit
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: typicalDetectionLimit
      schema:name:
        const: Typical Detection Limit
      ada:dataType:
        const: string
      schema:readonlyValue:
        const: true
  ...
  wdsDetectorType:
    title: Proportional Counter / Detector
    description: Type of detector used in the WDS spectrometer for this element.
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/wdsDetectorType
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: wdsDetectorType
      schema:name:
        const: Proportional Counter / Detector
      ada:dataType:
        const: string
  ...
  xrayEmissionLine:
    title: X-ray Line
    description: The X-ray emission line measured for this element.
    type: object
    properties:
      '@id':
        const: ada:analyteColumn/empaTAPP/xrayEmissionLine
      '@type':
        const:
        - schema:PropertyValueSpecification
      schema:valueName:
        const: xrayEmissionLine
      schema:name:
        const: X-ray Line
      ada:dataType:
        const: string
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/registry/analyteColumns/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/registry/analyteColumns/schema.yaml)
...
* Path: `_sources/registry/analyteColumns`
