...
$defs:
  ...
  empa_secondaryReferenceMaterials:
    ...
    - schema:name
    - schema:value
  empa_fundingSourceForProcedureDevelopment:
    title: Funding Source for Procedure Development
    description: Grants and other funding sources that supported instrument acquisition,
      major upgrades, procedure development, and associated personnel time. Include
      grant numbers and funding agencies where applicable.
    type: object
    properties:
      '@id':
        const: ada:parameter/empaTAPP/fundingSourceForProcedureDevelopment
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/empaTAPP/fundingSourceForProcedureDevelopment
      schema:name:
        const: Funding Source for Procedure Development
      schema:value:
        type: string
    required:
    - '@id'
    ...
    - schema:name
    - schema:value
  empa_procedureReference:
    title: Procedure Reference(s)
    description: DOI or URL for peer-reviewed publications or technical reports describing,
      validating, or benchmarking this procedure.
    type: object
    properties:
      '@id':
        const: ada:parameter/empaTAPP/procedureReference
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/empaTAPP/procedureReference
      schema:name:
        const: Procedure Reference(s)
      schema:value:
        type: string
    required:
    - '@id'
  ...
  empa_interferenceCorrectionStandard:
    ...
    - schema:name
    - schema:value
  geochron_coupledProcedureDoi:
    title: Coupled Procedure DOI
    description: Registered procedure DOI for the coupled technique named above.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/coupledProcedureDoi
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/coupledProcedureDoi
      schema:name:
        const: Coupled Procedure DOI
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  geochron_coupledDatasetOrPublicationReference:
    title: Coupled Dataset or Publication Reference
    description: DOI or persistent identifier for the co-registered dataset or publication
      reporting both datasets together.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/coupledDatasetOrPublicationReference
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/coupledDatasetOrPublicationReference
      schema:name:
        const: Coupled Dataset or Publication Reference
      schema:value:
        type: string
  ...
  geochron_imaging:
    title: Imaging
    description: Pre-ablation characterisation imaging (typically cathodoluminescence
      [CL] or backscattered electron [BSE]) used to reveal internal zoning, inherited
      cores, and metamict domains for selecting valid spot locations, including the
      imaging instrument and settings used.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/imaging
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/imaging
      schema:name:
        const: Imaging
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  geochron_samplePreparationMethod:
    title: Sample Preparation Method
    description: Standard cross-TAPP description of how samples were prepared for
      analysis (mounting, polishing, coating, etc.).
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/samplePreparationMethod
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/samplePreparationMethod
      schema:name:
        const: Sample Preparation Method
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  geochron_samplePersistentIdentifier:
    title: Sample Persistent Identifier
    description: Globally unique, persistent identifier for the analysed sample. IGSN
      is the recommended standard for geological and cosmochemical samples.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/samplePersistentIdentifier
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/samplePersistentIdentifier
      schema:name:
        const: Sample Persistent Identifier
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  geochron_preAblationSurfaceTreatment:
    ...
    description: Procedure applied immediately before each analysis to remove surface
      ...
      preparation. Pre-ablation pulses are typically discarded before signal acquisition
      begins.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/preAblationSurfaceTreatment
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/preAblationSurfaceTreatment
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_instrumentSerialNumberOrLabIdentifier:
    ...
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/instrumentSerialNumberOrLabIdentifier
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/instrumentSerialNumberOrLabIdentifier
      schema:name:
  ...
  geochron_torchDepth:
    ...
    description: Distance between the load coil and the sampling cone tip (mm), also
      called injector depth or torch position. Affects ion transmission efficiency,
      oxide formation, and doubly-charged species production.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/torchDepth
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/torchDepth
      schema:name:
        const: Torch Depth
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  geochron_massResolutionSetting:
    title: Mass Resolution Setting
    description: Operating mass resolution of the mass analyser. Fixed at unit resolution
      for quadrupole instruments; selectable (low/medium/high) for sector-field instruments
      to balance sensitivity against interference suppression; not applicable in the
      same sense for multi-collector instruments running static low-resolution collection
      (see Faraday Cup Array Configuration and Collector Configuration for MC-specific
      detail).
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/massResolutionSetting
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/massResolutionSetting
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_spotDiameter:
    title: Spot Diameter
    description: Diameter of the laser spot as set in the acquisition method (nominal/target
      value).
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/spotDiameter
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/spotDiameter
      schema:name:
        const: Spot Diameter
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  geochron_laserFluence:
    title: Laser Fluence (Energy Density)
    description: Laser pulse energy per unit area at the sample surface, the primary
      control on ablation rate and crater morphology.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/laserFluence
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/laserFluence
      schema:name:
    ...
    - schema:value
    - schema:unitText
  geochron_laserRepetitionRate:
    title: Laser Repetition Rate
    description: Laser pulse repetition rate.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/laserRepetitionRate
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/laserRepetitionRate
      schema:name:
    ...
    - schema:value
    - schema:unitText
  geochron_ablationDurationPerSpot:
    title: Ablation Duration per Spot
    description: Total on-sample ablation time per spot, as set in the acquisition
      method.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/ablationDurationPerSpot
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/ablationDurationPerSpot
      schema:name:
    ...
    - schema:value
    - schema:unitText
  geochron_ablationPitDepthAblationRate:
    ...
    description: Depth of the ablation pit produced under the registered laser conditions,
      the method used to measure it, and the resulting per-pulse ablation rate. Characterises
      the achievable depth/time resolution of the procedure.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/ablationPitDepthAblationRate
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/ablationPitDepthAblationRate
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_carrierGasAndFlowRate:
    title: Carrier Gas and Flow Rate
    description: Identity and plumbing configuration of the gas used to transport
      the ablated aerosol from the cell to the torch, including the procedure-registered
      flow rate(s).
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/carrierGasAndFlowRate
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/carrierGasAndFlowRate
      schema:name:
  ...
  geochron_rfPower:
    title: RF Power (W)
    description: ICP radiofrequency forward power. Session-tunable within procedure-defined
      bounds during plasma optimisation; consistent with the analogous, tunable treatment
      of RF Power across LA-Q/SF-ICP-MS and all three solution ICP-MS TAPPs.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/rfPower
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/rfPower
      schema:name:
        const: RF Power (W)
      schema:value:
        anyOf:
    ...
    - schema:value
    - schema:unitText
  geochron_makeUpGasFlow:
    title: "Make-up Gas Flow (L min\u207B\xB9)"
    description: Source and estimated flow rate of any make-up gas added downstream
      of the ablation cell, including any desolvating nebuliser used for tracer co-aspiration.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/makeUpGasFlow
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/makeUpGasFlow
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_coolantGasFlowRate:
    title: Coolant (Plasma) Gas Flow Rate
    description: Flow rate of the outer (coolant/plasma) argon gas stream that sustains
      the ICP plasma. Determines plasma volume and stability.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/coolantGasFlowRate
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/coolantGasFlowRate
      schema:name:
    ...
    - schema:value
    - schema:unitText
  geochron_auxiliaryGasFlowRate:
    title: Auxiliary Gas Flow Rate
    description: Flow rate of the intermediate (auxiliary) argon gas stream that positions
      the plasma relative to the load coil. Affects ion extraction efficiency and
      oxide production rates.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/auxiliaryGasFlowRate
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/auxiliaryGasFlowRate
      schema:name:
    ...
    - schema:value
    - schema:unitText
  geochron_massesMeasured:
    title: Masses Measured
    description: Mass-to-charge positions (isotope masses) this procedure is designed
      to measure. Defines the scope of the procedure; the analyst may record the specific
      subset actually measured in a given session.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/massesMeasured
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/massesMeasured
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_integrationTimePerPeakDwellTimesQuadrupoleSettlingTimeBetweenMassJumps:
    title: Integration Time per Peak/Dwell Times; Quadrupole Settling Time Between
      Mass Jumps
    description: Count time (dwell time) per mass position for each measured isotope,
      and the settling time allowed between mass jumps, as reported in Table 3 of
      Horstwood et al. (2016). Applies to sequential (Q/SF) mass-hopping acquisition;
      for simultaneous multi-collector acquisition see Number of Blocks per Measurement,
      Number of Cycles per Block, and Integration Time per Cycle.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/integrationTimePerPeakDwellTimesQuadrupoleSettlingTimeBetweenMassJumps
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/integrationTimePerPeakDwellTimesQuadrupoleSettlingTimeBetweenMassJumps
      schema:name:
        const: Integration Time per Peak/Dwell Times; Quadrupole Settling Time Between
          Mass Jumps
      schema:value:
        type: string
    required:
    ...
    - schema:name
    - schema:value
  geochron_totalIntegrationTimePerOutputDataPoint:
    title: Total Integration Time per Output Data Point (s)
    description: Total duty-cycle time for one complete mass-scan sweep (sum of all
      per-isotope dwell times and settling times), which sets the time resolution
      of the down-hole signal. Applies to sequential (Q/SF) acquisition.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/totalIntegrationTimePerOutputDataPoint
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/totalIntegrationTimePerOutputDataPoint
      schema:name:
    ...
    - schema:value
    - schema:unitText
  geochron_numberOfBlocksPerMeasurement:
    title: Number of Blocks per Measurement
    description: Number of measurement blocks acquired per spot. Each block typically
      begins with a baseline (on-peak zero) measurement before the analytical cycles.
      Multiple blocks allow inspection of signal stability and within-measurement
      drift.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/numberOfBlocksPerMeasurement
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/numberOfBlocksPerMeasurement
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_numberOfCyclesPerBlock:
    ...
    description: Number of measurement cycles acquired per block. One cycle corresponds
      ...
      in Integration Time per Cycle.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/numberOfCyclesPerBlock
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/numberOfCyclesPerBlock
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_integrationTimePerCycle:
    title: Integration Time per Cycle
    description: "Duration of signal integration per measurement cycle. Total integration
      time per spot = (Number of Cycles per Block) \xD7 (Integration Time per Cycle)
      \xD7 (Number of Blocks per Measurement)."
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/integrationTimePerCycle
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/integrationTimePerCycle
      schema:name:
    ...
    - schema:value
    - schema:unitText
  geochron_sensitivityAsUsefulYield:
    title: '''Sensitivity'' as Useful Yield (%, element)'
    description: "Instrument sensitivity expressed as useful yield \u2014 the percentage
      of sampled atoms of a given element that are ultimately detected as ions \u2014
      for the analytical session, following the method cited."
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/sensitivityAsUsefulYield
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/sensitivityAsUsefulYield
      schema:name:
        const: '''Sensitivity'' as Useful Yield (%, element)'
      schema:value:
        type: string
    required:
    - '@id'
  ...
  geochron_icDeadTime:
    ...
    description: Dead time of each ion-counting detector channel, used in dead-time
      correction of high count rates.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/icDeadTime
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/icDeadTime
      schema:name:
  ...
  geochron_signalSmoothing:
    ...
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/signalSmoothing
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/signalSmoothing
      schema:name:
  ...
  geochron_icpTuning:
    ...
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/icpTuning
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/icpTuning
      schema:name:
        const: ICP Tuning
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  geochron_doublyChargedSpeciesMonitor:
    title: Doubly-Charged Species Monitor
    description: "The mass ratio monitored to estimate doubly-charged ion (M\xB2\u207A)
      formation during instrument tuning."
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/doublyChargedSpeciesMonitor
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/doublyChargedSpeciesMonitor
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_doublyChargedSpeciesProduction:
    ...
    description: Measured percentage of doubly-charged ion production for the monitored
      species at the time of instrument tuning.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/doublyChargedSpeciesProduction
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/doublyChargedSpeciesProduction
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_analysisSequence:
    title: Analysis Sequence
    description: Repeating order of primary calibration standard(s), quality control
      standard(s), and unknown analyses within a measurement session.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/analysisSequence
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/analysisSequence
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_collisionGasFlowRate:
    title: Collision Gas Flow Rate
    description: Flow rate of the collision gas in KED mode. Higher flow rates provide
      greater interference suppression at the cost of analyte sensitivity. Applies
      to quadrupole-based instruments and to collision-cell-equipped multi-collector
      instruments (e.g., Nu Sapphire, Thermo Neoma MS/MS) operating in KED mode.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/collisionGasFlowRate
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/collisionGasFlowRate
      schema:name:
    ...
    - schema:value
    - schema:unitText
  geochron_cellExitDiscriminationVoltage:
    title: Cell Exit Discrimination Voltage
    description: Kinetic energy discrimination offset voltage applied at the exit
      of the collision cell in KED mode. Applies to quadrupole-based instruments and
      to collision-cell-equipped multi-collector instruments (e.g., Nu Sapphire, Thermo
      Neoma MS/MS) operating in KED mode.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/cellExitDiscriminationVoltage
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/cellExitDiscriminationVoltage
      schema:name:
    ...
    - schema:value
    - schema:unitText
  geochron_reactionGasFlowRate:
    title: Reaction Gas Flow Rate
    description: Flow rate of the reactive gas introduced into the dynamic reaction
      cell (DRC). Applies to quadrupole-based instruments and to collision-cell-equipped
      multi-collector instruments (e.g., Nu Sapphire, Thermo Neoma MS/MS) operating
      in DRC mode.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/reactionGasFlowRate
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/reactionGasFlowRate
      schema:name:
    ...
    - schema:value
    - schema:unitText
  geochron_otherInformation:
    title: Other Information
    description: "Supplementary methodological context not captured by the structured
      fields above, as reported in Table 3 of Horstwood et al. (2016) \u2014 in the
      source paper's own example, notes on ablation-cell and sample-line configuration
      for depth-profiling/single-pulse ablation studies, a variant not otherwise in
      scope for this single-mode (Spot Analysis) TAPP."
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/otherInformation
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/otherInformation
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_constantsAndReferenceValuesUsed:
    title: Constants and Reference Values Used
    description: 'Physical constants and reference values used in data reduction to
      calculate the final reported quantity (e.g., decay constants for age calculation,
      the 238U/235U ratio used to convert measured 235U-based data to 207Pb/235U,
      or other citable reference values), together with their source. Distinct from
      Reference Material Information (Group 6), which documents accepted values for
      specific calibration/validation materials rather than universal physical constants.
      Critical for traceability: community-recommended values for decay constants
      and isotope ratios are periodically revised (e.g., the 238U/235U ratio revision
      by Hiess et al. 2012), and a reported age or ratio can only be correctly reinterpreted
      against a future revision if the constants originally used are known.'
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/constantsAndReferenceValuesUsed
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/constantsAndReferenceValuesUsed
      schema:name:
        const: Constants and Reference Values Used
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  geochron_uncertaintyLevelAndPropagation:
    title: Uncertainty Level and Propagation
    description: "Uncertainty level at which ages/ratios are quoted (e.g., 1\u03C3,
      2\u03C3) and the method used to propagate component uncertainties (e.g., quadratic
      addition) into the final reported value."
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/uncertaintyLevelAndPropagation
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/uncertaintyLevelAndPropagation
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_spikeOutlierFilteringApproach:
    ...
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/spikeOutlierFilteringApproach
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/spikeOutlierFilteringApproach
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_doubleSpikeMixingRatio:
    title: Double-Spike Mixing Ratio
    description: Target proportion of double-spike signal relative to total analyte
      signal in the spiked mixture. An optimal mixing ratio minimises error propagation
      through the double-spike inversion. Record 'N/A' if double-spike method is not
      used.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/doubleSpikeMixingRatio
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/doubleSpikeMixingRatio
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_memoryEffectMitigation:
    ...
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/memoryEffectMitigation
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/memoryEffectMitigation
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_normalizationStandardsBasedCorrection:
    title: Normalization/Standards-Based Correction
    description: Any post-acquisition normalization applied to correct for systematic
      biases identified from secondary reference materials.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/normalizationStandardsBasedCorrection
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/normalizationStandardsBasedCorrection
      schema:name:
        const: Normalization/Standards-Based Correction
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  geochron_primaryCalibrationStandardName:
    title: Primary Calibration Standard Name
    description: Primary reference material used to calibrate the instrument and convert
      raw signal intensities to ages/isotope ratios. Include citation for the accepted
      values used.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/primaryCalibrationStandardName
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/primaryCalibrationStandardName
      schema:name:
        const: Primary Calibration Standard Name
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  geochron_secondaryReferenceMaterials:
    title: Secondary Reference Materials
    description: Quality-control reference material(s) analysed as unknowns alongside
      samples in the same session to assess accuracy and monitor drift. Include citation/accepted
      values for each.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/secondaryReferenceMaterials
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/secondaryReferenceMaterials
      schema:name:
        const: Secondary Reference Materials
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  geochron_fundingSourceForProcedureDevelopment:
    title: Funding Source for Procedure Development
    description: Grants and other funding sources that supported instrument purchase,
      major upgrades, and procedure development. Include grant numbers and funding
      agencies.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/fundingSourceForProcedureDevelopment
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/fundingSourceForProcedureDevelopment
      schema:name:
        const: Funding Source for Procedure Development
      schema:value:
        type: string
  ...
  geochron_procedureReference:
    ...
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/procedureReference
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/procedureReference
      schema:name:
        const: Procedure Reference(s)
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  geochron_ablationCellType:
    title: Ablation Cell Type
    description: Type, design origin, and internal volume of the ablation cell. Cell
      volume is a primary determinant of aerosol washout time and therefore the achievable
      time resolution of the data.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/ablationCellType
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/ablationCellType
      schema:name:
        const: Ablation Cell Type
      schema:value:
        type: string
    required:
    - '@id'
    ...
    - schema:name
    - schema:value
  geochron_interfaceConeConfiguration:
    ...
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/interfaceConeConfiguration
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/interfaceConeConfiguration
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_samplerAndSkimmerConeMaterial:
    title: Sampler and Skimmer Cone Material
    description: Material composition of the sampler and skimmer cones. Nickel (Ni)
      is standard for most matrices; platinum (Pt) is used for high-TDS or organic-matrix
      samples.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/samplerAndSkimmerConeMaterial
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/samplerAndSkimmerConeMaterial
      schema:name:
  ...
  geochron_torchType:
    ...
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/torchType
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/torchType
      schema:name:
        const: Torch Type
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  geochron_guardElectrode:
    title: Guard Electrode
    description: Whether the guard electrode (also called extraction lens or Fassel
      torch shield) was active during analysis.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/guardElectrode
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/guardElectrode
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_collisionReactionCellConfiguration:
    title: Collision/Reaction Cell (CRC) Configuration
    description: Whether a collision or reaction cell is installed and its operating
      mode. Long-standard on quadrupole-based instruments; a small number of modern
      multi-collector instruments (e.g., Nu Instruments Sapphire, Thermo Scientific
      Neoma MS/MS) also add a hexapole collision/reaction cell upstream of the collector
      array, operated in the same STD/KED/DRC modes. Single-collector sector-field
      instruments have no commercially available collision/reaction cell option and
      resolve interferences by mass resolution alone.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/collisionReactionCellConfiguration
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/collisionReactionCellConfiguration
      schema:name:
        const: Collision/Reaction Cell (CRC) Configuration
      schema:value:
        type: string
    required:
    - '@id'
    ...
    - schema:name
    - schema:value
  geochron_faradayCupArrayConfiguration:
    title: Faraday Cup Array Configuration
    description: 'Description of the multi-collector Faraday cup array: total number
      of Faraday cup detectors (fixed and moveable), their labelled positions, and
      the presence and position of any ion counter (SEM) or Daly detector. The number
      and span of cups constrains which isotope combinations can be simultaneously
      collected.'
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/faradayCupArrayConfiguration
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/faradayCupArrayConfiguration
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_faradayCupAmplifierResistorValues:
    title: Faraday Cup Amplifier Resistor Values
    description: "Resistance values (\u03A9) of the feedback resistors in the Faraday
      cup amplifiers. Standard amplifiers use 10\xB9\xB9 \u03A9 resistors; high-gain
      amplifiers (10\xB9\xB2 or 10\xB9\xB3 \u03A9) are fitted to selected cups to
      improve signal-to-noise for very low-intensity beams (e.g., low-abundance Pb
      isotopes in young or low-U material)."
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/faradayCupAmplifierResistorValues
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/faradayCupAmplifierResistorValues
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_faradayCupGainCalibrationMethod:
    ...
    description: Method used to calibrate the relative gain (amplification factor)
      ...
      ratios if uncorrected. For instruments with ion-counting detectors, also describes
      the SEM-to-Faraday cross-calibration sequence.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/faradayCupGainCalibrationMethod
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/faradayCupGainCalibrationMethod
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_laserPulseDuration:
    title: Laser Pulse Duration
    description: Duration of each individual laser pulse. A fixed hardware property
      of the laser system that determines the thermal vs. non-thermal ablation regime.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/laserPulseDuration
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/laserPulseDuration
      schema:name:
    ...
    - schema:value
    - schema:unitText
  geochron_laserBeamEnergyProfile:
    ...
    description: Spatial energy distribution of the laser beam at the sample surface,
      ...
      more uniform ablation craters than a Gaussian beam. Fixed hardware property.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/laserBeamEnergyProfile
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/laserBeamEnergyProfile
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_plasmaThermalMode:
    title: Plasma Thermal Mode
    description: Whether the ICP plasma is operated under cool plasma or normal (hot)
      plasma conditions. Normal plasma is standard for U-(Th-)Pb geochronology; cool
      plasma would reduce sensitivity for these high-mass analytes and is not typically
      used.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/plasmaThermalMode
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/plasmaThermalMode
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_collectorConfiguration:
    title: Collector Configuration
    description: Assignment of isotope masses to Faraday cup or ion counter detector
      positions for this procedure. For static multi-collection, one configuration
      applies throughout the measurement; for multi-dynamic procedures, lists all
      configurations and the cycling sequence. Includes interference-monitor masses
      collected alongside analyte isotopes.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/collectorConfiguration
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/collectorConfiguration
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_oxideProductionMethodAndThreshold:
    title: Oxide Production Method and Threshold
    description: "Method used to quantify plasma oxide production and the acceptance
      threshold applied before commencing analysis. ThO\u207A/Th\u207A (mass 248/232)
      is the standard proxy for U-Th-Pb geochronology, directly relevant to Th/U ratio
      accuracy."
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/oxideProductionMethodAndThreshold
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/oxideProductionMethodAndThreshold
      schema:name:
        const: Oxide Production Method and Threshold
      schema:value:
        type: string
    required:
    - '@id'
    ...
    - schema:name
    - schema:value
  geochron_instrumentWarmUpSessionDurationLimit:
    ...
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/instrumentWarmUpSessionDurationLimit
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/instrumentWarmUpSessionDurationLimit
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_baselineMeasurementApproach:
    title: Baseline Measurement Approach
    description: Method and timing for measuring the ion beam baseline (background)
      during acquisition, distinct from the data-processing-level blank subtraction
      method (see Gas Blank, Group 5). For LA-ICP-MS, baseline is measured with the
      laser off (gas blank), typically before each ablation or block.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/baselineMeasurementApproach
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/baselineMeasurementApproach
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_multiRunSequentialAnalysisDesign:
    title: Multi-Run Sequential Analysis Design
    description: Whether the procedure uses a single acquisition pass or multiple
      sequential runs on the same sample location, each optimised for different analytical
      objectives.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/multiRunSequentialAnalysisDesign
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/multiRunSequentialAnalysisDesign
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_signalCollectionMode:
    title: Signal Collection Mode
    description: "Mode used to collect ion signal across the monitored masses. In
      peak hopping mode, the quadrupole jumps sequentially between pre-set mass positions
      and dwells at each peak. Applicable only to quadrupole-based instruments; this
      concept does not extend to collision-cell-equipped multi-collector instruments
      (e.g., Nu Sapphire, Thermo Neoma MS/MS), whose collector array performs genuinely
      simultaneous multi-collection regardless of whether a collision/reaction cell
      is present upstream. Some such instruments (e.g., Neoma MS/MS) instead use a
      pre-cell mass filter of a fundamentally different, non-quadrupole design to
      pre-select a mass window before the cell \u2014 a distinct concept not currently
      captured by any field in this TAPP."
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/signalCollectionMode
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/signalCollectionMode
      schema:name:
        const: Signal Collection Mode
      schema:value:
        type: string
    required:
    - '@id'
    ...
    - schema:name
    - schema:value
  geochron_collisionGasType:
    title: Collision Gas Type
    description: Type of collision gas used in KED mode for polyatomic interference
      suppression. Applies to quadrupole-based instruments and to collision-cell-equipped
      multi-collector instruments (e.g., Nu Sapphire, Thermo Neoma MS/MS) operating
      in KED mode.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/collisionGasType
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/collisionGasType
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_reactionGasType:
    title: Reaction Gas Type
    description: Type of reactive gas introduced into the dynamic reaction cell (DRC)
      for interference removal through ion-molecule reactions. Applies to quadrupole-based
      instruments and to collision-cell-equipped multi-collector instruments (e.g.,
      Nu Sapphire, Thermo Neoma MS/MS) operating in DRC mode.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/reactionGasType
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/reactionGasType
      schema:name:
  ...
  geochron_massResolutionPerAnalyte:
    ...
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/massResolutionPerAnalyte
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/massResolutionPerAnalyte
      schema:name:
  ...
  geochron_eScanRange:
    ...
    description: Electric scan range used for peak acquisition, expressed as percentage
      of the centre mass. Varies the accelerating voltage to cover nearby masses without
      re-scanning the magnet. Applicable only to sector-field instruments.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/eScanRange
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/eScanRange
      schema:name:
        const: E-scan Range
      schema:value:
        anyOf:
    ...
    - schema:value
    - schema:unitText
  geochron_tripleScanningMode:
    title: Triple Scanning Mode
    description: Whether each mass peak is scanned three times per cycle and the results
      averaged, to reduce noise from short-term magnetic field instabilities. Applicable
      only to sector-field instruments with this capability.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/tripleScanningMode
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/tripleScanningMode
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_massFractionationLaw:
    title: Mass Fractionation Law
    description: Mathematical law used to parameterize instrumental isotope mass fractionation
      as a function of mass difference. Not stated in Table 3 (Horstwood et al. 2016)
      for the worked example; the exponential law is most widely used and theoretically
      best justified for MC-ICP-MS.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/massFractionationLaw
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/massFractionationLaw
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_perAnalyteCalibrationStrategy:
    title: Per-Analyte Calibration Strategy
    description: Documents cases where different analytes are calibrated using different
      strategies within the same session. If a single strategy applies uniformly,
      record that here.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/perAnalyteCalibrationStrategy
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/perAnalyteCalibrationStrategy
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_matrixOffsetCorrection:
    ...
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/matrixOffsetCorrection
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/matrixOffsetCorrection
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_signalIntegrationIntervalMethod:
    title: Signal Integration Interval Method
    description: Approach used to select the stable signal interval for integration
      during data reduction, and to exclude anomalous signals from inclusions, cracks,
      or mixed domains. Central to interpreting excess scatter/MSWD in the resulting
      age population.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/signalIntegrationIntervalMethod
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/signalIntegrationIntervalMethod
      schema:name:
        const: Signal Integration Interval Method
      schema:value:
        type: string
    required:
    - '@id'
  ...
  geochron_isobaricInterferenceCorrectionsApplied:
    ...
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/isobaricInterferenceCorrectionsApplied
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/isobaricInterferenceCorrectionsApplied
      schema:name:
  ...
  geochron_interferingSpecies:
    ...
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/interferingSpecies
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/interferingSpecies
      schema:name:
  ...
  geochron_interferenceCorrectionMethod:
    ...
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/interferenceCorrectionMethod
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/interferenceCorrectionMethod
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_isotopeDilutionDataReductionMethod:
    title: Isotope Dilution Data Reduction Method
    description: "Mass balance approach used to calculate sample mass fractions from
      spike-sample isotope ratio measurements, relevant when a concentration spike
      (e.g., \xB2\xB3\u2075U, as in Table 3's own worked example) is co-aspirated.
      Record 'None' if isotope dilution is not used."
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/isotopeDilutionDataReductionMethod
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/isotopeDilutionDataReductionMethod
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_doubleSpikeIsotopePair:
    title: Double-Spike Isotope Pair
    description: The pair of enriched isotopes used to construct a double spike for
      combined mass bias and/or common-Pb correction. Both isotopes must be naturally
      rare and free from isobaric interferences. Record 'N/A' if double-spike method
      is not used.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/doubleSpikeIsotopePair
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/doubleSpikeIsotopePair
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_doubleSpikeInversionAlgorithm:
    title: Double-Spike Inversion Algorithm
    description: Mathematical algorithm used to simultaneously solve for the true
      sample isotope ratio and the mass fractionation factor from the measured spike-sample
      mixture. Record 'N/A' if double-spike method is not used.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/doubleSpikeInversionAlgorithm
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/doubleSpikeInversionAlgorithm
      schema:name:
    ...
    - schema:name
    - schema:value
  geochron_calibrationStandardMeasurementFrequency:
    title: Calibration Standard Measurement Frequency
    description: How often the primary calibration standard is measured relative to
      unknown samples within a session, i.e. the bracketing interval used to monitor
      and correct for instrumental drift. Implied but not stated explicitly in Table
      3 (Horstwood et al. 2016) via the validation-material n counts.
    type: object
    properties:
      '@id':
        const: ada:parameter/geochronTAPP/calibrationStandardMeasurementFrequency
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/geochronTAPP/calibrationStandardMeasurementFrequency
      schema:name:
        const: Calibration Standard Measurement Frequency
      schema:value:
        type: string
    required:
    - '@id'
    ...
    - schema:name
    - schema:value
  laicpms_coupledProtocolDoi:
    title: Coupled Protocol DOI
    description: Registered protocol DOI for the coupled technique named above. Provides
      a stable, citable link to the companion method independent of whether a dataset
      has been deposited. If the coupled protocol has not yet been registered, enter
      the DOI of a publication describing the coupled method, or "pending". Enter
      "None" if no coupling is planned.
    type: object
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/coupledProtocolDoi
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/coupledProtocolDoi
      schema:name:
        const: Coupled Protocol DOI
      schema:value:
        type: string
    required:
    - '@id'
    ...
    - schema:name
    - schema:value
  laicpms_coupledDatasetOrPublicationReference:
    title: Coupled Dataset or Publication Reference
    description: 'DOI or other persistent identifier for the co-registered dataset
      or publication where both datasets are reported together. Accepts: a dedicated
      dataset DOI (if separately deposited), a shared dataset DOI (if co-submitted
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/coupledDatasetOrPublicationReference
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/coupledDatasetOrPublicationReference
      schema:name:
        const: Coupled Dataset or Publication Reference
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  laicpms_samplePersistentIdentifier:
    title: Sample Persistent Identifier
    description: Globally unique, persistent identifier for the analysed sample. IGSN
      (International Geo Sample Number) is the recommended standard for geological
      and cosmochemical samples, as used by Astromat, EarthChem, and SESAR.
    type: object
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/samplePersistentIdentifier
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/samplePersistentIdentifier
      schema:name:
        const: Sample Persistent Identifier
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  laicpms_fusionFluxAndDilutionRatio:
    title: Fusion Flux and Dilution Ratio
    description: For protocols using fused glass, the flux type and sample:flux dilution
      ratio used to prepare the analytical glass.
    type: object
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/fusionFluxAndDilutionRatio
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/fusionFluxAndDilutionRatio
      schema:name:
    ...
    - schema:name
    - schema:value
  laicpms_preAblationSurfaceTreatment:
    title: Pre-Ablation Surface Treatment
    description: Protocol applied immediately before each analysis to remove surface
      contamination or condition the sample surface. Distinct from general sample
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/preAblationSurfaceTreatment
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/preAblationSurfaceTreatment
      schema:name:
        const: Pre-Ablation Surface Treatment
      schema:value:
        type: string
  ...
  laicpms_instrumentIdentifier:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/instrumentIdentifier
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/instrumentIdentifier
      schema:name:
        const: Instrument Serial Number or Lab Identifier
      schema:value:
        type: string
  ...
  laicpms_torchDepth:
    ...
    description: Distance between the load coil and the sampling cone tip (mm), also
      ...
      production. The protocol specifies a target value optimised during initial setup;
      the analyst confirms or fine-adjusts during session tuning.
    type: object
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/torchDepth
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/torchDepth
      schema:name:
        const: Torch Depth
      schema:value:
        type: string
  ...
  laicpms_massResolutionSetting:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/massResolutionSetting
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/massResolutionSetting
      schema:name:
        const: Mass Resolution Setting
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  laicpms_spotGeometry:
    title: Laser Spot Geometry
    description: "Shape and dimensions of the laser ablation spot in micrometres registered
      by the protocol. For circular spots, report diameter; for square or rectangular
      spots, report width \xD7 length. The protocol registers the typical geometry;
      analysts may adjust within protocol-allowed range."
    type: object
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/spotGeometry
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/spotGeometry
      schema:name:
  ...
  laicpms_laserEnergy:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/laserEnergy
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/laserEnergy
      schema:name:
        const: Laser Energy
      schema:value:
        anyOf:
  ...
  laicpms_laserFluence:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/laserFluence
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/laserFluence
      schema:name:
        const: Laser Fluence (Energy Density)
      schema:value:
        anyOf:
  ...
  laicpms_laserRepetitionRate:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/laserRepetitionRate
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/laserRepetitionRate
      schema:name:
        const: Laser Repetition Rate
      schema:value:
        anyOf:
  ...
  laicpms_ablationSpotDuration:
    ...
    description: 'Total on-sample ablation (signal acquisition) time per individual
      ...
      For transect analysis, the equivalent protocol-level parameter is scan speed
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/ablationSpotDuration
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/ablationSpotDuration
      schema:name:
        const: Ablation Duration per Spot
      schema:value:
        anyOf:
  ...
  laicpms_transectOrMappingRateOrStepSize:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/transectOrMappingRateOrStepSize
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/transectOrMappingRateOrStepSize
      schema:name:
  ...
  laicpms_rasterLineSpacing:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/rasterLineSpacing
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/rasterLineSpacing
      schema:name:
    ...
    - schema:name
    - schema:value
  laicpms_carrierGasFlowRate:
    title: Carrier Gas and Flow Rate
    description: "Gas used to transport ablated aerosol from the ablation cell to
      the ICP-MS torch, with the protocol-registered target flow rate(s). Helium is
      standard for most UV laser systems due to superior aerosol transport. Flow rates
      are protocol targets; actual session values may be adjusted within \xB110% during
      tuning."
    type: object
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/carrierGasFlowRate
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/carrierGasFlowRate
      schema:name:
        const: Carrier Gas and Flow Rate
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  laicpms_plasmaMakeUpGasAddition:
    title: Plasma / Make-up Gas Addition
    description: "Additional gas(es) mixed into the carrier stream downstream of the
      ablation cell, with the protocol-registered target flow rate. Ar make-up gas
      is standard. Small N\u2082 additions can enhance sensitivity for some elements.
      If N\u2082 is not added, state \"None\" explicitly to distinguish from not reported."
    type: object
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/plasmaMakeUpGasAddition
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/plasmaMakeUpGasAddition
      schema:name:
  ...
  laicpms_coolantGasFlowRate:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/coolantGasFlowRate
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/coolantGasFlowRate
      schema:name:
        const: Coolant (Plasma) Gas Flow Rate
      schema:value:
        anyOf:
  ...
  laicpms_auxiliaryGasFlowRate:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/auxiliaryGasFlowRate
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/auxiliaryGasFlowRate
      schema:name:
        const: Auxiliary Gas Flow Rate
      schema:value:
        anyOf:
  ...
  laicpms_rfPower:
    title: RF Power
    description: ICP radiofrequency forward power in watts. Fixed in the protocol;
      cannot be changed by analysts without defining a new protocol, because RF power
      affects plasma temperature, ionisation efficiency, oxide formation, and whether
      cool or normal plasma conditions are in effect.
    type: object
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/rfPower
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/rfPower
      schema:name:
        const: RF Power
      schema:value:
        anyOf:
  ...
  laicpms_signalSmoothing:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/signalSmoothing
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/signalSmoothing
      schema:name:
        const: Signal Smoothing
      schema:value:
        type: string
  ...
  laicpms_icPlasmaTuning:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/icPlasmaTuning
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/icPlasmaTuning
      schema:name:
        const: ICP Tuning
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  laicpms_doublyChargedSpeciesMonitor:
    title: Doubly-Charged Species Monitor
    description: "The mass ratio monitored to estimate doubly-charged ion (M\xB2\u207A)
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/doublyChargedSpeciesMonitor
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/doublyChargedSpeciesMonitor
      schema:name:
        const: Doubly-Charged Species Monitor
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  laicpms_doublyChargedSpeciesProduction:
    title: Doubly-Charged Species Production
    description: Measured percentage of doubly-charged ion production for the monitored
      species at the time of instrument tuning. The protocol should specify the acceptable
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/doublyChargedSpeciesProduction
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/doublyChargedSpeciesProduction
      schema:name:
        const: Doubly-Charged Species Production
      schema:value:
        type: string
  ...
  laicpms_analysisSequence:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/analysisSequence
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/analysisSequence
      schema:name:
        const: Analysis Sequence
      schema:value:
        type: string
  ...
  laicpms_collisionGasFlowRate:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/collisionGasFlowRate
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/collisionGasFlowRate
      schema:name:
        const: Collision Gas Flow Rate
      schema:value:
        anyOf:
    ...
    - schema:value
    - schema:unitText
  laicpms_cellExitDiscriminationVoltage:
    title: Cell Exit Discrimination Voltage
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/cellExitDiscriminationVoltage
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/cellExitDiscriminationVoltage
      schema:name:
        const: Cell Exit Discrimination Voltage
      schema:value:
        anyOf:
  ...
  laicpms_reactionGasFlowRate:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/reactionGasFlowRate
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/reactionGasFlowRate
      schema:name:
        const: Reaction Gas Flow Rate
      schema:value:
        anyOf:
  ...
  laicpms_dwellTime:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/dwellTime
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/dwellTime
      schema:name:
  ...
  laicpms_backgroundCountTime:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/backgroundCountTime
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/backgroundCountTime
      schema:name:
    ...
    - schema:value
    - schema:unitText
  laicpms_outlierFiltering:
    title: Spike / Outlier Filtering Approach
    description: Method used to identify and remove anomalous signal spikes arising
      from micronuggets, inclusions, cracks, or instrument artifacts during time-resolved
      signal processing. Editable because the specific implementation may vary between
      sessions while remaining within the protocol framework.
    type: object
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/outlierFiltering
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/outlierFiltering
      schema:name:
        const: Spike / Outlier Filtering Approach
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  laicpms_nonlinearResponseCorrection:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/nonlinearResponseCorrection
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/nonlinearResponseCorrection
      schema:name:
    ...
    - schema:name
    - schema:value
  laicpms_memoryEffectMitigation:
    title: Memory Effect Mitigation
    description: Protocol applied to identify and minimise memory effects from high-concentration
      elements in the previous sample or standard that may contaminate subsequent
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/memoryEffectMitigation
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/memoryEffectMitigation
      schema:name:
        const: Memory Effect Mitigation
      schema:value:
        type: string
  ...
  laicpms_postAcquisitionNormalization:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/postAcquisitionNormalization
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/postAcquisitionNormalization
      schema:name:
        const: Normalization / Standards-Based Correction
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  laicpms_primaryCalibrationStandardName:
    title: Primary Calibration Standard Name
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/primaryCalibrationStandardName
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/primaryCalibrationStandardName
      schema:name:
        const: Primary Calibration Standard Name
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  laicpms_secondaryReferenceMaterial:
    title: Secondary Reference Materials
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/secondaryReferenceMaterial
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/secondaryReferenceMaterial
      schema:name:
        const: Secondary Reference Materials
      schema:value:
        type: string
  ...
  laicpms_torchType:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/torchType
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/torchType
      schema:name:
        const: Torch Type
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  laicpms_laserBeamEnergyProfile:
    title: Laser Beam Energy Profile
    description: Spatial energy distribution of the laser beam at the sample surface,
      and whether a beam homogenizer is installed. A flat-top (top-hat) profile produces
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/laserBeamEnergyProfile
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/laserBeamEnergyProfile
      schema:name:
        const: Laser Beam Energy Profile
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  laicpms_laserPulseDuration:
    title: Laser Pulse Duration
    description: 'Duration of each individual laser pulse, including units. Pulse
      duration determines the ablation regime: nanosecond (ns) pulses involve significant
      thermal effects and elemental fractionation; femtosecond (fs) pulses are non-thermal
      and substantially reduce elemental fractionation and matrix effects. This is
      a fixed hardware property of the laser system.'
    type: object
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/laserPulseDuration
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
    ...
    - schema:name
    - schema:value
  laicpms_instrumentWarmUpSessionDurationLimit:
    title: Instrument Warm-up / Session Duration Limit
    description: Minimum warm-up time required after plasma ignition before analyses
      begin, and any maximum session duration enforced to maintain stable operating
      conditions. These constraints are part of the protocol and cannot be varied
      by the analyst.
    type: object
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/instrumentWarmUpSessionDurationLimit
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/instrumentWarmUpSessionDurationLimit
      schema:name:
        const: Instrument Warm-up / Session Duration Limit
      schema:value:
        type: string
  ...
  laicpms_eScanRange:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/eScanRange
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/eScanRange
      schema:name:
        const: E-scan Range
      schema:value:
        anyOf:
    ...
    - schema:value
    - schema:unitText
  laicpms_tripleScanningMode:
    title: Triple Scanning Mode
    description: Whether each mass peak is scanned three times per cycle and the results
      averaged (Y/N). Used to reduce noise from short-term magnetic field instabilities
      on sector-field instruments. In LA-SF-ICP-MS, triple scanning affects the effective
      integration time per cycle and should be reported. Record 'N/A' if not applicable
      to the instrument.
    type: object
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/tripleScanningMode
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/tripleScanningMode
      schema:name:
        const: Triple Scanning Mode
      schema:value:
        type: string
  ...
  laicpms_reactionGasType:
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/reactionGasType
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/reactionGasType
      schema:name:
        const: Reaction Gas Type
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  laicpms_multiRunSequentialAnalysisDesign:
    title: Multi-Run Sequential Analysis Design
    description: Whether the protocol uses a single acquisition pass or multiple sequential
      runs on the same sample location, each optimized for different analytical objectives.
      For multi-run designs, describe the number of runs, their purpose, key laser
      and instrument settings per run, and how outputs of one run feed into data reduction
      of another. Not applicable to raster mapping, where each spatial location is
      visited exactly once.
    type: object
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/multiRunSequentialAnalysisDesign
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/multiRunSequentialAnalysisDesign
      schema:name:
        const: Multi-Run Sequential Analysis Design
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  laicpms_matrixOffsetCorrection:
    title: Matrix Offset Correction (LIEF)
    description: Whether an empirical correction was applied to account for systematic
      differences in laser-induced elemental fractionation (LIEF) patterns between
      the external calibration standard and the sample matrix.
    ...
    properties:
      '@id':
        const: ada:parameter/laicpmsTAPP/matrixOffsetCorrection
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laicpmsTAPP/matrixOffsetCorrection
      schema:name:
        const: Matrix Offset Correction (LIEF)
      schema:value:
        type: string
  ...
  semComposition_secondaryReferenceMaterials:
    ...
    - schema:name
    - schema:value
  semComposition_fundingSourceForProcedureDevelopment:
    title: Funding Source for Procedure Development
    description: Grants and other funding sources that supported instrument acquisition,
      major upgrades, procedure development, and associated personnel time. Include
      grant numbers and funding agencies where applicable.
    ...
    properties:
      '@id':
        const: ada:parameter/semCompositionTAPP/fundingSourceForProcedureDevelopment
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/semCompositionTAPP/fundingSourceForProcedureDevelopment
      schema:name:
        const: Funding Source for Procedure Development
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  semComposition_procedureReference:
    title: Procedure Reference(s)
    description: DOI or URL for peer-reviewed publications or technical reports describing,
      validating, or benchmarking this procedure.
    type: object
    properties:
      '@id':
        const: ada:parameter/semCompositionTAPP/procedureReference
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/semCompositionTAPP/procedureReference
      schema:name:
        const: Procedure Reference(s)
      schema:value:
        type: string
  ...
  semFibsem_constantsAndReferenceValuesUsed:
    ...
    - schema:name
    - schema:value
  semFibsem_fundingSourceForProcedureDevelopment:
    title: Funding Source for Procedure Development
    description: Grants and other funding sources that supported instrument acquisition,
      major upgrades, procedure development, and associated personnel time. Include
      grant numbers and funding agencies where applicable.
    ...
    properties:
      '@id':
        const: ada:parameter/semFibsemTAPP/fundingSourceForProcedureDevelopment
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/semFibsemTAPP/fundingSourceForProcedureDevelopment
      schema:name:
        const: Funding Source for Procedure Development
      schema:value:
        type: string
  ...
  semFibsem_procedureReference:
    ...
    properties:
      '@id':
        const: ada:parameter/semFibsemTAPP/procedureReference
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/semFibsemTAPP/procedureReference
      schema:name:
        const: Procedure Reference(s)
      schema:value:
        type: string
  ...
  semImaging_clWavelengthCalibrationReference:
    ...
    - schema:name
    - schema:value
  semImaging_fundingSourceForProcedureDevelopment:
    title: Funding Source for Procedure Development
    description: Grants and other funding sources that supported instrument acquisition,
      major upgrades, procedure development, and associated personnel time. Include
      grant numbers and funding agencies where applicable.
    ...
    properties:
      '@id':
        const: ada:parameter/semImagingTAPP/fundingSourceForProcedureDevelopment
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/semImagingTAPP/fundingSourceForProcedureDevelopment
      schema:name:
        const: Funding Source for Procedure Development
      schema:value:
        type: string
  ...
  semImaging_procedureReference:
    ...
    properties:
      '@id':
        const: ada:parameter/semImagingTAPP/procedureReference
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/semImagingTAPP/procedureReference
      schema:name:
        const: Procedure Reference(s)
      schema:value:
        type: string
  ...
  solutionMcicpms_nebulizerGasFlowRate:
    ...
    - schema:value
    - schema:unitText
  solutionMcicpms_makeUpGasFlowRate:
    title: Make-up Gas Flow Rate
    description: Supplementary argon flow added downstream of a desolvation system
      to maintain total gas delivery to the plasma (L/min). Record 'N/A' if no desolvation
      system is used. Record 'N/A' where Desolvation System is 'None'.
    type: object
    properties:
      '@id':
  ...
  solutionMcicpms_secondaryReferenceMaterials:
    ...
    - schema:name
    - schema:value
  solutionMcicpms_fundingSourceForProcedureDevelopment:
    title: Funding Source for Procedure Development
    description: Grants and other funding sources that supported instrument acquisition,
      major upgrades, procedure development, and associated personnel time. Include
      grant numbers and funding agencies where applicable.
    ...
    properties:
      '@id':
        const: ada:parameter/solutionMcicpmsTAPP/fundingSourceForProcedureDevelopment
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/solutionMcicpmsTAPP/fundingSourceForProcedureDevelopment
      schema:name:
        const: Funding Source for Procedure Development
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  solutionMcicpms_procedureReference:
    title: Procedure Reference(s)
    description: DOI or URL for peer-reviewed publications or technical reports describing,
      validating, or benchmarking this procedure.
    type: object
    properties:
      '@id':
        const: ada:parameter/solutionMcicpmsTAPP/procedureReference
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/solutionMcicpmsTAPP/procedureReference
      schema:name:
        const: Procedure Reference(s)
      schema:value:
        type: string
  ...
  solutionQicpms_nebulizerGasFlowRate:
    ...
    - schema:value
    - schema:unitText
  solutionQicpms_makeUpGasFlowRate:
    title: Make-up Gas Flow Rate
    description: Supplementary argon flow added downstream of a desolvation system
      to maintain total gas delivery to the plasma (L/min). Record 'N/A' if no desolvation
      system is used. Record 'N/A' where Desolvation System is 'None'.
  ...
  solutionQicpms_secondaryReferenceMaterials:
    ...
    - schema:name
    - schema:value
  solutionQicpms_fundingSourceForProcedureDevelopment:
    title: Funding Source for Procedure Development
    description: Grants and other funding sources that supported instrument acquisition,
      major upgrades, procedure development, and associated personnel time. Include
      grant numbers and funding agencies where applicable.
    ...
    properties:
      '@id':
        const: ada:parameter/solutionQicpmsTAPP/fundingSourceForProcedureDevelopment
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/solutionQicpmsTAPP/fundingSourceForProcedureDevelopment
      schema:name:
        const: Funding Source for Procedure Development
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  solutionQicpms_procedureReference:
    title: Procedure Reference(s)
    description: DOI or URL for peer-reviewed publications or technical reports describing,
      validating, or benchmarking this procedure.
    type: object
    properties:
      '@id':
        const: ada:parameter/solutionQicpmsTAPP/procedureReference
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/solutionQicpmsTAPP/procedureReference
      schema:name:
        const: Procedure Reference(s)
      schema:value:
        type: string
  ...
  solutionSficpms_nebulizerGasFlowRate:
    ...
    - schema:value
    - schema:unitText
  solutionSficpms_makeUpGasFlowRate:
    title: Make-up Gas Flow Rate
    description: Supplementary argon flow added downstream of a desolvation system
      to maintain total gas delivery to the plasma (L/min). Record 'N/A' if no desolvation
      system is used. Record 'N/A' where Desolvation System is 'None'.
    ...
    properties:
      '@id':
        const: ada:parameter/solutionSficpmsTAPP/makeUpGasFlowRate
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/solutionSficpmsTAPP/makeUpGasFlowRate
      schema:name:
        const: Make-up Gas Flow Rate
      schema:value:
        anyOf:
  ...
  solutionSficpms_secondaryReferenceMaterials:
    ...
    - schema:name
    - schema:value
  solutionSficpms_fundingSourceForProcedureDevelopment:
    title: Funding Source for Procedure Development
    description: Grants and other funding sources that supported instrument acquisition,
      major upgrades, procedure development, and associated personnel time. Include
      grant numbers and funding agencies where applicable.
    ...
    properties:
      '@id':
        const: ada:parameter/solutionSficpmsTAPP/fundingSourceForProcedureDevelopment
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/solutionSficpmsTAPP/fundingSourceForProcedureDevelopment
      schema:name:
        const: Funding Source for Procedure Development
      schema:value:
        type: string
    ...
    - schema:name
    - schema:value
  solutionSficpms_procedureReference:
    title: Procedure Reference(s)
    description: DOI or URL for peer-reviewed publications or technical reports describing,
      validating, or benchmarking this procedure.
    type: object
    properties:
      '@id':
        const: ada:parameter/solutionSficpmsTAPP/procedureReference
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/solutionSficpmsTAPP/procedureReference
      schema:name:
        const: Procedure Reference(s)
      schema:value:
        type: string
  ...
  sem_analyte:
    ...
    description: "The chemical species this procedure is designed to determine, recorded
      ...
      where it resolves molecules. The procedure registers the full analyte suite;
      analysts record the specific subset actually measured in a given session, which
      may be narrower. Fields whose Keyed By column declares 'analyte' apply individually
  ...
  sem_clWavelengthCalibrationReference:
    ...
    - schema:name
    - schema:value
  sem_fundingSourceForProcedureDevelopment:
    title: Funding Source for Procedure Development
    description: Grants and other funding sources that supported instrument acquisition,
      major upgrades, procedure development, and associated personnel time. Include
      grant numbers and funding agencies where applicable.
    ...
    properties:
      '@id':
        const: ada:parameter/semTAPP/fundingSourceForProcedureDevelopment
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/semTAPP/fundingSourceForProcedureDevelopment
      schema:name:
        const: Funding Source for Procedure Development
      schema:value:
        type: string
  ...
  sem_procedureReference:
    ...
    properties:
      '@id':
        const: ada:parameter/semTAPP/procedureReference
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/semTAPP/procedureReference
      schema:name:
        const: Procedure Reference(s)
      schema:value:
        type: string
  ...
  labxct_reconstructionSoftware:
    ...
    - schema:name
    - schema:value
  labxct_segmentationAndAnalysisSoftware:
    title: Segmentation and Analysis Software
    description: Software used for image segmentation, phase identification, and quantitative
      3D analysis after reconstruction. Report all packages used, with version numbers.
    type: object
    properties:
      '@id':
        const: ada:parameter/labxctTAPP/segmentationAndAnalysisSoftware
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/labxctTAPP/segmentationAndAnalysisSoftware
      schema:name:
        const: Segmentation and Analysis Software
      schema:value:
        type: string
    required:
    - '@id'
  ...
  labxct_crossValidationOutcome:
    ...
    - schema:name
    - schema:value
  labxct_fundingSourceForProcedureDevelopment:
    title: Funding Source for Procedure Development
    description: Grants and other funding sources that supported instrument acquisition,
      major upgrades, procedure development, and associated personnel time. Include
      grant numbers and funding agencies where applicable.
    ...
    properties:
      '@id':
        const: ada:parameter/labxctTAPP/fundingSourceForProcedureDevelopment
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/labxctTAPP/fundingSourceForProcedureDevelopment
      schema:name:
        const: Funding Source for Procedure Development
      schema:value:
        type: string
  ...
  labxct_procedureReference:
    ...
    properties:
      '@id':
        const: ada:parameter/labxctTAPP/procedureReference
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/labxctTAPP/procedureReference
      schema:name:
        const: Procedure Reference(s)
      schema:value:
        type: string
  ...
  tem_edsCountingStatisticsAccumulationCriterion:
    ...
    - schema:name
    - schema:value
  tem_fundingSourceForProcedureDevelopment:
    title: Funding Source for Procedure Development
    description: Grants and other funding sources that supported instrument acquisition,
      major upgrades, procedure development, and associated personnel time. Include
      grant numbers and funding agencies where applicable.
    ...
    properties:
      '@id':
        const: ada:parameter/temTAPP/fundingSourceForProcedureDevelopment
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/temTAPP/fundingSourceForProcedureDevelopment
      schema:name:
        const: Funding Source for Procedure Development
      schema:value:
        type: string
  ...
  tem_procedureReference:
    ...
    properties:
      '@id':
        const: ada:parameter/temTAPP/procedureReference
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/temTAPP/procedureReference
      schema:name:
        const: Procedure Reference(s)
      schema:value:
        type: string
  ...
  laQicpms_carrierGasAndFlowRate:
    ...
    - schema:name
    - schema:value
  laQicpms_plasmaMakeUpGasAddition:
    title: Plasma / Make-up Gas Addition
    description: "Additional gas(es) mixed into the carrier stream downstream of the
      ablation cell, with the procedure-registered target flow rate. Ar make-up gas
      is standard. Small N\u2082 additions can enhance sensitivity for some elements.
      If N\u2082 is not added, state \"None\" explicitly to distinguish from not reported."
    type: object
    properties:
      '@id':
        const: ada:parameter/laQicpmsTAPP/plasmaMakeUpGasAddition
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laQicpmsTAPP/plasmaMakeUpGasAddition
      schema:name:
        const: Plasma / Make-up Gas Addition
      schema:value:
        type: string
  ...
  laQicpms_icpTuning:
    ...
    - schema:name
    - schema:value
  laQicpms_sensitivityAsUsefulYield:
    title: Sensitivity as Useful Yield
    description: 'Instrument sensitivity expressed as useful yield: the percentage
      of sampled atoms of a given element ultimately detected as ions, with the method
      used to derive it cited. A more rigorous and more comparable statement of sensitivity
      than counts per second per unit concentration, which depends on spot size, fluence
      and repetition rate.'
    type: object
    properties:
      '@id':
        const: ada:parameter/laQicpmsTAPP/sensitivityAsUsefulYield
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laQicpmsTAPP/sensitivityAsUsefulYield
      schema:name:
  ...
  laSficpms_carrierGasAndFlowRate:
    ...
    - schema:name
    - schema:value
  laSficpms_plasmaMakeUpGasAddition:
    title: Plasma / Make-up Gas Addition
    description: "Additional gas(es) mixed into the carrier stream downstream of the
      ablation cell, with the procedure-registered target flow rate. Ar make-up gas
      is standard. Small N\u2082 additions can enhance sensitivity for some elements.
  ...
  laSficpms_icpTuning:
    ...
    - schema:name
    - schema:value
  laSficpms_sensitivityAsUsefulYield:
    title: Sensitivity as Useful Yield
    description: 'Instrument sensitivity expressed as useful yield: the percentage
      of sampled atoms of a given element ultimately detected as ions, with the method
      used to derive it cited. A more rigorous and more comparable statement of sensitivity
    ...
    properties:
      '@id':
        const: ada:parameter/laSficpmsTAPP/sensitivityAsUsefulYield
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laSficpmsTAPP/sensitivityAsUsefulYield
      schema:name:
        const: Sensitivity as Useful Yield
      schema:value:
        anyOf:
  ...
  laMcicpms_carrierGasAndFlowRate:
    ...
    - schema:name
    - schema:value
  laMcicpms_plasmaMakeUpGasAddition:
    title: Plasma / Make-up Gas Addition
    description: "Additional gas(es) mixed into the carrier stream downstream of the
      ablation cell, with the procedure-registered target flow rate. Ar make-up gas
      is standard. Small N\u2082 additions can enhance sensitivity for some elements.
    ...
    properties:
      '@id':
        const: ada:parameter/laMcicpmsTAPP/plasmaMakeUpGasAddition
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laMcicpmsTAPP/plasmaMakeUpGasAddition
      schema:name:
        const: Plasma / Make-up Gas Addition
      schema:value:
        type: string
  ...
  laMcicpms_icpTuning:
    ...
    - schema:name
    - schema:value
  laMcicpms_sensitivityAsUsefulYield:
    title: Sensitivity as Useful Yield
    description: 'Instrument sensitivity expressed as useful yield: the percentage
      of sampled atoms of a given element ultimately detected as ions, with the method
      used to derive it cited. A more rigorous and more comparable statement of sensitivity
    ...
    properties:
      '@id':
        const: ada:parameter/laMcicpmsTAPP/sensitivityAsUsefulYield
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laMcicpmsTAPP/sensitivityAsUsefulYield
      schema:name:
        const: Sensitivity as Useful Yield
      schema:value:
        anyOf:
  ...
  laQicpmsUPb_carrierGasAndFlowRate:
    ...
    - schema:name
    - schema:value
  laQicpmsUPb_plasmaMakeUpGasAddition:
    title: Plasma / Make-up Gas Addition
    description: "Additional gas(es) mixed into the carrier stream downstream of the
      ablation cell, with the procedure-registered target flow rate. Ar make-up gas
      is standard. Small N\u2082 additions can enhance sensitivity for some elements.
  ...
  laQicpmsUPb_icpTuning:
    ...
    - schema:name
    - schema:value
  laQicpmsUPb_sensitivityAsUsefulYield:
    title: Sensitivity as Useful Yield
    description: 'Instrument sensitivity expressed as useful yield: the percentage
      of sampled atoms of a given element ultimately detected as ions, with the method
      used to derive it cited. A more rigorous and more comparable statement of sensitivity
    ...
    properties:
      '@id':
        const: ada:parameter/laQicpmsUPbTAPP/sensitivityAsUsefulYield
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laQicpmsUPbTAPP/sensitivityAsUsefulYield
      schema:name:
        const: Sensitivity as Useful Yield
      schema:value:
        anyOf:
  ...
  laSficpmsUPb_carrierGasAndFlowRate:
    ...
    - schema:name
    - schema:value
  laSficpmsUPb_plasmaMakeUpGasAddition:
    title: Plasma / Make-up Gas Addition
    description: "Additional gas(es) mixed into the carrier stream downstream of the
      ablation cell, with the procedure-registered target flow rate. Ar make-up gas
      is standard. Small N\u2082 additions can enhance sensitivity for some elements.
    ...
    properties:
      '@id':
        const: ada:parameter/laSficpmsUPbTAPP/plasmaMakeUpGasAddition
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laSficpmsUPbTAPP/plasmaMakeUpGasAddition
      schema:name:
        const: Plasma / Make-up Gas Addition
      schema:value:
        type: string
  ...
  laSficpmsUPb_icpTuning:
    ...
    - schema:name
    - schema:value
  laSficpmsUPb_sensitivityAsUsefulYield:
    title: Sensitivity as Useful Yield
    description: 'Instrument sensitivity expressed as useful yield: the percentage
      of sampled atoms of a given element ultimately detected as ions, with the method
      used to derive it cited. A more rigorous and more comparable statement of sensitivity
    ...
    properties:
      '@id':
        const: ada:parameter/laSficpmsUPbTAPP/sensitivityAsUsefulYield
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laSficpmsUPbTAPP/sensitivityAsUsefulYield
      schema:name:
        const: Sensitivity as Useful Yield
      schema:value:
        anyOf:
  ...
  laMcicpmsUPb_carrierGasAndFlowRate:
    ...
    - schema:name
    - schema:value
  laMcicpmsUPb_plasmaMakeUpGasAddition:
    title: Plasma / Make-up Gas Addition
    description: "Additional gas(es) mixed into the carrier stream downstream of the
      ablation cell, with the procedure-registered target flow rate. Ar make-up gas
      is standard. Small N\u2082 additions can enhance sensitivity for some elements.
    ...
    properties:
      '@id':
        const: ada:parameter/laMcicpmsUPbTAPP/plasmaMakeUpGasAddition
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laMcicpmsUPbTAPP/plasmaMakeUpGasAddition
      schema:name:
        const: Plasma / Make-up Gas Addition
      schema:value:
        type: string
  ...
  laMcicpmsUPb_icpTuning:
    ...
    - schema:name
    - schema:value
  laMcicpmsUPb_sensitivityAsUsefulYield:
    title: Sensitivity as Useful Yield
    description: 'Instrument sensitivity expressed as useful yield: the percentage
      of sampled atoms of a given element ultimately detected as ions, with the method
      used to derive it cited. A more rigorous and more comparable statement of sensitivity
    ...
    properties:
      '@id':
        const: ada:parameter/laMcicpmsUPbTAPP/sensitivityAsUsefulYield
      '@type':
        const:
        - schema:PropertyValue
      schema:propertyID:
        const:
        - '@id': ada:parameter/laMcicpmsUPbTAPP/sensitivityAsUsefulYield
      schema:name:
        const: Sensitivity as Useful Yield
      schema:value:
        anyOf:
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/registry/parameterValues/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/registry/parameterValues/schema.yaml)
