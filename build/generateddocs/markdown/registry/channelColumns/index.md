...
# Channel-Column Specification Registry (Schema)

`ogch.registry.channelColumns` *v0.1*
...
title: ADA Channel Column Specification Registry
description: Registry of reusable schema:PropertyValueSpecification channel column
  definitions derived from technique TAPP workbooks. Each $def constrains one column
  of the channel table, a channel being an instrument selection position -- a mass,
  a Faraday cup, an energy-loss edge, an X-ray line -- as distinct from the analyte
  measured on it. TAPP building blocks reference these definitions via fragment $refs
...
$defs:
  ...
  empa_xRayLine:
    ...
    - ada:dataType
    - schema:defaultValue
  laMcicpms_faradayCupAmplifierResistorValues:
    ...
    - ada:dataType
    - schema:defaultValue
  laMcicpms_faradayCupGainCalibrationMethod:
  ...
  solutionMcicpms_interferingSpecies:
    ...
    - ada:dataType
    - schema:defaultValue
  solutionMcicpms_isobaricInterferenceCorrectionsApplied:
    ...
    description: 'Whether mathematical corrections for residual isobaric or polyatomic
      ...
      suppression achieved by chemical separation or mass resolution. In solution
      MC-ICP-MS, chemical separation is the primary interference mitigation; mathematical
      corrections address residual contributions. Common examples: 204Hg on 204Pb;
      abundance sensitivity tailing of 238U onto 236U and 235U.'
    type: object
    properties:
      '@id':
  ...
  tem_eelsBackgroundSubtractionMethod:
    ...
    - schema:name
    - ada:dataType
  tem_eelsSensitivityAndDetectionLimit:
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/registry/channelColumns/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/registry/channelColumns/schema.yaml)
...
* Path: `_sources/registry/channelColumns`
