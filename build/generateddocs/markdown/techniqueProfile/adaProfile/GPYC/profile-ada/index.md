...
`ogch.techniqueProfile.adaProfile.GPYC.profile-ada` *v0.1*
...
```json
{
      ...
      "schema:hasPart": [
        {
          ...
          "ada:componentType": "ada:GPYCProcessedTabular",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaGPYC"
      },
      {
...
```jsonld
{
  "@context": [
    ...
    "https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/adaProfile/GPYC/profile-ada/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaGPYC-file-001 a cdi:TabularTextDataSet,
        schema1:MediaObject,
        ada:tabularData ;
    cdi:isDelimited true ;
...
ex:adaGPYC-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaGPYC>,
...
- type: object
  properties:
    ...
    schema:distribution:
      description: Distribution items for adaGPYC. Archive hasPart items must have
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaGPYC
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/adaProfile/GPYC/profile-ada/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/adaProfile/GPYC/profile-ada/schema.yaml)
...
[context.jsonld](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/adaProfile/GPYC/profile-ada/context.jsonld)
...
* Path: `_sources/techniqueProfile/adaProfile/GPYC/profile-ada`
