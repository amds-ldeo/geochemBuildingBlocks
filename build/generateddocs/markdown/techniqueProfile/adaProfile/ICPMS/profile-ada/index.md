...
`ogch.techniqueProfile.adaProfile.ICPMS.profile-ada` *v0.1*
...
```json
{
      ...
      "schema:hasPart": [
        {
          ...
          "ada:componentType": "ada:HRICPMSProcessed",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaICPMS"
      },
      {
...
```jsonld
{
  "@context": [
    ...
    "https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/adaProfile/ICPMS/profile-ada/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaICPMS-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaICPMS>,
...
- type: object
  properties:
    ...
    schema:distribution:
      description: Distribution items for adaICPMS. Archive hasPart items must have
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaICPMS
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/adaProfile/ICPMS/profile-ada/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/adaProfile/ICPMS/profile-ada/schema.yaml)
...
[context.jsonld](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/adaProfile/ICPMS/profile-ada/context.jsonld)
...
* Path: `_sources/techniqueProfile/adaProfile/ICPMS/profile-ada`
