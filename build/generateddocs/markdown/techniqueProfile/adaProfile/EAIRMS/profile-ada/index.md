...
`ogch.techniqueProfile.adaProfile.EAIRMS.profile-ada` *v0.1*
...
```jsonld
{
  "@context": [
    ...
    "https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/adaProfile/EAIRMS/profile-ada/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaEAIRMS-file-001 a schema1:MediaObject,
        ada:collection,
        schema:Collection ;
...
- type: object
  properties:
    ...
    schema:distribution:
      description: Distribution items for adaEAIRMS. Archive hasPart items must have
        ...
        properties:
          schema:hasPart:
            items:
              ...
              - $ref: https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/adaProfile/EAIRMS/detail/schema.yaml
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaEAIRMS
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/adaProfile/EAIRMS/profile-ada/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/adaProfile/EAIRMS/profile-ada/schema.yaml)
...
[context.jsonld](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/adaProfile/EAIRMS/profile-ada/context.jsonld)
...
* Path: `_sources/techniqueProfile/adaProfile/EAIRMS/profile-ada`
