...
# ADA GC-C-IRMS Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.GC-C-IRMS.profile` *v0.1*
...
### ADA GC-C-IRMS Product Profile Example
Example path-driven GCCIRMS product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaGCCIRMS-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA GC-C-IRMS Example Product",
  "schema:description": "Example path-driven GCCIRMS product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data.",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaGCCIRMS"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/GC-C-IRMS/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaGCCIRMS-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Gas Chromatography-Combustion-Isotopic Ratio Mass Spectrometry",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example path-driven GCCIRMS product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA GC-C-IRMS Example Product" ;
...
ex:adaProduct-file-001 a schema1:ImageObject,
        schema1:MediaObject,
        ada:image ;
    schema1:additionalType "ada:GCCIRMSDataCollection" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaGCCIRMS>,
...
title: ADA GC-C-IRMS Product Profile
description: Path-driven technique-specific profile for ADA GC-C-IRMS Product Profile.
  Extends the base ADA product profile with the GCCIRMS analysis-instance detail on
  the schema:Dataset root, narrows prov:used to the gcCIrmsTAPP protocol, and constrains
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/GC-C-IRMS/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the gcCIrmsTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/GC-C-IRMS/tapp/schema.yaml
    schema:additionalType:
      description: Must include a GCCIRMS product type identifier.
      contains:
        enum:
        - Gas Chromatography-Combustion-Isotopic Ratio Mass Spectrometry
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaGCCIRMS

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/GC-C-IRMS/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/GC-C-IRMS/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/GC-C-IRMS/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/GC-C-IRMS/profile`
