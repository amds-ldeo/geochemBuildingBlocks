...
# Gas Chromatography-Mass Spectrometry Technique-Aligned Procedure Profile (gcmsTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.GCMS.tapp` *v0.1*
...
### gcmsTAPP example Agilent5977
gcmsTAPP instance derived from ADA n=26 | Sako, Sunami | Tohoku University | Agilent 5977B GCMSD.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Gas Chromatography-Mass Spectrometry"
    }
  ],
  "schema:creator": {
    "schema:name": "Sako, Sunami",
    "@type": [
      "schema:Person"
    ]
  },
  ...
  "schema:funding": [
    {
      ...
      "schema:name": "This material is supported by NASA under contract NNM10AA11C issued through the New Frontiers program. This analysis is supported by JSPS Kakenhi 18H03728 and 22H00165 to Yoshihiro Furukawa."
    }
  ],
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/GCMS/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:gcmsTAPP-Agilent5977 a cdi:Activity,
        schema1:Action,
        prov:Plan,
        ada:TAPPDefinition,
        bios:LabProtocol ;
    ...
    schema1:location [ a schema1:Place ;
            schema1:name "Tohoku University" ] ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Gas Chromatography-Mass Spectrometry" ] ;
    schema1:name "gcms protocol — Agilent5977" ;
    ada:constantsAndReferenceValuesUsedDefault "missing" ;
    ada:instrumentManufacturer "Unknown" ;
    ada:instrumentModel "Agilent 5977B GCMSD" ;
    ada:samplingUnit "missing" ;
...
description: 'Gas Chromatography-Mass Spectrometry extension of the base TAPP definition.
  CORE-ONLY DRAFT: the native technique layer is empty. GCMS has no ADA detail schema
  ...
  Phase 0 seed papers before it says anything GCMS-specific. Generated from draftTAPPs/GCMS_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/GCMS/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/GCMS/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/GCMS/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/GCMS/tapp`
