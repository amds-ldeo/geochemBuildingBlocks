...
# UV Fluorescence Microscopy Technique-Aligned Procedure Profile (uvfmTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.UVFM.tapp` *v0.1*
...
### uvfmTAPP example P0
uvfmTAPP instance derived from ADA n=2 | Clemett, Simon | NASA Johnson Space Center | Olympus BX-60 Fluorescence Microscope.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "UV Fluorescence Microscopy"
    }
  ],
  "schema:creator": {
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/UVFM/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:uvfmTAPP-P0 a cdi:Activity,
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "UV Fluorescence Microscopy" ] ;
    schema1:name "uvfm protocol — P0" ;
    ada:constantsAndReferenceValuesUsedDefault "missing" ;
    ada:instrumentManufacturer "Unknown" ;
    ada:instrumentModel "Olympus BX-60 Fluorescence Microscope" ;
    ada:samplingUnit "missing" ;
...
description: 'UV Fluorescence Microscopy extension of the base TAPP definition. CORE-ONLY
  DRAFT: the native technique layer is empty. UVFM has no ADA detail schema and no
  ...
  0 seed papers before it says anything UVFM-specific. Generated from draftTAPPs/UVFM_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/UVFM/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/UVFM/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/UVFM/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/UVFM/tapp`
