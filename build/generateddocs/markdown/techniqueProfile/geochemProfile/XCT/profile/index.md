...
# ADA Lab-XCT Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.XCT.profile` *v0.1*
...
### ADA Lab-XCT Product Profile Example
Example path-driven LABXCT product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaLabXCT-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA Lab-XCT Example Product",
  "schema:description": "Example path-driven LABXCT product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data.",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaLabXCT"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/XCT/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaLabXCT-example-001 a schema1:Dataset,
        schema1:Product ;
    ...
    schema1:description "Example path-driven LABXCT product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA Lab-XCT Example Product" ;
    ...
    schema1:version "1.0" ;
    dqv:hasQualityMeasurement [ dqv:isMeasurementOf "Metal Streak Artifact Assessment" ;
            dqv:value "example metalStreakArtifactAssessment" ],
        [ dqv:isMeasurementOf "Ring Artifact Severity and Correction Outcome" ;
            dqv:value "example ringArtifactSeverityAndCorrectionOutcome" ],
        [ dqv:isMeasurementOf "Partial Volume Effect Assessment" ;
...
ex:adaProduct-file-001 a schema1:ImageObject,
        schema1:MediaObject,
        ada:image ;
    schema1:additionalType "ada:XCTVolume" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaLabXCT>,
...
description: Path-driven technique-specific profile for ADA Lab-XCT Product Profile.
  Extends the base ADA product profile with the LABXCT analysis-instance detail on
  the schema:Dataset root, narrows prov:used to the labxctTAPP protocol, and constrains
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/XCT/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the labxctTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/XCT/tapp/schema.yaml
    schema:additionalType:
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/XCT/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/XCT/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/XCT/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/XCT/profile`
