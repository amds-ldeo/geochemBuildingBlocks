...
# Particle cohesion determination with AFM Technique-Aligned Procedure Profile (pcdAfmTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.PCD-AFM.tapp` *v0.1*
...
### pcdAfmTAPP example P0
pcdAfmTAPP instance derived from ADA n=10 | no named analyst | Arizona State University | Bruker MultiMode 8.
#### json
```json
{
  "@context": {
  ...
  "schema:name": "pcdAfm protocol — P0",
  "schema:description": "pcdAfmTAPP instance derived from ADA n=10 | no named analyst | Arizona State University | Bruker MultiMode 8 (publication column of PCD-AFM_TAPP_draft_v2.csv).",
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Particle cohesion determination with AFM"
    }
  ],
  "schema:location": {
    "@type": [
    ...
    "schema:name": "Arizona State University",
    "schema:identifier": "https://ror.org/03efmqc40"
  },
  "ada:reportedProperties": [
    "Calc_Ramp_Ex_nm | Calc_Ramp_Rt_nm | Defl_V_Ex | Defl_V_Rt"
  ],
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/PCD-AFM/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:pcdAfmTAPP-P0 a cdi:Activity,
        schema1:Action,
        prov:Plan,
        ada:TAPPDefinition,
        bios:LabProtocol ;
    ...
    schema1:location [ a schema1:Place ;
            ...
            schema1:name "Arizona State University" ] ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Particle cohesion determination with AFM" ] ;
...
title: Particle cohesion determination with AFM Technique-Aligned Procedure Profile
  (pcdAfmTAPP)
description: 'Particle cohesion determination with AFM extension of the base TAPP
  definition. CORE-ONLY DRAFT: the native technique layer is empty. PCD-AFM has no
  ADA detail schema and no technique-specific property in any ADA record, so there
  was nothing to seed one from and none was invented. This registers the procedure
  skeleton and needs Phase 0 seed papers before it says anything PCD-AFM-specific.
  Generated from draftTAPPs/PCD-AFM_TAPP_draft_v2.csv by tools/build_tapp.py.'
allOf:
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/PCD-AFM/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/PCD-AFM/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/PCD-AFM/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/PCD-AFM/tapp`
