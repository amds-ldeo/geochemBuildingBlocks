...
# ADA PCD-AFM Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.PCD-AFM.profile` *v0.1*
...
### ADA PCD-AFM Product Profile Example
Example path-driven PCDAFM product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaPCDAFM-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA PCD-AFM Example Product",
  "schema:description": "Example path-driven PCDAFM product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data.",
  "schema:additionalType": [
    "Particle cohesion determination with AFM",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaPCDAFM"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/PCD-AFM/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaPCDAFM-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Particle cohesion determination with AFM",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example path-driven PCDAFM product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA PCD-AFM Example Product" ;
...
ex:adaProduct-file-001 a schema1:ImageObject,
        schema1:MediaObject,
        ada:image ;
    schema1:additionalType "ada:PCDAFMCollection" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaPCDAFM>,
...
title: ADA PCD-AFM Product Profile
description: Path-driven technique-specific profile for ADA PCD-AFM Product Profile.
  Extends the base ADA product profile with the PCDAFM analysis-instance detail on
  the schema:Dataset root, narrows prov:used to the pcdAfmTAPP protocol, and constrains
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/PCD-AFM/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the pcdAfmTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/PCD-AFM/tapp/schema.yaml
    schema:additionalType:
      description: Must include a PCDAFM product type identifier.
      contains:
        enum:
        - Particle cohesion determination with AFM
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaPCDAFM

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/PCD-AFM/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/PCD-AFM/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/PCD-AFM/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/PCD-AFM/profile`
