...
# Structured Light Scanning Technique-Aligned Procedure Profile (slsTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.SLS.tapp` *v0.1*
...
### slsTAPP example P0
slsTAPP instance derived from ADA n=51 | Ryan, Andy | University of Arizona | (UAZ) Polyga Compact C506 structured light scanner.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Structured Light Scanning"
    }
  ],
  "schema:creator": {
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SLS/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
description: 'Structured Light Scanning extension of the base TAPP definition. CORE-ONLY
  DRAFT: the native technique layer is empty. SLS has no ADA detail schema and no
  ...
  0 seed papers before it says anything SLS-specific. Generated from draftTAPPs/SLS_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SLS/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SLS/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SLS/tapp/context.jsonld)

## Sources

* [SLS_TAPP_draft_v2.csv (TAPP worksheet)](https://github.com/amds-ldeo/geochemBuildingBlocks/tree/main/docs)
...
* Path: `_sources/techniqueProfile/geochemProfile/SLS/tapp`
