...
# Visible Light Microscopy Technique-Aligned Procedure Profile (vlmTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.VLM.tapp` *v0.1*
...
### vlmTAPP example P0
vlmTAPP instance derived from ADA n=10 | Haenecour, Pierre | University of Arizona | (UAZ)Keyence VHX-7000 Digital Microscope.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Visible Light Microscopy"
    }
  ],
  "schema:creator": {
    "schema:name": "Haenecour, Pierre",
    "@type": [
      "schema:Person"
    ]
  },
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/VLM/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:vlmTAPP-P0 a cdi:Activity,
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Visible Light Microscopy" ] ;
    schema1:name "vlm protocol — P0" ;
    ada:constantsAndReferenceValuesUsedDefault "missing" ;
    ada:instrumentManufacturer "Unknown" ;
    ada:instrumentModel "(UAZ)Keyence VHX-7000 Digital Microscope" ;
    ada:samplingUnit "missing" ;
...
description: 'Visible Light Microscopy extension of the base TAPP definition. CORE-ONLY
  DRAFT: the native technique layer is empty. VLM has no ADA detail schema and no
  ...
  0 seed papers before it says anything VLM-specific. Generated from draftTAPPs/VLM_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/VLM/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/VLM/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/VLM/tapp/context.jsonld)

## Sources

* [VLM_TAPP_draft_v2.csv (TAPP worksheet)](https://github.com/amds-ldeo/geochemBuildingBlocks/tree/main/docs)
...
* Path: `_sources/techniqueProfile/geochemProfile/VLM/tapp`
