  ...
  "schema:funding": [
    {
      ...
      "schema:name": "CNSA pre-research project D020205; NSFC 41973013; Natural Science Foundation of Hubei Province 2020CFA045; GPMR State Key Laboratory special fund MSFGPMR04 and MSFGPMR08"
    }
  ],
...
```jsonld
{
  "@context": [
    ...
    "https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/geochemProfile/LA-MC-ICPMS/detail/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/"
    }
...
ex:detail-Zhang2022 a ada:LAICPMSTabular ;
    ...
    schema1:funding [ a schema1:MonetaryGrant ;
            schema1:name "CNSA pre-research project D020205; NSFC 41973013; Natural Science Foundation of Hubei Province 2020CFA045; GPMR State Key Laboratory special fund MSFGPMR04 and MSFGPMR08" ] ;
                                          ...
                                          items:
                                            ...
                                            - title: Integration Time per Cycle
                                              description: "Duration of signal integration
                                                per measurement cycle (seconds). Determines
                                                counting statistics per cycle. Longer
                                                integration times improve shot-noise
                                                precision but increase the impact
                                                of signal drift within the integration
                                                window. For high-gain (10\xB9\xB2
                                                or 10\xB9\xB3 \u03A9) amplifier channels,
                                                longer integration times are often
                                                required to accumulate sufficient
                                                charge. Procedure specifies the standard
                                                integration time; analyst may confirm
                                                or adjust within procedure bounds.
                                                Where different isotope channels use
                                                different integration schemes, record
                                            ...
                                            - title: Ion Counter Dead Time
                                              description: Dead time of each ion-counting
                                                ...
                                                correction applied to high count rates.
                                                Distinct from pulse/analog cross-calibration,
                                                which relates the two detector modes
                                                rather than correcting counting losses
                  ...
                  schema:additionalProperty:
                    ...
                    items:
                      ...
                      - title: Analysis Location/Spot Coordinates
                        ...
                        properties:
                          '@id':
                            const: ada:parameter/laMcicpmsTAPP/analysisLocationSpotCoordinates
                          '@type':
                            const:
                            - schema:PropertyValue
                          schema:propertyID:
                            const:
                            - '@id': ada:parameter/laMcicpmsTAPP/analysisLocationSpotCoordinates
                          schema:name:
                        ...
                        items:
                          ...
                          - title: Pulse/Analog Detector Nonlinearity Correction
                            ...
                            properties:
                              ...
                              schema:propertyID:
                                const:
                                - '@id': ada:parameter/laMcicpmsTAPP/pulseAnalogDetectorNonlinearityCorrection
                              schema:name:
        ...
        schema:additionalProperty:
          ...
          items:
            ...
            - title: Procedural Blank Level
              ...
              properties:
                '@id':
                  const: ada:parameter/laMcicpmsTAPP/proceduralBlankLevel
                '@type':
                  const:
                  - schema:PropertyValue
                schema:propertyID:
                  const:
                  - '@id': ada:parameter/laMcicpmsTAPP/proceduralBlankLevel
                schema:name:
            ...
            - title: Transect Length
              ...
              properties:
                '@id':
                  const: ada:parameter/laMcicpmsTAPP/transectLength
                '@type':
                  const:
                  - schema:PropertyValue
                schema:propertyID:
                  const:
                  - '@id': ada:parameter/laMcicpmsTAPP/transectLength
                schema:name:
  ...
  schema:variableMeasured:
    ...
    items:
      ...
      - title: Goodness-of-Fit or Dispersion Statistic
        ...
        properties:
          '@id':
            const: ada:parameter/laMcicpmsTAPP/goodnessOfFitOrDispersionStatistic
          '@type':
            const:
            - schema:PropertyValue
          schema:propertyID:
      ...
      - title: Normalization / Standards-Based Correction
        description: Any post-acquisition normalization applied to correct for systematic
          ...
          normalization applied per pixel in mapping. Distinct from the primary internal
      ...
      - title: Uncertainty Propagation Method
        description: 'The approach used to propagate analytical uncertainty through
          ...
          uncertainty, internal standard uncertainty, drift correction, and any systematic
          contributions. Distinct from Uncertainty Level, which states the convention
          at which the resulting uncertainty is quoted.'
        type: object
        properties:
          '@id':
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/geochemProfile/LA-MC-ICPMS/detail/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/geochemProfile/LA-MC-ICPMS/detail/schema.yaml)
...
[context.jsonld](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/geochemProfile/LA-MC-ICPMS/detail/context.jsonld)
