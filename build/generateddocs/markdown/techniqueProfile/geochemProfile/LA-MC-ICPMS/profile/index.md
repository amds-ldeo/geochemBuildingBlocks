...
# ADA LA-MC-ICP-MS Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.LA-MC-ICPMS.profile` *v0.1*
...
### ADA LA-MC-ICP-MS Product Profile Example
Example path-driven LAMCICPMS product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaLAMCICPMS-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaLAMCICPMS"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-MC-ICPMS/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaLAMCICPMS-example-001 a schema1:Dataset,
    ...
    schema1:description "Example path-driven LAMCICPMS product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaLAMCICPMS>,
...
description: Path-driven technique-specific profile for ADA LA-MC-ICP-MS Product Profile.
  Extends the base ADA product profile with the LAMCICPMS analysis-instance detail
  on the schema:Dataset root, narrows prov:used to the laMcicpmsTAPP protocol, and
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-MC-ICPMS/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the laMcicpmsTAPP definition and the instrument where prov:used
    ...
    schema:distribution:
      description: Each distribution item is EITHER a monolithic single-file dataset
        whose ada:componentType is a LAMCICPMS-specific or universal value (and may
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaLAMCICPMS

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-MC-ICPMS/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-MC-ICPMS/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-MC-ICPMS/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/LA-MC-ICPMS/profile`
