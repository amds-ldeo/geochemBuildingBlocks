...
# Gas pycnometry Technique-Aligned Procedure Profile (gpycTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.GPYC.tapp` *v0.1*
...
### gpycTAPP example P0
gpycTAPP instance derived from ADA n=27 | Ryan, Andy | NASA Johnson Space Center | Densinator - Custom-built glove-box mounted pycnometer.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Gas pycnometry"
    }
  ],
  "schema:creator": {
    "schema:name": "Ryan, Andy",
    "@type": [
      "schema:Person"
    ]
  },
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/GPYC/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:gpycTAPP-P0 a cdi:Activity,
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Gas pycnometry" ] ;
...
description: 'Gas pycnometry extension of the base TAPP definition. CORE-ONLY DRAFT:
  the native technique layer is empty. GPYC has no ADA detail schema and no technique-specific
  ...
  anything GPYC-specific. Generated from draftTAPPs/GPYC_TAPP_draft_v2.csv by tools/build_tapp.py.'
allOf:
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/GPYC/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/GPYC/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/GPYC/tapp/context.jsonld)

## Sources

* [GPYC_TAPP_draft_v2.csv (TAPP worksheet)](https://github.com/amds-ldeo/geochemBuildingBlocks/tree/main/docs)
...
* Path: `_sources/techniqueProfile/geochemProfile/GPYC/tapp`
