                  ...
                  schema:additionalProperty:
                    ...
                    items:
                      ...
                      - title: Analysis Location/Spot Coordinates
                        ...
                        properties:
                          '@id':
                            const: ada:parameter/laMcicpmsUPbTAPP/analysisLocationSpotCoordinates
                          '@type':
                            const:
                            - schema:PropertyValue
                          schema:propertyID:
                            const:
                            - '@id': ada:parameter/laMcicpmsUPbTAPP/analysisLocationSpotCoordinates
                          schema:name:
                        ...
                        items:
                          ...
                          - title: Pulse/Analog Detector Nonlinearity Correction
                            ...
                            properties:
                              ...
                              schema:propertyID:
                                const:
                                - '@id': ada:parameter/laMcicpmsUPbTAPP/pulseAnalogDetectorNonlinearityCorrection
                              schema:name:
        ...
        schema:additionalProperty:
          ...
          items:
            ...
            - title: Transect Length
              ...
              properties:
                '@id':
                  const: ada:parameter/laMcicpmsUPbTAPP/transectLength
                '@type':
                  const:
                  - schema:PropertyValue
                schema:propertyID:
                  const:
                  - '@id': ada:parameter/laMcicpmsUPbTAPP/transectLength
                schema:name:
            ...
            - title: Mapping Area
              ...
              properties:
                '@id':
                  const: ada:parameter/laMcicpmsUPbTAPP/mappingArea
                '@type':
                  const:
                  - schema:PropertyValue
                schema:propertyID:
                  const:
                  - '@id': ada:parameter/laMcicpmsUPbTAPP/mappingArea
                schema:name:
                  const: Mapping Area
                schema:value:
                  type: string
            ...
            - title: Number of Blocks per Measurement
              description: Number of measurement blocks acquired per sample or standard
                solution introduction. In MC-ICP-MS, data are structured as blocks
                of cycles; each block typically begins with a baseline (on-peak zero)
                measurement before the analytical cycles. Multiple blocks per sample
                allow inspection of signal stability and within-measurement drift.
                Procedure specifies the standard number; analyst may adjust for samples
                with low signal or for high-precision requirements.
              type: object
              properties:
                '@id':
            ...
            - title: Integration Time per Cycle
              description: "Duration of signal integration per measurement cycle (seconds).
                Determines counting statistics per cycle. Longer integration times
                improve shot-noise precision but increase the impact of signal drift
                within the integration window. For high-gain (10\xB9\xB2 or 10\xB9\xB3
                \u03A9) amplifier channels, longer integration times are often required
                to accumulate sufficient charge. Procedure specifies the standard
                integration time; analyst may confirm or adjust within procedure bounds.
                Where different isotope channels use different integration schemes,
            ...
            - title: Signal Integration Time
              ...
              properties:
                '@id':
                  const: ada:parameter/laMcicpmsUPbTAPP/signalIntegrationTime
                '@type':
                  const:
                  - schema:PropertyValue
                schema:propertyID:
                  const:
                  - '@id': ada:parameter/laMcicpmsUPbTAPP/signalIntegrationTime
                schema:name:
            ...
            - title: Procedural Blank Level
              ...
              properties:
                '@id':
                  const: ada:parameter/laMcicpmsUPbTAPP/proceduralBlankLevel
                '@type':
                  const:
                  - schema:PropertyValue
                schema:propertyID:
                  const:
                  - '@id': ada:parameter/laMcicpmsUPbTAPP/proceduralBlankLevel
                schema:name:
            ...
            - title: Double-Spike Mixing Ratio
              description: "Target proportion of double-spike signal relative to total
                analyte signal in the spiked mixture, expressed as spike fraction
                (0\u20131) or spike:sample ratio. An optimal mixing ratio minimizes
                error propagation through the double-spike inversion; the optimum
                is analyte-system specific and is typically determined using the Double
                Spike Toolbox or equivalent. The achieved mixing ratio may deviate
                from the target within acceptable bounds (typically \xB120% of optimal);
                the double-spike inversion corrects for actual mixing ratios. Record
            ...
            - title: Age Datum / Reference Epoch
              ...
              properties:
                '@id':
                  const: ada:parameter/laMcicpmsUPbTAPP/ageDatumReferenceEpoch
                '@type':
                  const:
                  - schema:PropertyValue
                schema:propertyID:
                  const:
                  - '@id': ada:parameter/laMcicpmsUPbTAPP/ageDatumReferenceEpoch
                schema:name:
            ...
            - title: Imaging
              ...
              properties:
                ...
                schema:propertyID:
                  const:
                  - '@id': ada:parameter/laMcicpmsUPbTAPP/imaging
                schema:name:
                  const: Imaging
                schema:value:
                  type: string
            ...
            - title: Ablation Pit Depth/Ablation Rate
              ...
              properties:
                ...
                schema:propertyID:
                  const:
                  - '@id': ada:parameter/laMcicpmsUPbTAPP/ablationPitDepthAblationRate
                schema:name:
            ...
            - title: IC Dead Time (ns)
              ...
              properties:
                ...
                schema:propertyID:
                  const:
                  - '@id': ada:parameter/laMcicpmsUPbTAPP/icDeadTime
                schema:name:
            ...
            - title: Other Information
              ...
              properties:
                ...
                schema:propertyID:
                  const:
                  - '@id': ada:parameter/laMcicpmsUPbTAPP/otherInformation
                schema:name:
            ...
            - title: Uncertainty Level and Propagation
              ...
              properties:
                ...
                schema:propertyID:
                  const:
                  - '@id': ada:parameter/laMcicpmsUPbTAPP/uncertaintyLevelAndPropagation
                schema:name:
                                          ...
                                          items:
                                            ...
                                            - title: Cell Exit Discrimination Voltage
                                              description: Bias voltage applied at
                                                ...
                                                in STD mode. Record 'N/A' where Collision/Reaction
                                ...
                                items:
                                  ...
                                  - title: Mass Resolution Setting
                                    description: Operating mass resolution of the
                                      ...
                                      For sector-field instruments the analyst selects
                                      low, medium, or high resolution to balance sensitivity
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/geochemProfile/LA-MC-ICPMS-UPb/detail/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/geochemProfile/LA-MC-ICPMS-UPb/detail/schema.yaml)
...
[context.jsonld](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/geochemProfile/LA-MC-ICPMS-UPb/detail/context.jsonld)
