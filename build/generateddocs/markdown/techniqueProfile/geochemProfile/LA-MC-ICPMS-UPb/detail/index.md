          ...
          schema:additionalProperty:
            ...
            items:
              ...
              - title: Detection Limit
                ...
                properties:
                  '@id':
                    const: ada:parameter/laMcicpmsUPbTAPP/detectionLimit
                  '@type':
                    const:
                    - schema:PropertyValue
                  schema:propertyID:
                    const:
                    - '@id': ada:parameter/laMcicpmsUPbTAPP/detectionLimit
                  schema:name:
    ...
    schema:variableMeasured:
      ...
      items:
        ...
        - title: Detection Limit Method
          ...
          properties:
            '@id':
              const: ada:parameter/laMcicpmsUPbTAPP/detectionLimitMethod
            '@type':
              const:
              - schema:PropertyValue
              - cdi:InstanceVariable
            schema:propertyID:
              const:
              - '@id': ada:parameter/laMcicpmsUPbTAPP/detectionLimitMethod
            schema:name:
