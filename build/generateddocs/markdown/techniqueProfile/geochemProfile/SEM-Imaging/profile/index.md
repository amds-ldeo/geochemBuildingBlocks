...
# ADA SEM Imaging Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.SEM-Imaging.profile` *v0.1*
...
### ADA SEM Imaging Product Profile Example
Example path-driven SEMIMAGING product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaSEMImaging-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA SEM Imaging Example Product",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaSEMImaging"
      }
    ],
    "schema:maintainer": {
      "@type": [
  ...
  "ada:frameTime": 1.0,
  "ada:indexingMethod": "Hough transform",
  "ada:patternQualityThreshold": "example ebsdPatternQualityThreshold",
  "ada:meanAngularDeviation": 1.0,
  "ada:indexingRate": 1.0
}
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-Imaging/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaSEMImaging-example-001 a schema1:Dataset,
    ...
    schema1:description "Example path-driven SEMIMAGING product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    ada:frameTime 1e+00 ;
    ada:indexingMethod "Hough transform" ;
    ada:indexingRate 1e+00 ;
    ada:meanAngularDeviation 1e+00 ;
    ada:patternQualityThreshold "example ebsdPatternQualityThreshold" .
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaSEMImaging>,
...
description: Path-driven technique-specific profile for ADA SEM Imaging Product Profile.
  Extends the base ADA product profile with the SEMIMAGING analysis-instance detail
  on the schema:Dataset root, narrows prov:used to the semImagingTAPP protocol, and
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-Imaging/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the semImagingTAPP definition and the instrument where prov:used
    ...
    schema:additionalType:
      description: Must include a SEMIMAGING product type identifier.
      contains:
        enum:
        - Scanning Electron Microscopy (SEM) Image
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaSEMImaging

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-Imaging/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-Imaging/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-Imaging/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/SEM-Imaging/profile`
