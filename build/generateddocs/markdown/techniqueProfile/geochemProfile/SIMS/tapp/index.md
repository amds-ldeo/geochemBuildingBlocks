...
# Secondary ion mass spectrometry Technique-Aligned Procedure Profile (simsTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.SIMS.tapp` *v0.1*
...
### simsTAPP example P0
simsTAPP instance derived from ADA n=5 | Marrocchi, Yves | Centre de Recherches Petrographiques et Geochimiques (Nancy, France) | CAMECA IMS-1270E7.
#### json
```json
{
  "@context": {
  ...
  "schema:name": "sims protocol — P0",
  "schema:description": "simsTAPP instance derived from ADA n=5 | Marrocchi, Yves | Centre de Recherches Petrographiques et Geochimiques (Nancy, France) | CAMECA IMS-1270E7 (publication column of SIMS_TAPP_draft_v2.csv).",
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Secondary ion mass spectrometry"
    }
  ],
  "schema:creator": {
    "schema:name": "Marrocchi, Yves",
    "@type": [
      "schema:Person"
    ]
  },
  "schema:location": {
    ...
    "schema:name": "Centre de Recherches Petrographiques et Geochimiques (Nancy, France)"
  },
  "schema:funding": [
    {
      "@type": [
      ...
      "schema:name": "This material is supported by the French Centre national d'%C3%A9tudes spatiales (CNES)."
    }
  ],
  "ada:reportedProperties": [
    "Analysis Name | error | d18O corr | 2SE | d17O corr | D17O corr"
  ],
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SIMS/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:simsTAPP-P0 a cdi:Activity,
    ...
    schema1:description "simsTAPP instance derived from ADA n=5 | Marrocchi, Yves | Centre de Recherches Petrographiques et Geochimiques (Nancy, France) | CAMECA IMS-1270E7 (publication column of SIMS_TAPP_draft_v2.csv)." ;
    schema1:funding [ a schema1:MonetaryGrant ;
            schema1:name "This material is supported by the French Centre national d'%C3%A9tudes spatiales (CNES)." ] ;
    schema1:location [ a schema1:Place ;
            schema1:name "Centre de Recherches Petrographiques et Geochimiques (Nancy, France)" ] ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Secondary ion mass spectrometry" ] ;
...
description: 'Secondary ion mass spectrometry extension of the base TAPP definition.
  CORE-ONLY DRAFT: the native technique layer is empty. SIMS has no ADA detail schema
  ...
  Phase 0 seed papers before it says anything SIMS-specific. Generated from draftTAPPs/SIMS_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SIMS/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SIMS/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SIMS/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/SIMS/tapp`
