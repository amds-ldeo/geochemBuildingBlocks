...
# Laser Assisted Fluorination for Bulk Oxygen Isotope Ratio Me Technique-Aligned Procedure Profile (lafTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.LAF.tapp` *v0.1*
...
### lafTAPP example P0
lafTAPP instance derived from ADA n=16 | Greenwood, Richard | Open University | Thermo MAT 253.
#### json
```json
{
  "@context": {
  ...
  "schema:name": "laf protocol — P0",
  "schema:description": "lafTAPP instance derived from ADA n=16 | Greenwood, Richard | Open University | Thermo MAT 253 (publication column of LAF_TAPP_draft_v2.csv).",
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Laser Assisted Fluorination for Bulk Oxygen Isotope Ratio Measurements"
    }
  ],
  "schema:creator": {
    "schema:name": "Greenwood, Richard",
    "@type": [
      "schema:Person"
    ]
  },
  ...
  "schema:funding": [
    {
      ...
      "schema:name": "STFC Grant ST/Y000188/1"
    }
  ],
  "ada:reportedProperties": [
    "None | DATE | SAMPLE | WEIGHT | d17 | d17SE"
  ],
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LAF/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:lafTAPP-P0 a cdi:Activity,
    ...
    schema1:description "lafTAPP instance derived from ADA n=16 | Greenwood, Richard | Open University | Thermo MAT 253 (publication column of LAF_TAPP_draft_v2.csv)." ;
    schema1:funding [ a schema1:MonetaryGrant ;
            schema1:name "STFC Grant ST/Y000188/1" ] ;
    schema1:location [ a schema1:Place ;
            schema1:name "Open University" ] ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Laser Assisted Fluorination for Bulk Oxygen Isotope Ratio Measurements" ] ;
    schema1:name "laf protocol — P0" ;
...
title: Laser Assisted Fluorination for Bulk Oxygen Isotope Ratio Me Technique-Aligned
  Procedure Profile (lafTAPP)
description: 'Laser Assisted Fluorination for Bulk Oxygen Isotope Ratio Measurements
  extension of the base TAPP definition. CORE-ONLY DRAFT: the native technique layer
  is empty. LAF has no ADA detail schema and no technique-specific property in any
  ADA record, so there was nothing to seed one from and none was invented. This registers
  the procedure skeleton and needs Phase 0 seed papers before it says anything LAF-specific.
  Generated from draftTAPPs/LAF_TAPP_draft_v2.csv by tools/build_tapp.py.'
allOf:
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LAF/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LAF/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LAF/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/LAF/tapp`
