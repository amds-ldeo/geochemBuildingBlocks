...
# Thermal ionization mass spectrometry Technique-Aligned Procedure Profile (timsTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.TIMS.tapp` *v0.1*
...
### timsTAPP example P0
timsTAPP instance derived from ADA n=4 | no named analyst | ETH Zurich | (ETHZ)Triton Thermo Fisher TIMS.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Thermal ionization mass spectrometry"
    }
  ],
  "schema:location": {
    "@type": [
  ...
  "ada:reportedProperties": [
    "Date | Sample name | File name | Number of cycles | Intensity 142Nd (V) | 146Nd/144Nd average | 140Ce/144Nd | 147Sm/144Nd | 142Nd/144Nd mass bias corr | 142Nd/144Nd mass bias corr 2SE | 143Nd/144Nd mass bias corr | 143Nd/144Nd mass bias corr 2SE"
  ],
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TIMS/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:timsTAPP-P0 a cdi:Activity,
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Thermal ionization mass spectrometry" ] ;
...
description: 'Thermal ionization mass spectrometry extension of the base TAPP definition.
  CORE-ONLY DRAFT: the native technique layer is empty. TIMS has no ADA detail schema
  ...
  Phase 0 seed papers before it says anything TIMS-specific. Generated from draftTAPPs/TIMS_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TIMS/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TIMS/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TIMS/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/TIMS/tapp`
