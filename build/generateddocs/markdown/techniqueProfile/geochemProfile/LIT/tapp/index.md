...
# Lock-In Thermography Technique-Aligned Procedure Profile (litTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.LIT.tapp` *v0.1*
...
### litTAPP example P0
litTAPP instance derived from ADA n=99 | Ishizaki, Takuya | Nagoya University | Infratec camera model ThermoHAWK H9000.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Lock-In Thermography"
    }
  ],
  "schema:creator": {
    "schema:name": "Ishizaki, Takuya",
    "@type": [
      "schema:Person"
    ]
  },
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LIT/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:litTAPP-P0 a cdi:Activity,
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Lock-In Thermography" ] ;
    schema1:name "lit protocol — P0" ;
    ada:constantsAndReferenceValuesUsedDefault "missing" ;
    ada:instrumentManufacturer "Unknown" ;
    ada:instrumentModel "Infratec camera model ThermoHAWK H9000" ;
    ada:samplingUnit "missing" ;
...
description: 'Lock-In Thermography extension of the base TAPP definition. CORE-ONLY
  DRAFT: the native technique layer is empty. LIT has no ADA detail schema and no
  ...
  0 seed papers before it says anything LIT-specific. Generated from draftTAPPs/LIT_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LIT/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LIT/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LIT/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/LIT/tapp`
