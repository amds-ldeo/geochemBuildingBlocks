...
# ADA Solution MC-ICP-MS Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.Solution-MC-ICPMS.profile` *v0.1*
...
### ADA Solution MC-ICP-MS Product Profile Example
Example path-driven SOLUTIONMCICPMS product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaSolutionMCICPMS-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA Solution MC-ICP-MS Example Product",
  ...
  "schema:variableMeasured": [
    ...
    },
    {
      ...
      "schema:name": "Isotope Ratio Reported",
      "schema:description": "Isotope Ratio Reported reported for this dataset. Example value.",
      "schema:propertyID": [
        {
          "@id": "ada:parameter/solutionMcicpmsTAPP/isotopeRatioReported"
        }
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaSolutionMCICPMS"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/Solution-MC-ICPMS/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaSolutionMCICPMS-example-001 a schema1:Dataset,
    ...
    schema1:description "Example path-driven SOLUTIONMCICPMS product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA Solution MC-ICP-MS Example Product" ;
    schema1:subjectOf ex:adaProduct-metadata-001 ;
    schema1:url "https://astromat.org/products/adaproduct-example-001" ;
    schema1:variableMeasured <https://ada.astromat.org/metadata/parameter/solutionMcicpmsTAPP/isotopeRatioReported>,
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaSolutionMCICPMS>,
...
<https://ada.astromat.org/metadata/parameter/solutionMcicpmsTAPP/isotopeRatioReported> a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:description "Isotope Ratio Reported reported for this dataset. Example value." ;
    schema1:name "Isotope Ratio Reported" ;
    schema1:propertyID <https://ada.astromat.org/metadata/parameter/solutionMcicpmsTAPP/isotopeRatioReported> ;
    schema1:unitText "counts" ;
    cdif:physicalDataType "https://www.w3.org/TR/xmlschema-2/#double" .
...
description: Path-driven technique-specific profile for ADA Solution MC-ICP-MS Product
  Profile. Extends the base ADA product profile with the SOLUTIONMCICPMS analysis-instance
  detail on the schema:Dataset root, narrows prov:used to the solutionMcicpmsTAPP
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/Solution-MC-ICPMS/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the solutionMcicpmsTAPP definition and the instrument where
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/Solution-MC-ICPMS/tapp/schema.yaml
    schema:additionalType:
      description: Must include a SOLUTIONMCICPMS product type identifier.
      contains:
        enum:
        - Multi-Collector Inductively Coupled Plasma Mass Spectrometry (MCICPMS) processed
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaSolutionMCICPMS

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/Solution-MC-ICPMS/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/Solution-MC-ICPMS/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/Solution-MC-ICPMS/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/Solution-MC-ICPMS/profile`
