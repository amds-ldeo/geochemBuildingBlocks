...
# ADA SEM Composition (EDS/WDS) Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.SEM-Composition.profile` *v0.1*
...
### ADA SEM Composition (EDS/WDS) Product Profile Example
Example path-driven SEMCOMPOSITION product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaSEMComposition-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA SEM Composition (EDS/WDS) Example Product",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaSEMComposition"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-Composition/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaSEMComposition-example-001 a schema1:Dataset,
    ...
    schema1:description "Example path-driven SEMCOMPOSITION product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:variableMeasured <https://ada.astromat.org/metadata/parameter/semCompositionTAPP/calibrationFactorAndDeterminationMethod>,
        <https://ada.astromat.org/metadata/parameter/semCompositionTAPP/detectionLimit>,
        <https://ada.astromat.org/metadata/parameter/semCompositionTAPP/detectionLimitMethod>,
        <https://ada.astromat.org/metadata/parameter/semCompositionTAPP/normalizationStandardsBasedCorrection>,
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaSEMComposition>,
...
ex:adaProduct-var-001 a cdi:InstanceVariable,
    ...
    schema1:description "Goodness-of-Fit or Dispersion Statistic reported for this dataset. Example value.",
        "Primary measured quantity from Astromat Data Archive (ADA) analysis. This is example mock data for testing." ;
    schema1:name "Goodness-of-Fit or Dispersion Statistic",
        "measurement_value" ;
...
<https://ada.astromat.org/metadata/parameter/semCompositionTAPP/calibrationFactorAndDeterminationMethod> a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    ...
    schema1:propertyID <https://ada.astromat.org/metadata/parameter/semCompositionTAPP/calibrationFactorAndDeterminationMethod> ;
    schema1:unitText "counts" ;
    cdif:physicalDataType "https://www.w3.org/TR/xmlschema-2/#double" .

<https://ada.astromat.org/metadata/parameter/semCompositionTAPP/detectionLimit> a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:description "Detection Limit reported for this dataset. Example value." ;
    schema1:name "Detection Limit" ;
    schema1:propertyID <https://ada.astromat.org/metadata/parameter/semCompositionTAPP/detectionLimit> ;
    schema1:unitText "counts" ;
    cdif:physicalDataType "https://www.w3.org/TR/xmlschema-2/#double" .

<https://ada.astromat.org/metadata/parameter/semCompositionTAPP/detectionLimitMethod> a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:description "Detection Limit Method reported for this dataset. Example value." ;
    schema1:name "Detection Limit Method" ;
    schema1:propertyID <https://ada.astromat.org/metadata/parameter/semCompositionTAPP/detectionLimitMethod> ;
    schema1:unitText "counts" ;
    cdif:physicalDataType "https://www.w3.org/TR/xmlschema-2/#double" .

<https://ada.astromat.org/metadata/parameter/semCompositionTAPP/normalizationStandardsBasedCorrection> a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:description "Normalization / Standards-Based Correction reported for this dataset. Example value." ;
    schema1:name "Normalization / Standards-Based Correction" ;
    schema1:propertyID <https://ada.astromat.org/metadata/parameter/semCompositionTAPP/normalizationStandardsBasedCorrection> ;
    schema1:unitText "counts" ;
    cdif:physicalDataType "https://www.w3.org/TR/xmlschema-2/#double" .
...
description: Path-driven technique-specific profile for ADA SEM Composition (EDS/WDS)
  Product Profile. Extends the base ADA product profile with the SEMCOMPOSITION analysis-instance
  detail on the schema:Dataset root, narrows prov:used to the semCompositionTAPP protocol,
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-Composition/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the semCompositionTAPP definition and the instrument where
    ...
    schema:additionalType:
      description: Must include a SEMCOMPOSITION product type identifier.
      contains:
        enum:
    ...
    schema:distribution:
      description: Each distribution item is EITHER a monolithic single-file dataset
        whose ada:componentType is a SEMCOMPOSITION-specific or universal value (and
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaSEMComposition

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-Composition/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-Composition/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-Composition/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/SEM-Composition/profile`
