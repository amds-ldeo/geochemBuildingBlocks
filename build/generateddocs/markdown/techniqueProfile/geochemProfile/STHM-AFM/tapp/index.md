...
# Scanning Thermal Microscopy with AFM Technique-Aligned Procedure Profile (sthmAfmTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.STHM-AFM.tapp` *v0.1*
...
### sthmAfmTAPP example P0
sthmAfmTAPP instance derived from ADA n=483 | no named analyst | York University | Park Systems NX10 AFM.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Scanning Thermal Microscopy with AFM"
    }
  ],
  "schema:location": {
    "@type": [
    ...
    "schema:identifier": "https://ror.org/05fq50484"
  },
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/STHM-AFM/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:sthmAfmTAPP-P0 a cdi:Activity,
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Scanning Thermal Microscopy with AFM" ] ;
    schema1:name "sthmAfm protocol — P0" ;
    ada:constantsAndReferenceValuesUsedDefault "missing" ;
    ada:instrumentManufacturer "Unknown" ;
    ada:instrumentModel "Park Systems NX10 AFM" ;
    ada:samplingUnit "missing" ;
...
description: 'Scanning Thermal Microscopy with AFM extension of the base TAPP definition.
  CORE-ONLY DRAFT: the native technique layer is empty. STHM-AFM has no ADA detail
  schema and no technique-specific property in any ADA record, so there was nothing
  to seed one from and none was invented. This registers the procedure skeleton and
  needs Phase 0 seed papers before it says anything STHM-AFM-specific. Generated from
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/STHM-AFM/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/STHM-AFM/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/STHM-AFM/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/STHM-AFM/tapp`
