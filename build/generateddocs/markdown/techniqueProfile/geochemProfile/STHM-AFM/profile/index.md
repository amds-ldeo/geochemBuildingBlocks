...
# ADA STHM-AFM Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.STHM-AFM.profile` *v0.1*
...
### ADA STHM-AFM Product Profile Example
Example path-driven STHMAFM product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaSTHMAFM-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA STHM-AFM Example Product",
  "schema:description": "Example path-driven STHMAFM product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data.",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaSTHMAFM"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/STHM-AFM/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaSTHMAFM-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Scanning Thermal Microscopy with AFM (STHMAFM)",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example path-driven STHMAFM product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA STHM-AFM Example Product" ;
...
ex:adaProduct-file-001 a schema1:ImageObject,
        schema1:MediaObject,
        ada:image ;
    schema1:additionalType "ada:SThMCollection" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaSTHMAFM>,
...
title: ADA STHM-AFM Product Profile
description: Path-driven technique-specific profile for ADA STHM-AFM Product Profile.
  Extends the base ADA product profile with the STHMAFM analysis-instance detail on
  the schema:Dataset root, narrows prov:used to the sthmAfmTAPP protocol, and constrains
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/STHM-AFM/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the sthmAfmTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/STHM-AFM/tapp/schema.yaml
    schema:additionalType:
      description: Must include a STHMAFM product type identifier.
      contains:
        enum:
        - Scanning Thermal Microscopy with AFM (STHMAFM)
    schema:subjectOf:
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaSTHMAFM

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/STHM-AFM/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/STHM-AFM/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/STHM-AFM/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/STHM-AFM/profile`
