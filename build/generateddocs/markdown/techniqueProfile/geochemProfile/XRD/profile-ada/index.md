...
# ADA XRD Profile (TAPP-linked) (Schema)

`ogch.techniqueProfile.geochemProfile.XRD.profile-ada` *v0.1*
...
title: ADA XRD Product Profile (TAPP-linked)
description: Profile for an ADA metadata document describing data generated under
  a registered xrdTAPP procedure. Extends the base ADA product profile with the XRD
  analysis-instance detail on the schema:Dataset root, pins prov:used to the xrdTAPP
  definition and the instrument building block, and constrains valid XRD component
  types on both the monolithic and bundle forms of schema:distribution. Distinct from
  adaProfile/XRD, which is the generic (adaProduct-only) XRD profile and carries no
  TAPP linkage - a record conforming here additionally asserts which registered procedure
  produced it. DRAFT - the xrdTAPP source table has not been through Phase 0 review.
allOf:
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/BaseSchema/adaProduct/schema.yaml
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/XRD/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the xrdTAPP definition and the instrument where prov:used
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/XRD/profile-ada/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/XRD/profile-ada/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/XRD/profile-ada/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/XRD/profile-ada`
