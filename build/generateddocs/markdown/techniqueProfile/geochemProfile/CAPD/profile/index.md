...
# ADA Capacitance Dilatometry Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.CAPD.profile` *v0.1*
...
### ADA Capacitance Dilatometry Product Profile Example
Example path-driven CAPD product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaCAPD-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA Capacitance Dilatometry Example Product",
  "schema:description": "Example path-driven CAPD product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data.",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaCAPD"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CAPD/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaCAPD-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Capacitance Dilatometry (CAPD)",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example path-driven CAPD product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA Capacitance Dilatometry Example Product" ;
...
ex:adaProduct-file-001 a schema1:ImageObject,
        schema1:MediaObject,
        ada:image ;
    schema1:additionalType "ada:CAPDRawTabular" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaCAPD>,
...
title: ADA Capacitance Dilatometry Product Profile
description: Path-driven technique-specific profile for ADA Capacitance Dilatometry
  Product Profile. Extends the base ADA product profile with the CAPD analysis-instance
  detail on the schema:Dataset root, narrows prov:used to the capdTAPP protocol, and
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CAPD/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the capdTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CAPD/tapp/schema.yaml
    schema:additionalType:
      description: Must include a CAPD product type identifier.
      contains:
        enum:
        - Capacitance Dilatometry (CAPD)
    schema:subjectOf:
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaCAPD

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CAPD/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CAPD/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CAPD/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/CAPD/profile`
