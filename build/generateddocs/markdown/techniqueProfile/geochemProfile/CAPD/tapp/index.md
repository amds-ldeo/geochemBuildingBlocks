...
# Capacitance Dilatometry Technique-Aligned Procedure Profile (capdTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.CAPD.tapp` *v0.1*
...
### capdTAPP example P0
capdTAPP instance derived from ADA n=2 | no named analyst | Boston College | (BC)Quantum Design Physical Property Measurement System (QD-PPMS).
#### json
```json
{
  "@context": {
  ...
  "schema:name": "capd protocol — P0",
  "schema:description": "capdTAPP instance derived from ADA n=2 | no named analyst | Boston College | (BC)Quantum Design Physical Property Measurement System (QD-PPMS) (publication column of CAPD_TAPP_draft_v2.csv).",
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Capacitance Dilatometry"
    }
  ],
  "schema:location": {
    "@type": [
  ...
  "ada:reportedProperties": [
    "T [K] Raw Data | T [K] Raw Data Error | Capacitance [pF] Raw data | Capacitance [pF] Raw data Error | T [K] Data | T [K] Data Error | a [1/K] | a [1/K] x 10^-6 | T [K] dilatometer calibration (avg) | Capacitance [pF] dilatometer calibration (avg) | T [K] OFHC Cu Std. Reference | a [1/K] OFHC Cu Std. Reference"
  ],
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CAPD/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
description: 'Capacitance Dilatometry extension of the base TAPP definition. CORE-ONLY
  DRAFT: the native technique layer is empty. CAPD has no ADA detail schema and no
  technique-specific property in any ADA record, so there was nothing to seed one
  from and none was invented. This registers the procedure skeleton and needs Phase
  0 seed papers before it says anything CAPD-specific. Generated from draftTAPPs/CAPD_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CAPD/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CAPD/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CAPD/tapp/context.jsonld)

## Sources

* [CAPD_TAPP_draft_v2.csv (TAPP worksheet)](https://github.com/amds-ldeo/geochemBuildingBlocks/tree/main/docs)
...
* Path: `_sources/techniqueProfile/geochemProfile/CAPD/tapp`
