...
# ADA NI-MI Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.NI-MI.profile` *v0.1*
...
### ADA NI-MI Product Profile Example
Example path-driven NIMI product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaNIMI-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA NI-MI Example Product",
  "schema:description": "Example path-driven NIMI product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data.",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaNIMI"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NI-MI/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaNIMI-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Nanoindentation and microindentation (NI-MI)",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example path-driven NIMI product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA NI-MI Example Product" ;
...
ex:adaProduct-file-001 a schema1:ImageObject,
        schema1:MediaObject,
        ada:image ;
    schema1:additionalType "ada:NIMICollection" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaNIMI>,
...
title: ADA NI-MI Product Profile
description: Path-driven technique-specific profile for ADA NI-MI Product Profile.
  Extends the base ADA product profile with the NIMI analysis-instance detail on the
  schema:Dataset root, narrows prov:used to the niMiTAPP protocol, and constrains
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NI-MI/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the niMiTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NI-MI/tapp/schema.yaml
    schema:additionalType:
      description: Must include a NIMI product type identifier.
      contains:
        enum:
        - Nanoindentation and microindentation (NI-MI)
    schema:subjectOf:
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaNIMI

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NI-MI/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NI-MI/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NI-MI/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/NI-MI/profile`
