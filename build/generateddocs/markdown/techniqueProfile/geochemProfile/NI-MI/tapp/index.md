...
# Nanoindentation and Microindentation Technique-Aligned Procedure Profile (niMiTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.NI-MI.tapp` *v0.1*
...
### niMiTAPP example P0
niMiTAPP instance derived from ADA n=8 | no named analyst | Arizona State University | NI: Ultra Nanoindentation Tester (UNHT3) manufactured by Anton Paar.
#### json
```json
{
  "@context": {
  ...
  "schema:name": "niMi protocol — P0",
  "schema:description": "niMiTAPP instance derived from ADA n=8 | no named analyst | Arizona State University | NI: Ultra Nanoindentation Tester (UNHT3) manufactured by Anton Paar (publication column of NI-MI_TAPP_draft_v2.csv).",
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Nanoindentation and Microindentation"
    }
  ],
  "schema:location": {
    "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NI-MI/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
description: 'Nanoindentation and Microindentation extension of the base TAPP definition.
  CORE-ONLY DRAFT: the native technique layer is empty. NI-MI has no ADA detail schema
  ...
  Phase 0 seed papers before it says anything NI-MI-specific. Generated from draftTAPPs/NI-MI_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NI-MI/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NI-MI/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NI-MI/tapp/context.jsonld)

## Sources

* [NI-MI_TAPP_draft_v2.csv (TAPP worksheet)](https://github.com/amds-ldeo/geochemBuildingBlocks/tree/main/docs)
...
* Path: `_sources/techniqueProfile/geochemProfile/NI-MI/tapp`
