...
# Seismic Velocities and Rock Ultrasonic Elastic Constants Technique-Aligned Procedure Profile (svruecTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.SVRUEC.tapp` *v0.1*
...
### svruecTAPP example Model5077
svruecTAPP instance derived from ADA n=1 | Hanton, Lincoln | University of Calgary | Olympus Model 5077 PR with 35 MHz ultrasonic bandwidth.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Seismic Velocities and Rock Ultrasonic Elastic Constants"
    }
  ],
  "schema:creator": {
    "schema:name": "Hanton, Lincoln",
    "@type": [
      "schema:Person"
    ]
  },
  "schema:location": {
    ...
    "schema:name": "University of Calgary"
  },
  "schema:funding": [
    {
      "@type": [
      ...
      "schema:name": "Grant 22EXPOSICA from Planetary Exploration, Space Exploration, Canadian Space Agency. This material is supported by NASA under contract NNM10AA11C issued through the New Frontiers program."
    }
  ],
  "ada:reportedProperties": [
    "Sample ID | Mass (g) | Dimension (mm) | Applied Force (N) | P Wave First Arrival (micro-s) | P Wave Velocity (m/s)"
  ],
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SVRUEC/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:svruecTAPP-Model5077 a cdi:Activity,
        schema1:Action,
        prov:Plan,
        ada:TAPPDefinition,
        bios:LabProtocol ;
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Seismic Velocities and Rock Ultrasonic Elastic Constants" ] ;
    schema1:name "svruec protocol — Model5077" ;
...
title: Seismic Velocities and Rock Ultrasonic Elastic Constants Technique-Aligned
  Procedure Profile (svruecTAPP)
description: 'Seismic Velocities and Rock Ultrasonic Elastic Constants extension of
  the base TAPP definition. CORE-ONLY DRAFT: the native technique layer is empty.
  SVRUEC has no ADA detail schema and no technique-specific property in any ADA record,
  so there was nothing to seed one from and none was invented. This registers the
  procedure skeleton and needs Phase 0 seed papers before it says anything SVRUEC-specific.
  Generated from draftTAPPs/SVRUEC_TAPP_draft_v2.csv by tools/build_tapp.py.'
allOf:
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SVRUEC/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SVRUEC/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SVRUEC/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/SVRUEC/tapp`
