...
# Noble gas and Nitrogen Static Mass Spectrometry Technique-Aligned Procedure Profile (ngnsmsTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.NGNSMS.tapp` *v0.1*
...
### ngnsmsTAPP example P0
ngnsmsTAPP instance derived from ADA n=29 | Fueri, Evelyn | Centre de Recherches Petrographiques et Geochimiques (Nancy, France) | (CNRS-CRPG)Nu Instruments Noblesse HR.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Noble gas and Nitrogen Static Mass Spectrometry"
    }
  ],
  "schema:creator": {
    "schema:name": "Fueri, Evelyn",
    "@type": [
      "schema:Person"
    ]
  },
  ...
  "schema:funding": [
    {
      ...
      "schema:name": "This material is supported by NASA under contract NNM10AA11C issued through the New Frontiers program. This work was cofunded by the European Union (ERC, IRONIS, 10187562). Support from the French Space Agency (CNES) is also acknowledged."
    }
  ],
  "ada:reportedProperties": [
    "1 sigma | Sample | Laser power | Date | Cycles | Trap"
  ],
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NGNSMS/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:ngnsmsTAPP-P0 a cdi:Activity,
        schema1:Action,
        prov:Plan,
        ada:TAPPDefinition,
        bios:LabProtocol ;
...
title: Noble gas and Nitrogen Static Mass Spectrometry Technique-Aligned Procedure
  Profile (ngnsmsTAPP)
description: 'Noble gas and Nitrogen Static Mass Spectrometry extension of the base
  TAPP definition. CORE-ONLY DRAFT: the native technique layer is empty. NGNSMS has
  ...
  skeleton and needs Phase 0 seed papers before it says anything NGNSMS-specific.
  Generated from draftTAPPs/NGNSMS_TAPP_draft_v2.csv by tools/build_tapp.py.'
allOf:
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NGNSMS/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NGNSMS/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NGNSMS/tapp/context.jsonld)

## Sources

* [NGNSMS_TAPP_draft_v2.csv (TAPP worksheet)](https://github.com/amds-ldeo/geochemBuildingBlocks/tree/main/docs)
...
* Path: `_sources/techniqueProfile/geochemProfile/NGNSMS/tapp`
