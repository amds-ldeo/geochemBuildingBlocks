...
# ADA S-XRF Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.S-XRF.profile` *v0.1*
...
### ADA S-XRF Product Profile Example
Example path-driven SXRF product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaSXRF-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA S-XRF Example Product",
  "schema:description": "Example path-driven SXRF product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data.",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaSXRF"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/S-XRF/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaSXRF-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Synchrotron-based X-ray Fluorescence Spectroscopy (S-XRF)",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example path-driven SXRF product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA S-XRF Example Product" ;
...
ex:adaProduct-file-001 a schema1:ImageObject,
        schema1:MediaObject,
        ada:image ;
    schema1:additionalType "ada:SXRF2DImage" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaSXRF>,
...
title: ADA S-XRF Product Profile
description: Path-driven technique-specific profile for ADA S-XRF Product Profile.
  Extends the base ADA product profile with the SXRF analysis-instance detail on the
  schema:Dataset root, narrows prov:used to the sXrfTAPP protocol, and constrains
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/S-XRF/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the sXrfTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/S-XRF/tapp/schema.yaml
    schema:additionalType:
      description: Must include a SXRF product type identifier.
      contains:
        enum:
        - Synchrotron-based X-ray Fluorescence Spectroscopy (S-XRF)
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaSXRF

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/S-XRF/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/S-XRF/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/S-XRF/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/S-XRF/profile`
