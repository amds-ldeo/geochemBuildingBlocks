...
# Synchrotron-based X-ray Fluorescence Spectroscopy Technique-Aligned Procedure Profile (sXrfTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.S-XRF.tapp` *v0.1*
...
### sXrfTAPP example P0
sXrfTAPP instance derived from ADA n=325 | no named analyst | European Synchrotron Radiation Facility | Synchrotron (beamline ID15A - Materials Chemistry and Materials Engineering).
#### json
```json
{
  "@context": {
  ...
  "schema:name": "sXrf protocol — P0",
  "schema:description": "sXrfTAPP instance derived from ADA n=325 | no named analyst | European Synchrotron Radiation Facility | Synchrotron (beamline ID15A - Materials Chemistry and Materials Engineering) (publication column of S-XRF_TAPP_draft_v2.csv).",
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Synchrotron-based X-ray Fluorescence Spectroscopy"
    }
  ],
  "schema:location": {
    "@type": [
    ...
    "schema:name": "European Synchrotron Radiation Facility",
    "schema:identifier": "https://ror.org/02550n020"
  },
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/S-XRF/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:sXrfTAPP-P0 a cdi:Activity,
    ...
    schema1:location [ a schema1:Place ;
            schema1:identifier "https://ror.org/02550n020" ;
            schema1:name "European Synchrotron Radiation Facility" ] ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Synchrotron-based X-ray Fluorescence Spectroscopy" ] ;
    schema1:name "sXrf protocol — P0" ;
    ada:constantsAndReferenceValuesUsedDefault "missing" ;
    ada:instrumentManufacturer "Unknown" ;
    ada:instrumentModel "Synchrotron (beamline ID15A - Materials Chemistry and Materials Engineering)" ;
    ada:samplingUnit "missing" ;
...
title: Synchrotron-based X-ray Fluorescence Spectroscopy Technique-Aligned Procedure
  Profile (sXrfTAPP)
description: 'Synchrotron-based X-ray Fluorescence Spectroscopy extension of the base
  TAPP definition. CORE-ONLY DRAFT: the native technique layer is empty. S-XRF has
  ...
  skeleton and needs Phase 0 seed papers before it says anything S-XRF-specific. Generated
  from draftTAPPs/S-XRF_TAPP_draft_v2.csv by tools/build_tapp.py.'
allOf:
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/S-XRF/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/S-XRF/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/S-XRF/tapp/context.jsonld)

## Sources

* [S-XRF_TAPP_draft_v2.csv (TAPP worksheet)](https://github.com/amds-ldeo/geochemBuildingBlocks/tree/main/docs)
...
* Path: `_sources/techniqueProfile/geochemProfile/S-XRF/tapp`
