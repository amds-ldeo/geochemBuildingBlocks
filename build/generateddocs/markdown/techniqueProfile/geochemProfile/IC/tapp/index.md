...
# Ion Chromatography Technique-Aligned Procedure Profile (icTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.IC.tapp` *v0.1*
...
### icTAPP example P0
icTAPP instance derived from ADA n=2 | Peretyazhko, Tanya | NASA Johnson Space Center | DIONEX Integrion IC.
#### json
```json
{
  "@context": {
  ...
  "schema:name": "ic protocol — P0",
  "schema:description": "icTAPP instance derived from ADA n=2 | Peretyazhko, Tanya | NASA Johnson Space Center | DIONEX Integrion IC (publication column of IC_TAPP_draft_v2.csv).",
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Ion Chromatography"
    }
  ],
  "schema:creator": {
    "schema:name": "Peretyazhko, Tanya",
    "@type": [
      "schema:Person"
    ]
  },
  ...
  "ada:reportedProperties": [
    "sample number | sample name | retention time | area | height | Amount"
  ],
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/IC/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:icTAPP-P0 a cdi:Activity,
    ...
    schema1:description "icTAPP instance derived from ADA n=2 | Peretyazhko, Tanya | NASA Johnson Space Center | DIONEX Integrion IC (publication column of IC_TAPP_draft_v2.csv)." ;
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Ion Chromatography" ] ;
...
description: 'Ion Chromatography extension of the base TAPP definition. CORE-ONLY
  DRAFT: the native technique layer is empty. IC has no ADA detail schema and no technique-specific
  property in any ADA record, so there was nothing to seed one from and none was invented.
  This registers the procedure skeleton and needs Phase 0 seed papers before it says
  anything IC-specific. Generated from draftTAPPs/IC_TAPP_draft_v2.csv by tools/build_tapp.py.'
allOf:
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/IC/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/IC/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/IC/tapp/context.jsonld)

## Sources

* [IC_TAPP_draft_v2.csv (TAPP worksheet)](https://github.com/amds-ldeo/geochemBuildingBlocks/tree/main/docs)
...
* Path: `_sources/techniqueProfile/geochemProfile/IC/tapp`
