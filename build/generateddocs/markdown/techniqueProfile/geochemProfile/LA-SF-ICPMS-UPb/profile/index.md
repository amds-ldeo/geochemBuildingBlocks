...
# ADA LA-SF-ICP-MS U-Pb Geochronology Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.LA-SF-ICPMS-UPb.profile` *v0.1*
...
### ADA LA-SF-ICP-MS U-Pb Geochronology Product Profile Example
Example path-driven LASFICPMSUPB product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaLASFICPMSUPb-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA LA-SF-ICP-MS U-Pb Geochronology Example Product",
  "schema:description": "Example path-driven LASFICPMSUPB product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data.",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaLASFICPMSUPb"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-SF-ICPMS-UPb/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaLASFICPMSUPb-example-001 a schema1:Dataset,
        schema1:Product ;
    ...
    schema1:description "Example path-driven LASFICPMSUPB product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA LA-SF-ICP-MS U-Pb Geochronology Example Product" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaLASFICPMSUPb>,
...
description: Path-driven technique-specific profile for ADA LA-SF-ICP-MS U-Pb Geochronology
  Product Profile. Extends the base ADA product profile with the LASFICPMSUPB analysis-instance
  detail on the schema:Dataset root, narrows prov:used to the laSficpmsUPbTAPP protocol,
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-SF-ICPMS-UPb/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the laSficpmsUPbTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-SF-ICPMS-UPb/tapp/schema.yaml
    schema:additionalType:
      description: Must include a LASFICPMSUPB product type identifier.
      contains:
        enum:
    ...
    schema:distribution:
      description: Each distribution item is EITHER a monolithic single-file dataset
        whose ada:componentType is a LASFICPMSUPB-specific or universal value (and
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaLASFICPMSUPb

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-SF-ICPMS-UPb/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-SF-ICPMS-UPb/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-SF-ICPMS-UPb/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/LA-SF-ICPMS-UPb/profile`
