...
# 40Ar/39Ar geochronology and thermochronology Technique-Aligned Procedure Profile (argtTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.ARGT.tapp` *v0.1*
...
### argtTAPP example P0
argtTAPP instance derived from ADA n=69 | Jourdan, Fred | Curtin University | Thermo Fisher ARGUS VI.
#### json
```json
{
  "@context": {
  ...
  "schema:name": "argt protocol — P0",
  "schema:description": "argtTAPP instance derived from ADA n=69 | Jourdan, Fred | Curtin University | Thermo Fisher ARGUS VI (publication column of ARGT_TAPP_draft_v2.csv).",
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "40Ar/39Ar geochronology and thermochronology"
    }
  ],
  "schema:creator": {
    "schema:name": "Jourdan, Fred",
    "@type": [
      "schema:Person"
    ]
  },
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/ARGT/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:argtTAPP-P0 a cdi:Activity,
    ...
    schema1:description "argtTAPP instance derived from ADA n=69 | Jourdan, Fred | Curtin University | Thermo Fisher ARGUS VI (publication column of ARGT_TAPP_draft_v2.csv)." ;
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "40Ar/39Ar geochronology and thermochronology" ] ;
    schema1:name "argt protocol — P0" ;
    ada:constantsAndReferenceValuesUsedDefault "missing" ;
    ada:instrumentManufacturer "Thermo Fisher Scientific" ;
    ada:instrumentModel "Thermo Fisher ARGUS VI" ;
    ada:samplingUnit "missing" ;
...
title: 40Ar/39Ar geochronology and thermochronology Technique-Aligned Procedure Profile
  (argtTAPP)
description: '40Ar/39Ar geochronology and thermochronology extension of the base TAPP
  definition. CORE-ONLY DRAFT: the native technique layer is empty. ARGT has no ADA
  ...
  and needs Phase 0 seed papers before it says anything ARGT-specific. Generated from
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/ARGT/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/ARGT/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/ARGT/tapp/context.jsonld)

## Sources

* [ARGT_TAPP_draft_v2.csv (TAPP worksheet)](https://github.com/amds-ldeo/geochemBuildingBlocks/tree/main/docs)
...
* Path: `_sources/techniqueProfile/geochemProfile/ARGT/tapp`
