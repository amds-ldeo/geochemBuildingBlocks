...
# ADA FIB-SEM Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.SEM-FIBSEM.profile` *v0.1*
...
### ADA FIB-SEM Product Profile Example
Example path-driven SEMFIBSEM product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaSEMFIBSEM-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA FIB-SEM Example Product",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaSEMFIBSEM"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-FIBSEM/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaSEMFIBSEM-example-001 a schema1:Dataset,
    ...
    schema1:description "Example path-driven SEMFIBSEM product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA FIB-SEM Example Product" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaSEMFIBSEM>,
...
description: Path-driven technique-specific profile for ADA FIB-SEM Product Profile.
  Extends the base ADA product profile with the SEMFIBSEM analysis-instance detail
  on the schema:Dataset root, narrows prov:used to the semFibsemTAPP protocol, and
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-FIBSEM/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the semFibsemTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-FIBSEM/tapp/schema.yaml
    schema:additionalType:
      description: Must include a SEMFIBSEM product type identifier.
      contains:
        enum:
        - Focused ion beam-scanning electron microscopy
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaSEMFIBSEM

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-FIBSEM/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-FIBSEM/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-FIBSEM/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/SEM-FIBSEM/profile`
