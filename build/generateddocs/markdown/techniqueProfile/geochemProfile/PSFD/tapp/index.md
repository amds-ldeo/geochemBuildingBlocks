...
# Particle Size Frequency Distribution Technique-Aligned Procedure Profile (psfdTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.PSFD.tapp` *v0.1*
...
### psfdTAPP example P0
psfdTAPP instance derived from ADA n=2 | Pajola, Maurizio | NASA Johnson Space Center | Fujifilm GFX 100s.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Particle Size Frequency Distribution"
    }
  ],
  "schema:creator": {
    "schema:name": "Pajola, Maurizio",
    "@type": [
      "schema:Person"
    ]
  },
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/PSFD/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:psfdTAPP-P0 a cdi:Activity,
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Particle Size Frequency Distribution" ] ;
    schema1:name "psfd protocol — P0" ;
...
description: 'Particle Size Frequency Distribution extension of the base TAPP definition.
  CORE-ONLY DRAFT: the native technique layer is empty. PSFD has no ADA detail schema
  ...
  Phase 0 seed papers before it says anything PSFD-specific. Generated from draftTAPPs/PSFD_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/PSFD/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/PSFD/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/PSFD/tapp/context.jsonld)

## Sources

* [PSFD_TAPP_draft_v2.csv (TAPP worksheet)](https://github.com/amds-ldeo/geochemBuildingBlocks/tree/main/docs)
...
* Path: `_sources/techniqueProfile/geochemProfile/PSFD/tapp`
