...
# ADA TDM Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.TDM.profile` *v0.1*
...
### ADA TDM Product Profile Example
Example path-driven TDM product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaTDM-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA TDM Example Product",
  "schema:description": "Example path-driven TDM product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data.",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaTDM"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TDM/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaTDM-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Temperature-Dependent Magnetization (TDM)",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example path-driven TDM product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA TDM Example Product" ;
...
ex:adaProduct-file-001 a schema1:ImageObject,
        schema1:MediaObject,
        ada:image ;
    schema1:additionalType "ada:TDMRawTabular" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaTDM>,
...
title: ADA TDM Product Profile
description: Path-driven technique-specific profile for ADA TDM Product Profile. Extends
  the base ADA product profile with the TDM analysis-instance detail on the schema:Dataset
  root, narrows prov:used to the tdmTAPP protocol, and constrains valid component
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TDM/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the tdmTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TDM/tapp/schema.yaml
    schema:additionalType:
      description: Must include a TDM product type identifier.
      contains:
        enum:
        - Temperature-Dependent Magnetization (TDM)
    schema:subjectOf:
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaTDM

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TDM/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TDM/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TDM/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/TDM/profile`
