...
# Temperature-Dependent Magnetization Technique-Aligned Procedure Profile (tdmTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.TDM.tapp` *v0.1*
...
description: 'Temperature-Dependent Magnetization extension of the base TAPP definition.
  CORE-ONLY DRAFT: the native technique layer is empty. TDM has no ADA detail schema
  ...
  Phase 0 seed papers before it says anything TDM-specific. Generated from draftTAPPs/TDM_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TDM/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TDM/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TDM/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/TDM/tapp`
