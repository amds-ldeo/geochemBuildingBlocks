...
ex:adaEMPA-example-001 a schema1:Dataset,
    ...
    schema1:description "Example path-driven EMPA product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
...
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the empaTAPP definition and the instrument where prov:used
    ...
    schema:additionalType:
      description: Must include a EMPA product type identifier.
      contains:
        enum:
        - Electron Microprobe Analysis (EMPA)
