...
`ogch.techniqueProfile.geochemProfile.EMPA.profile-ada` *v0.1*
...
### ADA EMPA Product Example
Example Electron Microprobe Analysis (EMPA/EPMA) product metadata with properties
populated and EMPA component types on the archive distribution. Mock data for
...
```json
{
  ...
  "schema:description": "Example Electron Microprobe Analysis (EMPA) product metadata demonstrating properties defined by the adaEMPA profile. Mock data for testing and validation.",
...
```jsonld
{
  "@context": [
    ...
    "https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/geochemProfile/EMPA/profile-ada/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaEMPA-example-001 a schema1:Dataset,
    ...
    schema1:description "Example Electron Microprobe Analysis (EMPA) product metadata demonstrating properties defined by the adaEMPA profile. Mock data for testing and validation." ;
...
description: Technique-specific profile for Electron Microprobe Analysis (EMPA/EPMA)
  products. Extends the base ADA product profile with constraints on valid EMPA component
  types. Generic (adaProduct-only) profile; the analysis-instance detail (detailEMPA)
  and empaTAPP linkage live on the path-driven geochem empaProfile.
allOf:
- $ref: https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/BaseSchema/adaProduct/schema.yaml
- type: object
  properties:
    schema:additionalType:
        ...
        properties:
          schema:hasPart:
            items:
              type: object
              anyOf:
              - $ref: https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/BaseSchema/adaProduct/schema.yaml#/$defs/universalComponentTypeBranch
              - properties:
                  ada:componentType:
                    type: string
                    enum:
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/geochemProfile/EMPA/profile-ada/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/geochemProfile/EMPA/profile-ada/schema.yaml)
...
[context.jsonld](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/geochemProfile/EMPA/profile-ada/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/EMPA/profile-ada`
