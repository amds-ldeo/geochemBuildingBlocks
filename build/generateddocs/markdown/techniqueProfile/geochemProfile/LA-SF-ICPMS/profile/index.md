...
# ADA LA-SF-ICP-MS Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.LA-SF-ICPMS.profile` *v0.1*
...
### ADA LA-SF-ICP-MS Product Profile Example
Example path-driven LASFICPMS product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaLASFICPMS-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaLASFICPMS"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-SF-ICPMS/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaLASFICPMS-example-001 a schema1:Dataset,
    ...
    schema1:description "Example path-driven LASFICPMS product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA LA-SF-ICP-MS Example Product" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaLASFICPMS>,
...
description: Path-driven technique-specific profile for ADA LA-SF-ICP-MS Product Profile.
  Extends the base ADA product profile with the LASFICPMS analysis-instance detail
  on the schema:Dataset root, narrows prov:used to the laSficpmsTAPP protocol, and
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-SF-ICPMS/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the laSficpmsTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-SF-ICPMS/tapp/schema.yaml
    schema:additionalType:
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaLASFICPMS

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-SF-ICPMS/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-SF-ICPMS/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LA-SF-ICPMS/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/LA-SF-ICPMS/profile`
