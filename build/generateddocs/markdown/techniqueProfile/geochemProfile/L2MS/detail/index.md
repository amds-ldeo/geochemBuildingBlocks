...
# Microprobe Two-Step Laser Mass Spectrometry Analysis Detail (Schema)

`ogch.techniqueProfile.geochemProfile.L2MS.detail` *v0.1*
...
### detail example P0
detail instance derived from ADA n=1 | Clemett, Simon | NASA Johnson Space Center | uL2MS instrument.
#### json
```json
{
  "@context": {
  ...
  "ada:analysisStartDate": "2024-05-24",
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/L2MS/detail/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/"
    }
...
<ex:detail-P0> a ada:L2MSCube ;
    schema1:measurementTechnique <ex:l2msTAPP-P0> ;
    ada:analysisEndDate "missing" ;
    ada:analysisStartDate "2024-05-24" ;
    ada:analyst "Clemett, Simon" ;
    ada:componentType "ada:L2MSCube" ;
...
title: Microprobe Two-Step Laser Mass Spectrometry Analysis Detail
description: Detail block for L2MS hasPart items, carrying the analysis-identification
  properties the Core module places on the dataset. No L2MS-specific analysis property
  is defined yet.
allOf:
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/L2MS/detail/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/L2MS/detail/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/L2MS/detail/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/L2MS/detail`
