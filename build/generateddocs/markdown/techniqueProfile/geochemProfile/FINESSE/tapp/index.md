...
# Stepped Heating Carbon and Nitrogen Isotopic Compositions Technique-Aligned Procedure Profile (finesseTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.FINESSE.tapp` *v0.1*
...
### finesseTAPP example P0
finesseTAPP instance derived from ADA n=8 | no named analyst | Open University | FINESSE.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Stepped Heating Carbon and Nitrogen Isotopic Compositions"
    }
  ],
  "schema:location": {
    "@type": [
    ...
    "schema:identifier": "https://ror.org/05mzfcs16"
  },
  "ada:reportedProperties": [
    "Filename | Temperature | C ng | delta13C | delta3C 2 sigma error | N ng | delta15N | delta15N 2 sigma error"
  ],
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/FINESSE/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:finesseTAPP-P0 a cdi:Activity,
        schema1:Action,
        prov:Plan,
        ada:TAPPDefinition,
        bios:LabProtocol ;
...
title: Stepped Heating Carbon and Nitrogen Isotopic Compositions Technique-Aligned
  Procedure Profile (finesseTAPP)
description: 'Stepped Heating Carbon and Nitrogen Isotopic Compositions extension
  of the base TAPP definition. CORE-ONLY DRAFT: the native technique layer is empty.
  FINESSE has no ADA detail schema and no technique-specific property in any ADA record,
  so there was nothing to seed one from and none was invented. This registers the
  procedure skeleton and needs Phase 0 seed papers before it says anything FINESSE-specific.
  Generated from draftTAPPs/FINESSE_TAPP_draft_v2.csv by tools/build_tapp.py.'
allOf:
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/FINESSE/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/FINESSE/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/FINESSE/tapp/context.jsonld)

## Sources

* [FINESSE_TAPP_draft_v2.csv (TAPP worksheet)](https://github.com/amds-ldeo/geochemBuildingBlocks/tree/main/docs)
...
* Path: `_sources/techniqueProfile/geochemProfile/FINESSE/tapp`
