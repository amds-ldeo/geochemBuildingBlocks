...
# ADA FINESSE Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.FINESSE.profile` *v0.1*
...
### ADA FINESSE Product Profile Example
Example path-driven FINESSE product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaFINESSE-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA FINESSE Example Product",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaFINESSE"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/FINESSE/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaFINESSE-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Elemental Analyzer Stepped Heating C N Isotope (FINESSE)",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example path-driven FINESSE product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA FINESSE Example Product" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaFINESSE>,
...
title: ADA FINESSE Product Profile
description: Path-driven technique-specific profile for ADA FINESSE Product Profile.
  Extends the base ADA product profile with the FINESSE analysis-instance detail on
  the schema:Dataset root, narrows prov:used to the finesseTAPP protocol, and constrains
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/FINESSE/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the finesseTAPP definition and the instrument where prov:used
    ...
    schema:additionalType:
      description: Must include a FINESSE product type identifier.
      contains:
        enum:
        - Elemental Analyzer Stepped Heating C N Isotope (FINESSE)
    schema:subjectOf:
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaFINESSE

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/FINESSE/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/FINESSE/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/FINESSE/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/FINESSE/profile`
