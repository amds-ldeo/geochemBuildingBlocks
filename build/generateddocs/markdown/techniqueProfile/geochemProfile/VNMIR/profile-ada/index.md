...
# ADA VNMIR Profile (TAPP-linked) (Schema)

`ogch.techniqueProfile.geochemProfile.VNMIR.profile-ada` *v0.1*
...
title: ADA VNMIR Product Profile (TAPP-linked)
description: Profile for an ADA metadata document describing data generated under
  a registered vnmirTAPP procedure. Extends the base ADA product profile with the
  VNMIR analysis-instance detail on the schema:Dataset root, pins prov:used to the
  vnmirTAPP definition and the instrument building block, and constrains valid VNMIR
  component types on both the monolithic and bundle forms of schema:distribution.
  Distinct from adaProfile/VNMIR, which is the generic (adaProduct-only) VNMIR profile
  and carries no TAPP linkage - a record conforming here additionally asserts which
  registered procedure produced it. DRAFT - the vnmirTAPP source table has not been
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/VNMIR/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the vnmirTAPP definition and the instrument where prov:used
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/VNMIR/profile-ada/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/VNMIR/profile-ada/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/VNMIR/profile-ada/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/VNMIR/profile-ada`
