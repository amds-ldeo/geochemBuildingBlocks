...
# ADA TEM Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.TEM.profile` *v0.1*
...
### ADA TEM Product Profile Example
Example path-driven TEM product record with dataset-level analysis detail
...
```json
{
  ...
  "schema:name": "ADA TEM Example Product",
  ...
  "schema:variableMeasured": [
    ...
    },
    {
      ...
      "schema:description": "EDS Detection Limit reported for this dataset. Example value.",
      "schema:propertyID": [
        {
          "@id": "ada:parameter/temTAPP/edsDetectionLimit"
        }
    ...
    },
    {
      ...
      "schema:name": "sensitivityDetectionLimit",
      "schema:description": "sensitivityDetectionLimit reported for this dataset. Example value.",
      "schema:propertyID": [
        "https://ada.astromat.org/vocabulary/variables/ada_primary"
      ],
      "schema:unitText": "counts",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaTEM"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TEM/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaTEM-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Scanning Transmission Electron Microscopy (STEM) Image",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example path-driven TEM product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA TEM Example Product" ;
    schema1:subjectOf ex:adaProduct-metadata-001 ;
    schema1:url "https://astromat.org/products/adaproduct-example-001" ;
    schema1:variableMeasured <https://ada.astromat.org/metadata/parameter/temTAPP/edsDetectionLimit>,
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaTEM>,
...
<https://ada.astromat.org/metadata/parameter/temTAPP/edsDetectionLimit> a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:description "EDS Detection Limit reported for this dataset. Example value." ;
    schema1:name "EDS Detection Limit" ;
    schema1:propertyID <https://ada.astromat.org/metadata/parameter/temTAPP/edsDetectionLimit> ;
    schema1:unitText "counts" ;
    cdif:physicalDataType "https://www.w3.org/TR/xmlschema-2/#double" .
...
description: Path-driven technique-specific profile for ADA TEM Product Profile. Extends
  the base ADA product profile with the TEM analysis-instance detail on the schema:Dataset
  root, narrows prov:used to the temTAPP protocol, and constrains valid component
  types on schema:distribution.hasPart.
allOf:
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/BaseSchema/geochemProduct/schema.yaml
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TEM/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the temTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TEM/tapp/schema.yaml
    schema:additionalType:
    ...
    schema:distribution:
      description: Each distribution item is EITHER a monolithic single-file dataset
        whose ada:componentType is a TEM-specific or universal value (and may carry
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaTEM

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TEM/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TEM/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/TEM/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/TEM/profile`
