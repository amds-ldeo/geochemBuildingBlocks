...
# Liquid Chromatography-Mass Spectrometry Technique-Aligned Procedure Profile (lcmsTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.LCMS.tapp` *v0.1*
...
### lcmsTAPP example Ultimate3000
lcmsTAPP instance derived from ADA n=24 | Oba, Yasuhiro | Kyushu University | Thermo Fischer Ultimate3000-QExactive.
#### json
```json
{
  "@context": {
  ...
  "schema:name": "lcms protocol — Ultimate3000",
  "schema:description": "lcmsTAPP instance derived from ADA n=24 | Oba, Yasuhiro | Kyushu University | Thermo Fischer Ultimate3000-QExactive (publication column of LCMS_TAPP_draft_v2.csv).",
  "ada:instrumentManufacturer": "Thermo Fisher Scientific",
  "ada:instrumentModel": "Thermo Fischer Ultimate3000-QExactive",
  "schema:measurementTechnique": [
    {
      "@type": [
        "schema:DefinedTerm"
      ],
      "schema:termCode": "Liquid Chromatography-Mass Spectrometry"
    }
  ],
  "schema:creator": {
    "schema:name": "Oba, Yasuhiro",
    "@type": [
      "schema:Person"
    ]
  },
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LCMS/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:lcmsTAPP-Ultimate3000 a cdi:Activity,
        schema1:Action,
        prov:Plan,
        ada:TAPPDefinition,
        bios:LabProtocol ;
    ...
    schema1:creator [ a schema1:Person ;
            schema1:name "Oba, Yasuhiro" ] ;
    schema1:datePublished "missing" ;
    schema1:description "lcmsTAPP instance derived from ADA n=24 | Oba, Yasuhiro | Kyushu University | Thermo Fischer Ultimate3000-QExactive (publication column of LCMS_TAPP_draft_v2.csv)." ;
    schema1:funding [ a schema1:MonetaryGrant ;
            schema1:name "NASA" ] ;
    schema1:location [ a schema1:Place ;
            schema1:name "Kyushu University" ] ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Liquid Chromatography-Mass Spectrometry" ] ;
    schema1:name "lcms protocol — Ultimate3000" ;
    ada:constantsAndReferenceValuesUsedDefault "missing" ;
    ada:instrumentManufacturer "Thermo Fisher Scientific" ;
    ada:instrumentModel "Thermo Fischer Ultimate3000-QExactive" ;
    ada:samplingUnit "missing" ;
...
title: Liquid Chromatography-Mass Spectrometry Technique-Aligned Procedure Profile
  (lcmsTAPP)
description: 'Liquid Chromatography-Mass Spectrometry extension of the base TAPP definition.
  CORE-ONLY DRAFT: the native technique layer is empty. LCMS has no ADA detail schema
  ...
  Phase 0 seed papers before it says anything LCMS-specific. Generated from draftTAPPs/LCMS_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LCMS/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LCMS/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/LCMS/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/LCMS/tapp`
