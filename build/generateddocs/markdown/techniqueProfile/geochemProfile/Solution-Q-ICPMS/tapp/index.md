...
description: Solution quadrupole ICP-MS extension of the base TAPP definition, generated
  from TAPPS20260813/Current TAPPs/Solution_Q-ICP-MS_TAPP_v17.csv via the path-driven
  pipeline.
allOf:
...
- type: object
  properties:
                        ...
                        schema:value:
                          ...
                          items:
                            description: Type of geological or experimental material
                              being analyzed (e.g., basalt, peridotite, meteorite,
                  ...
                  schema:additionalProperty:
                    ...
                    items:
                      ...
                      - title: Digestion Vessel Type
                        ...
                        properties:
                          '@id':
                            const: ada:parameter/solutionQicpmsTAPP/digestionVesselType
                          '@type':
                            const:
                            - schema:PropertyValue
                          schema:propertyID:
                            const:
                            - '@id': ada:parameter/solutionQicpmsTAPP/digestionVesselType
                          schema:name:
                      ...
                      - title: Number of Digestion Steps
                        ...
                        properties:
                          '@id':
                            const: ada:parameter/solutionQicpmsTAPP/numberOfDigestionSteps
                          '@type':
                            const:
                            - schema:PropertyValue
                          schema:propertyID:
                            const:
                            - '@id': ada:parameter/solutionQicpmsTAPP/numberOfDigestionSteps
                          schema:name:
                      ...
                      - title: Digestion Temperature
                        ...
                        properties:
                          '@id':
                            const: ada:parameter/solutionQicpmsTAPP/digestionTemperatureDefault
                          '@type':
                            const:
                            - schema:PropertyValueSpecification
                          schema:valueName:
                      ...
                      - title: Digestion Duration
                        ...
                        properties:
                          '@id':
                            const: ada:parameter/solutionQicpmsTAPP/digestionDurationDefault
                          '@type':
                            const:
                            - schema:PropertyValueSpecification
                          schema:valueName:
                  ...
                  schema:additionalProperty:
                    ...
                    items:
                      ...
                      - title: Constants and Reference Values Used
                        ...
                        properties:
                          '@id':
                            const: ada:parameter/solutionQicpmsTAPP/constantsAndReferenceValuesUsedDefault
                          '@type':
                            const:
                            - schema:PropertyValueSpecification
                          schema:valueName:
          ...
          then:
            properties:
              schema:model:
                ...
                properties:
                  schema:name:
                    description: Manufacturer and model name of the quadrupole ICP-MS
                      instrument (e.g., Thermo iCAP RQ, Agilent 7900, PerkinElmer
                      NexION 350D). Determines instrument-specific tuning parameters
                      and available cell configurations.
                    type: string
                    readOnly: true
              schema:additionalProperty:
                type: array
                        ...
                        schema:additionalProperty:
                          ...
                          items:
                            ...
                            - title: Nebulizer Type
                              ...
                              properties:
                                '@id':
                                  const: ada:parameter/solutionQicpmsTAPP/nebulizerType
                                '@type':
                                  const:
                                  - schema:PropertyValue
                                schema:propertyID:
                                  const:
                                  - '@id': ada:parameter/solutionQicpmsTAPP/nebulizerType
                                schema:name:
                            ...
                            - title: Spray Chamber Type and Cooling Temperature
                              ...
                              properties:
                                '@id':
                                  const: ada:parameter/solutionQicpmsTAPP/sprayChamberTypeAndCoolingTemperature
                                '@type':
                                  const:
                                  - schema:PropertyValue
                                schema:propertyID:
                                  const:
                                  - '@id': ada:parameter/solutionQicpmsTAPP/sprayChamberTypeAndCoolingTemperature
                                schema:name:
                            ...
                            - title: Sample Uptake Rate
                              ...
                              properties:
                                '@id':
                                  const: ada:parameter/solutionQicpmsTAPP/sampleUptakeRateDefault
                                '@type':
                                  const:
                                  - schema:PropertyValueSpecification
                                schema:valueName:
                            ...
                            - title: Nebulizer Gas Flow Rate
                              ...
                              properties:
                                '@id':
                                  const: ada:parameter/solutionQicpmsTAPP/nebulizerGasFlowRateDefault
                                '@type':
                                  const:
                                  - schema:PropertyValueSpecification
                                schema:valueName:
            ...
            properties:
              schema:name:
                description: Name and version of the software used to control the
                  instrument and acquire raw mass spectrum data (e.g., Qtegra, MassLynx).
                anyOf:
                - type: string
                - type: array
                  items:
            ...
            properties:
              schema:name:
                description: 'Name and version of the software used for data reduction:
                  ...
                  and concentration calculation (e.g., Iolite, lab spreadsheet). Include
                  version number.'
                anyOf:
                - type: string
                - type: array
        ...
        ada:defaultChannels:
          ...
          items:
            description: Specific isotope(s) monitored in this procedure, grouped
              ...
              parent element. The analyte list is given by the Analyte field and is
              never inferred from the element symbols appearing here.
            type: string
            readOnly: true
        ada:channelColumns:
          type: array
    ...
    ada:massCyclesPerReplicate:
      description: Number of complete mass scans (sweeps) accumulated per analytical
        replicate.
      anyOf:
      - type: integer
      - type: string
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/geochemProfile/Solution-Q-ICPMS/tapp/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/geochemProfile/Solution-Q-ICPMS/tapp/schema.yaml)
...
[context.jsonld](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/techniqueProfile/geochemProfile/Solution-Q-ICPMS/tapp/context.jsonld)
