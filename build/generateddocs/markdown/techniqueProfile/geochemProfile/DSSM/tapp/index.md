...
# Direct Shear Strength Measurement Technique-Aligned Procedure Profile (dssmTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.DSSM.tapp` *v0.1*
...
### dssmTAPP example P0
dssmTAPP instance derived from ADA n=2 | no named analyst | University of Calgary | Test Resources electromechanical press (Model 313Q).
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Direct Shear Strength Measurement"
    }
  ],
  "schema:location": {
    "@type": [
    ...
    "schema:identifier": "https://ror.org/03yjb2x39"
  },
  "ada:reportedProperties": [
    "Time (s) | Uncorrected Load (N) | Corrected Load (N) | Uncorrected Stress (MPa) | Corrected Stress (MPa) | Load (N) | Stress (MPa) | Displacement (mm) | Strain"
  ],
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/DSSM/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:dssmTAPP-P0 a cdi:Activity,
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Direct Shear Strength Measurement" ] ;
...
description: 'Direct Shear Strength Measurement extension of the base TAPP definition.
  CORE-ONLY DRAFT: the native technique layer is empty. DSSM has no ADA detail schema
  ...
  Phase 0 seed papers before it says anything DSSM-specific. Generated from draftTAPPs/DSSM_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/DSSM/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/DSSM/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/DSSM/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/DSSM/tapp`
