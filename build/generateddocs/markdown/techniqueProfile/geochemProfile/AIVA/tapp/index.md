...
# Advanced Imaging & Visualization of Astromaterials Technique-Aligned Procedure Profile (aivaTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.AIVA.tapp` *v0.1*
...
### aivaTAPP example P0
aivaTAPP instance derived from ADA n=3 | Blumenfeld, Erika | NASA Johnson Space Center | Fujifilm GFX 100s.
#### json
```json
{
  "@context": {
  ...
  "schema:name": "aiva protocol — P0",
  "schema:description": "aivaTAPP instance derived from ADA n=3 | Blumenfeld, Erika | NASA Johnson Space Center | Fujifilm GFX 100s (publication column of AIVA_TAPP_draft_v2.csv).",
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Advanced Imaging & Visualization of Astromaterials"
    }
  ],
  "schema:creator": {
    "schema:name": "Blumenfeld, Erika",
    "@type": [
      "schema:Person"
    ]
  },
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/AIVA/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:aivaTAPP-P0 a cdi:Activity,
    ...
    schema1:creator [ a schema1:Person ;
            schema1:name "Blumenfeld, Erika" ] ;
    schema1:datePublished "missing" ;
    schema1:description "aivaTAPP instance derived from ADA n=3 | Blumenfeld, Erika | NASA Johnson Space Center | Fujifilm GFX 100s (publication column of AIVA_TAPP_draft_v2.csv)." ;
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Advanced Imaging & Visualization of Astromaterials" ] ;
    schema1:name "aiva protocol — P0" ;
    ada:constantsAndReferenceValuesUsedDefault "missing" ;
    ada:instrumentManufacturer "Unknown" ;
    ada:instrumentModel "Fujifilm GFX 100s" ;
    ada:samplingUnit "missing" ;
...
title: Advanced Imaging & Visualization of Astromaterials Technique-Aligned Procedure
  Profile (aivaTAPP)
description: 'Advanced Imaging & Visualization of Astromaterials extension of the
  base TAPP definition. CORE-ONLY DRAFT: the native technique layer is empty. AIVA
  ...
  skeleton and needs Phase 0 seed papers before it says anything AIVA-specific. Generated
  from draftTAPPs/AIVA_TAPP_draft_v2.csv by tools/build_tapp.py.'
allOf:
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/AIVA/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/AIVA/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/AIVA/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/AIVA/tapp`
