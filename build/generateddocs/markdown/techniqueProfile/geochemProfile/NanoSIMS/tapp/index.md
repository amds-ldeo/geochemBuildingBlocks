...
# Nanoscale secondary ion mass spectrometry Technique-Aligned Procedure Profile (nanosimsTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.NanoSIMS.tapp` *v0.1*
...
### nanosimsTAPP example P0
nanosimsTAPP instance derived from ADA n=7 | Nguyen, Ann | Open University | (OU)NanoSIMS 50L.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Nanoscale secondary ion mass spectrometry"
    }
  ],
  "schema:creator": {
    "schema:name": "Nguyen, Ann",
    "@type": [
      "schema:Person"
    ]
  },
  ...
  "ada:reportedProperties": [
    "Sample Name | X | Y | Z | 16O Counts | 17O/16O Ratio"
  ],
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NanoSIMS/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:nanosimsTAPP-P0 a cdi:Activity,
        schema1:Action,
        prov:Plan,
        ada:TAPPDefinition,
        bios:LabProtocol ;
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Nanoscale secondary ion mass spectrometry" ] ;
...
title: Nanoscale secondary ion mass spectrometry Technique-Aligned Procedure Profile
  (nanosimsTAPP)
description: 'Nanoscale secondary ion mass spectrometry extension of the base TAPP
  definition. CORE-ONLY DRAFT: the native technique layer is empty. NanoSIMS has no
  ...
  skeleton and needs Phase 0 seed papers before it says anything NanoSIMS-specific.
  Generated from draftTAPPs/NanoSIMS_TAPP_draft_v2.csv by tools/build_tapp.py.'
allOf:
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NanoSIMS/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NanoSIMS/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/NanoSIMS/tapp/context.jsonld)

## Sources

* [NanoSIMS_TAPP_draft_v2.csv (TAPP worksheet)](https://github.com/amds-ldeo/geochemBuildingBlocks/tree/main/docs)
...
* Path: `_sources/techniqueProfile/geochemProfile/NanoSIMS/tapp`
