...
# ADA SEM-CL Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.SEM-CL.profile` *v0.1*
...
### ADA SEM-CL Product Profile Example
Example path-driven SEMCL product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaSEMCL-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA SEM-CL Example Product",
  "schema:description": "Example path-driven SEMCL product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data.",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaSEMCL"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-CL/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaSEMCL-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "SEM Cathodoluminescence Spectroscopy (SEMCL)",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example path-driven SEMCL product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA SEM-CL Example Product" ;
...
ex:adaProduct-file-001 a schema1:ImageObject,
        schema1:MediaObject,
        ada:image ;
    schema1:additionalType "ada:SEMHRCLTabular" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaSEMCL>,
...
title: ADA SEM-CL Product Profile
description: Path-driven technique-specific profile for ADA SEM-CL Product Profile.
  Extends the base ADA product profile with the SEMCL analysis-instance detail on
  the schema:Dataset root, narrows prov:used to the semClTAPP protocol, and constrains
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-CL/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the semClTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-CL/tapp/schema.yaml
    schema:additionalType:
      description: Must include a SEMCL product type identifier.
      contains:
        enum:
        - SEM Cathodoluminescence Spectroscopy (SEMCL)
    schema:subjectOf:
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaSEMCL

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-CL/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-CL/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-CL/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/SEM-CL/profile`
