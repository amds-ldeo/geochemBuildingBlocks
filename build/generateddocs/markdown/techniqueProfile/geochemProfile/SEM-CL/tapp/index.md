...
# SEM Cathodoluminescence Spectroscopy Technique-Aligned Procedure Profile (semClTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.SEM-CL.tapp` *v0.1*
...
### semClTAPP example JSM7000
semClTAPP instance derived from ADA n=26 | no named analyst | CNRS - Centre de Recherche sur l'Hetero-Epitaxie et ses Applications | JEOL JSM7000F FEG-SEM.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "SEM Cathodoluminescence Spectroscopy"
    }
  ],
  "schema:location": {
    "@type": [
    ...
    "schema:name": "CNRS - Centre de Recherche sur l'Hetero-Epitaxie et ses Applications",
    "schema:identifier": "https://ror.org/02feahw73"
  },
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-CL/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:semClTAPP-JSM7000 a cdi:Activity,
        schema1:Action,
        prov:Plan,
        ada:TAPPDefinition,
        bios:LabProtocol ;
...
description: 'SEM Cathodoluminescence Spectroscopy extension of the base TAPP definition.
  CORE-ONLY DRAFT: the native technique layer is empty. SEM-CL has no ADA detail schema
  ...
  Phase 0 seed papers before it says anything SEM-CL-specific. Generated from draftTAPPs/SEM-CL_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-CL/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-CL/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/SEM-CL/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/SEM-CL/tapp`
