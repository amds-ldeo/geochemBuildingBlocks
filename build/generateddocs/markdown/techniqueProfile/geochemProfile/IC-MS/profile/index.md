...
# ADA Ion Chromatography-Mass Spectrometry Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.IC-MS.profile` *v0.1*
...
### ADA Ion Chromatography-Mass Spectrometry Product Profile Example
Example path-driven ICMS product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaICMS-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA Ion Chromatography-Mass Spectrometry Example Product",
  "schema:description": "Example path-driven ICMS product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data.",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaICMS"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/IC-MS/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaICMS-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Ion Chromatography-Mass Spectrometry (ICMS)",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example path-driven ICMS product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA Ion Chromatography-Mass Spectrometry Example Product" ;
...
ex:adaProduct-file-001 a schema1:ImageObject,
        schema1:MediaObject,
        ada:image ;
    schema1:additionalType "ada:ICMSCollection" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaICMS>,
...
title: ADA Ion Chromatography-Mass Spectrometry Product Profile
description: Path-driven technique-specific profile for ADA Ion Chromatography-Mass
  Spectrometry Product Profile. Extends the base ADA product profile with the ICMS
  analysis-instance detail on the schema:Dataset root, narrows prov:used to the icMsTAPP
...
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/IC-MS/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the icMsTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/IC-MS/tapp/schema.yaml
    schema:additionalType:
      description: Must include a ICMS product type identifier.
      contains:
        enum:
        - Ion Chromatography-Mass Spectrometry (ICMS)
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaICMS

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/IC-MS/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/IC-MS/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/IC-MS/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/IC-MS/profile`
