...
# ADA Curation Photo-Documentation Product Profile (Schema)

`ogch.techniqueProfile.geochemProfile.CPD.profile` *v0.1*
...
### ADA Curation Photo-Documentation Product Profile Example
Example path-driven CPD product record with dataset-level analysis detail
...
```json
{
  ...
  "@id": "ex:adaCPD-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "ADA Curation Photo-Documentation Example Product",
  "schema:description": "Example path-driven CPD product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data.",
  "schema:additionalType": [
    "Curation Photo-Documentation",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      ...
      {
        "@id": "https://w3id.org/geochem/metadata/profiles/adaCPD"
      }
    ],
    "schema:maintainer": {
      "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CPD/profile/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaCPD-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Curation Photo-Documentation",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example path-driven CPD product record: dataset-level analysis detail plus technique component types on distribution.hasPart. Mock data." ;
    ...
    schema1:name "ADA Curation Photo-Documentation Example Product" ;
...
ex:adaProduct-file-001 a schema1:ImageObject,
        schema1:MediaObject,
        ada:image ;
    schema1:additionalType "ada:CPDImage" ;
...
ex:adaProduct-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/core/1.1>,
        ...
        <https://w3id.org/geochem/metadata/profiles/adaCPD>,
...
title: ADA Curation Photo-Documentation Product Profile
description: Path-driven technique-specific profile for ADA Curation Photo-Documentation
  Product Profile. Extends the base ADA product profile with the CPD analysis-instance
  detail on the schema:Dataset root, narrows prov:used to the cpdTAPP protocol, and
  constrains valid component types on schema:distribution.hasPart.
allOf:
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/BaseSchema/geochemProduct/schema.yaml
- $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CPD/detail/schema.yaml
- type: object
  properties:
    prov:wasGeneratedBy:
      description: 'Pin the cpdTAPP definition and the instrument where prov:used
          ...
          prov:used:
            ...
            items:
              ...
              - if:
                  ...
                  - '@type'
                then:
                  $ref: https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CPD/tapp/schema.yaml
    schema:additionalType:
      description: Must include a CPD product type identifier.
      contains:
        enum:
        - Curation Photo-Documentation
      ...
      properties:
        dcterms:conformsTo:
          contains:
            ...
            properties:
              '@id':
                const: https://w3id.org/geochem/metadata/profiles/adaCPD

```

Links to the schema:

* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CPD/profile/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CPD/profile/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CPD/profile/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/CPD/profile`
