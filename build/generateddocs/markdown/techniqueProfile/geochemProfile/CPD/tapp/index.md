...
# Curation Photo-Documentation Technique-Aligned Procedure Profile (cpdTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.CPD.tapp` *v0.1*
...
### cpdTAPP example P0
cpdTAPP instance derived from ADA n=10 | no named analyst | NASA Johnson Space Center | (JSC) Nikon Nikor S Camera.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Curation Photo-Documentation"
    }
  ],
  "schema:location": {
    "@type": [
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CPD/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:cpdTAPP-P0 a cdi:Activity,
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Curation Photo-Documentation" ] ;
    schema1:name "cpd protocol — P0" ;
    ada:constantsAndReferenceValuesUsedDefault "missing" ;
    ada:instrumentManufacturer "Unknown" ;
    ada:instrumentModel "(JSC) Nikon Nikor S Camera" ;
    ada:samplingUnit "missing" ;
...
description: 'Curation Photo-Documentation extension of the base TAPP definition.
  CORE-ONLY DRAFT: the native technique layer is empty. CPD has no ADA detail schema
  ...
  Phase 0 seed papers before it says anything CPD-specific. Generated from draftTAPPs/CPD_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CPD/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CPD/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/CPD/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/CPD/tapp`
