...
# Accelerator Mass Spectrometry Technique-Aligned Procedure Profile (amsTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.AMS.tapp` *v0.1*
...
description: 'Accelerator Mass Spectrometry extension of the base TAPP definition.
  CORE-ONLY DRAFT: the native technique layer is empty. AMS has no ADA detail schema
  ...
  Phase 0 seed papers before it says anything AMS-specific. Generated from draftTAPPs/AMS_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/AMS/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/AMS/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/AMS/tapp/context.jsonld)

## Sources

* [AMS_TAPP_draft_v2.csv (TAPP worksheet)](https://github.com/amds-ldeo/geochemBuildingBlocks/tree/main/docs)
...
* Path: `_sources/techniqueProfile/geochemProfile/AMS/tapp`
