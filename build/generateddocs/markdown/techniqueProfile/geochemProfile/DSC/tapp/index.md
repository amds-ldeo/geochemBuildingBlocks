...
# Differential Scanning Calorimetry Technique-Aligned Procedure Profile (dscTAPP) (Schema)

`ogch.techniqueProfile.geochemProfile.DSC.tapp` *v0.1*
...
### dscTAPP example DSC8000
dscTAPP instance derived from ADA n=2 | Biele, Jens | Nagoya University | PerkinsElmer DSC 8000.
#### json
```json
{
  "@context": {
  ...
  "schema:measurementTechnique": [
    {
      ...
      "schema:termCode": "Differential Scanning Calorimetry"
    }
  ],
  "schema:creator": {
    "schema:name": "Biele, Jens",
    "@type": [
      "schema:Person"
    ]
  },
  ...
  "ada:reportedProperties": [
    "T | Standard Deviation | Step Scan 1 Cp [J/g/K] | Step Scan 2 Cp [J/g/K] | Step Scan 3 Cp [J/g/K] | Averaged Cp [J/g/K]"
  ],
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/DSC/tapp/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:dscTAPP-DSC8000 a cdi:Activity,
        schema1:Action,
        prov:Plan,
        ada:TAPPDefinition,
        bios:LabProtocol ;
    ...
    schema1:location [ a schema1:Place ;
            schema1:name "Nagoya University" ] ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:termCode "Differential Scanning Calorimetry" ] ;
...
description: 'Differential Scanning Calorimetry extension of the base TAPP definition.
  CORE-ONLY DRAFT: the native technique layer is empty. DSC has no ADA detail schema
  ...
  Phase 0 seed papers before it says anything DSC-specific. Generated from draftTAPPs/DSC_TAPP_draft_v2.csv
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/DSC/tapp/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/DSC/tapp/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/techniqueProfile/geochemProfile/DSC/tapp/context.jsonld)
...
* Path: `_sources/techniqueProfile/geochemProfile/DSC/tapp`
