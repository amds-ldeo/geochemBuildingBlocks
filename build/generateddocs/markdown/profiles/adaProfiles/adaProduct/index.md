...
`ogch.profiles.adaProfiles.adaProduct` *v0.1*
...
- type: object
  properties:
    ...
    prov:wasGeneratedBy:
      ...
      items:
        ...
        properties:
          prov:used:
            type: array
            description: Instruments and/or Technique-Aligned Protocol Profile (TAPP)
              definitions used in the analysis. Each item is either an instrument
    ...
    schema:variableMeasured:
      description: ADA variable definitions. Extends cdifInstanceVariable (from cdifDataDescription)
...
$defs:
  ...
  universalComponentType:
    description: ada:componentType values valid across all ADA techniques. As a string,
      ...
      $def (typically via the universalComponentTypeBranch wrapper) in their hasPart
      anyOf branches.
    type: string
    enum:
