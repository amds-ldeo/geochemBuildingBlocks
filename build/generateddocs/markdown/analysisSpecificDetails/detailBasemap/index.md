...
`ogch.analysisSpecificDetails.detailBasemap` *v0.1*
...
```jsonld
{
  "@context": [
    ...
    "https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/analysisSpecificDetails/detailBasemap/context.jsonld"
  ],
  "@type": [
    "ada:basemap",
    "schema:Map"
...
* YAML version: [schema.yaml](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/analysisSpecificDetails/detailBasemap/schema.json)
* JSON version: [schema.json](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/analysisSpecificDetails/detailBasemap/schema.yaml)
...
[context.jsonld](https://amds-ldeo.github.io/geochemBuildingBlocks/build/annotated/analysisSpecificDetails/detailBasemap/context.jsonld)
...
* Path: `_sources/analysisSpecificDetails/detailBasemap`
