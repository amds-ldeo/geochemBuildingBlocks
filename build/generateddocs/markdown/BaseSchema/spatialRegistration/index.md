...
`ogch.BaseSchema.spatialRegistration` *v0.1*
...
```jsonld
{
  "@context": [
    ...
    "https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/BaseSchema/spatialRegistration/context.jsonld"
  ],
  "ada:basemap": "basemap_BSE_001.tif",
  "ada:originX": 0.0,
  "ada:originY": 0.0,
...
properties:
  ada:basemap:
    ...
    x-jsonld-id: https://ada.astromat.org/metadata/basemap
  ada:originX:
    type: number
    x-jsonld-id: https://ada.astromat.org/metadata/originX
  ada:originY:
    type: number
    x-jsonld-id: https://ada.astromat.org/metadata/originY
  ada:originZ:
    type: number
    x-jsonld-id: https://ada.astromat.org/metadata/originZ
  ada:coordDef:
    type: string
    ...
    x-jsonld-id: https://ada.astromat.org/metadata/coordDef
  ada:coordUnits:
    type: string
    x-jsonld-id: https://ada.astromat.org/metadata/coordUnits
  ada:pixelUnits:
    type: string
    x-jsonld-id: https://ada.astromat.org/metadata/pixelUnits
  ada:pixelScaleX:
    type: number
    x-jsonld-id: https://ada.astromat.org/metadata/pixelScaleX
  ada:pixelScaleY:
    type: number
    x-jsonld-id: https://ada.astromat.org/metadata/pixelScaleY
  ada:originLocation:
    type: string
    description: 'The location of the origin pixel of an image. Range: upperLeft,
      upperRight, lowerLeft, lowerRight, center'
    x-jsonld-id: https://ada.astromat.org/metadata/originLocation
required:
- ada:originX
- ada:originY
- ada:pixelScaleX
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/BaseSchema/spatialRegistration/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/BaseSchema/spatialRegistration/schema.yaml)
...
[context.jsonld](https://raw.githubusercontent.com/amds-ldeo/geochemBuildingBlocks/undefined/build/annotated/BaseSchema/spatialRegistration/context.jsonld)
...
* Path: `_sources/BaseSchema/spatialRegistration`
